...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div align="left" id="AL_Application_Form" >
            ...
            <p><img src="../../Img/Company_logo.JPG" alt="" width="96" height="46" /><strong> </strong><br />
                <strong><?php
            ...
            ?></font></font><strong> Working Month(በሥራ ላይ የቆየባቸው ወራቶች</span>) </strong> <font color= "color=&quot;#FF0000&quot;"><?php
                        if (isset($_GET['Workingmonths'])) {
                            echo "<u>{$_GET['Workingmonths']}</u>";
                        }
            ?></font></strong></font><br />

                <strong>ID N<u>o<font color= "color=&quot;#FF0000&quot;"><?php
                            if (isset($_GET['ID'])) {
                                echo "<u> {$_GET['ID']} </u>";
                            }
            ?></font></u></strong><br />
            ...
            ?></strong>For(<span sans-serif="sans-serif""'>ለ</span>)<font color= "color=&quot;#FF0000&quot;"><?php
                        if (isset($_GET['Leavedays'])) {
                            echo "<u>{$_GET['Leavedays']}</u>";
                        }
            ?></font>days (<strong>ቀናት</strong>)<strong></strong><br />
            ...
            ?></font>days</strong><br />
                    ...
                    <?php
                    echo "<b>This Year(<span style=\"font-family:&quot;TITUS Cyberbit Basic&quot;,&quot;serif&quot;;\">ከአሁኑ ዓመት</span>): <font color= \"color=&quot;#FF0000&quot;\">";
                    ...
                    <strong> Note: -prepared  in two copies. One to the employee and the second for personnel file.</br>
                        ...
                        <?php echo " " . date("Y-M-d") . " " . time(); ?><p><img src="../../Img/Company_logo.JPG" alt="" width="100" height="46" /><strong> </strong><br />
                            <strong>   <?php
                        $sqlCS = "SELECT * FROM company_settings";
