        ...
        <div id="thekey_page">
            ...
            <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
                ...
                if (isset($_GET['Auto_ID'])) {
                    ...
                    $mydb->delete('funeral_leave');
                }



                $mydb = new DataBase();
                $header_lable = 'Funeral Leave';
                $mydb = filter($mydb);
                $result = $mydb->get('funeral_leave');
                $total_num_row = $result['total_row'];                 $result = $result['result'];
                
                $update_page = 'FuneralLeaveUpdate.php';
                $key_filed = 'Auto_ID';
                
                
                  $header_info = $mydb->show_column('funeral_leave');
                ksort($header_info);
