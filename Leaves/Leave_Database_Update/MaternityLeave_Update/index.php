        ...
        <div id="thekey_page">
            ...
            <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
                ...
                if (isset($_GET['Auto_ID'])) {
                    ...
                    $mydb->delete('maternity_leave');
                }



                $mydb = new DataBase();
                $header_lable = 'Maternity Leave';
                $mydb = filter($mydb);
                $result = $mydb->get('maternity_leave');
                $total_num_row = $result['total_row'];                 $result = $result['result'];

                $update_page = 'MaternityLeaveUpdate.php';
                $key_filed = 'Auto_ID';

                $header_info = $mydb->show_column('maternity_leave');
                ksort($header_info);
