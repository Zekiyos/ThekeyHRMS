        ...
        <div id="thekey_page">
            ...
            <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
                ...
                if (isset($_GET['Auto_ID'])) {
                    ...
                    $mydb->delete('special_leave');
                }



                $mydb = new DataBase();
                $header_lable = 'Special Leave';
                 $mydb = filter($mydb);
                $result = $mydb->get('special_leave');
                $total_num_row = $result['total_row'];                 
				$result = $result['result'];

                $update_page = 'SpecialLeaveUpdate.php';
                $key_filed = 'Auto_ID';

                $header_info = $mydb->show_column('special_leave');
                ksort($header_info);
