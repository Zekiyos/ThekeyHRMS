        ...
        <table width="252" height="49" border="0" align="center">
            <tr>
                <td><?php if ($pageNum_RSWeddingLeaveDisplay > 0) { // Show if not first page  ?>
                        <a href="<?php printf("%s?pageNum_RSWeddingLeaveDisplay=%d%s", $currentPage, 0, $queryString_RSWeddingLeaveDisplay); ?>"><img src="../../../images/First.gif" /></a>
                    <?php } // Show if not first page  ?></td>
                <td><?php if ($pageNum_RSWeddingLeaveDisplay > 0) { // Show if not first page ?>
                        <a href="<?php printf("%s?pageNum_RSWeddingLeaveDisplay=%d%s", $currentPage, max(0, $pageNum_RSWeddingLeaveDisplay - 1), $queryString_RSWeddingLeaveDisplay); ?>"><img src="../../../images/Previous.gif" /></a>
                    <?php } // Show if not first page  ?></td>
                <td><?php if ($pageNum_RSWeddingLeaveDisplay < $totalPages_RSWeddingLeaveDisplay) { // Show if not last page ?>
                        <a href="<?php printf("%s?pageNum_RSWeddingLeaveDisplay=%d%s", $currentPage, min($totalPages_RSWeddingLeaveDisplay, $pageNum_RSWeddingLeaveDisplay + 1), $queryString_RSWeddingLeaveDisplay); ?>"><img src="../../../images/Next.gif" /></a>
                    <?php } // Show if not last page  ?></td>
                <td><?php if ($pageNum_RSWeddingLeaveDisplay < $totalPages_RSWeddingLeaveDisplay) { // Show if not last page ?>
                        <a href="<?php printf("%s?pageNum_RSWeddingLeaveDisplay=%d%s", $currentPage, $totalPages_RSWeddingLeaveDisplay, $queryString_RSWeddingLeaveDisplay); ?>"><img src="../../../images/Last.gif" /></a>
                    <?php } // Show if not last page  ?></td>
            </tr>
        </table>
    </body>
