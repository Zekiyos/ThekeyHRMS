        ...
        <div id="thekey_page">
            ...
            <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
                ...
                if (isset($_GET['Auto_ID'])) {
                    ...
                    $mydb->delete('wedding_leave');
                }



                $mydb = new DataBase();
                $header_lable = 'Wedding Leave';
                $mydb = filter($mydb);
                $result = $mydb->get('wedding_leave');
                $total_num_row = $result['total_row'];                 $result = $result['result'];


                $update_page = 'WeddingLeaveUpdate.php';
                $key_filed = 'Auto_ID';

                $header_info = $mydb->show_column('annual_leave');
                ksort($header_info);
