...
<table width="250" border="0" align="center">
  <tr>
    <td><?php if ($pageNum_RSFuneralLeaveDisplay > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_RSFuneralLeaveDisplay=%d%s", $currentPage, 0, $queryString_RSFuneralLeaveDisplay); ?>"><img src="../../images/First.gif" /></a>
        <?php } // Show if not first page ?></td>
    <td><?php if ($pageNum_RSFuneralLeaveDisplay > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_RSFuneralLeaveDisplay=%d%s", $currentPage, max(0, $pageNum_RSFuneralLeaveDisplay - 1), $queryString_RSFuneralLeaveDisplay); ?>"><img src="../../images/Previous.gif" /></a>
        <?php } // Show if not first page ?></td>
    <td><?php if ($pageNum_RSFuneralLeaveDisplay < $totalPages_RSFuneralLeaveDisplay) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_RSFuneralLeaveDisplay=%d%s", $currentPage, min($totalPages_RSFuneralLeaveDisplay, $pageNum_RSFuneralLeaveDisplay + 1), $queryString_RSFuneralLeaveDisplay); ?>"><img src="../../images/Next.gif" /></a>
        <?php } // Show if not last page ?></td>
    <td><?php if ($pageNum_RSFuneralLeaveDisplay < $totalPages_RSFuneralLeaveDisplay) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_RSFuneralLeaveDisplay=%d%s", $currentPage, $totalPages_RSFuneralLeaveDisplay, $queryString_RSFuneralLeaveDisplay); ?>"><img src="../../images/Last.gif" /></a>
        <?php } // Show if not last page ?></td>
  </tr>
</table>
</body>
