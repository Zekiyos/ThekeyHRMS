...
?>
<?php include('../../Classes/Class_language.php');?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/ThekeyHRMS_main_Template.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE sick_leave SET ID=%s, FirstName=%s, MiddelName=%s, LastName=%s, SickLeavedays=%s, SickLeave_Taken_Date=%s, ReportOn=%s, LeaveType=%s, ModifiedBy=%s, Reported=%s, Report_Back_Date=%s WHERE Auto_ID=%s",
...
?>
    ...
    <font color="#FF6600" size="+1" > <p align="center">Sick Leave Record Update form</p></font>
      <table align="center">
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Modified By:</td>
          <td><input type="text" name="ModifiedBy" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
