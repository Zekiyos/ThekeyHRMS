...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE maternity_leave SET ID=%s, FirstName=%s, MiddelName=%s, LastName=%s, MaternityLeaveDays=%s, MaternityLeave_Taken_Date=%s, ReportOn=%s, LeaveType=%s, Reported=%s, Report_Back_Date=%s, ModifiedBy=%s WHERE Auto_ID=%s",
...
$query_RSMaternityLeaveUpdate = "SELECT * FROM  maternity_leave where Auto_ID=".$_GET['Auto_ID']."";}else
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          ...
          <td><input type="text" name="ID" value="<?php echo htmlentities($row_RSMaternityLeaveUpdate['ID'], ENT_COMPAT, 'utf-8'); ?>" size="32" readonly="readonly" /></td>
        </tr>
        <tr valign="baseline">
