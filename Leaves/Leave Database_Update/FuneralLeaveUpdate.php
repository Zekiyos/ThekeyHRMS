...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE funeral_leave SET ID=%s, FirstName=%s, MiddelName=%s, LastName=%s, Department=%s, FuneralLeaveDays=%s, RestDay=%s, FuneralLeave_Taken_Date=%s, ReportOn=%s, LeaveType=%s, Reported=%s, Report_Back_Date=%s, ModifiedBy=%s WHERE Auto_ID=%s",
