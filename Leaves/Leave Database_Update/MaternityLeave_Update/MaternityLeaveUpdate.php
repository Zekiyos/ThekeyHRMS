...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
	...
	$data = array('ID' => $_POST['ID']
        ...
        , 'FuneralLeaveDays' => $_POST['MaternityLeaveDays']
...
?>
    ...
    <font color="#FF6600" size="+1" > <p align="center">Maternity Leave Record Update form</p></font>
      <table align="center">
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Maternity Leave Days:</td>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Maternity Leave Taken Date:</td>
