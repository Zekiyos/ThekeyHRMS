...
<table width="315" border="0" align="center">
  <tr>
    <td><?php if ($pageNum_RSAnnualLeaveCalcDisplay > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_RSAnnualLeaveCalcDisplay=%d%s", $currentPage, 0, $queryString_RSAnnualLeaveCalcDisplay); ?>"><img src="../../images/First.gif" /></a>
        <?php } // Show if not first page ?></td>
    <td><?php if ($pageNum_RSAnnualLeaveCalcDisplay > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_RSAnnualLeaveCalcDisplay=%d%s", $currentPage, max(0, $pageNum_RSAnnualLeaveCalcDisplay - 1), $queryString_RSAnnualLeaveCalcDisplay); ?>"><img src="../../images/Previous.gif" /></a>
        <?php } // Show if not first page ?></td>
    <td><?php if ($pageNum_RSAnnualLeaveCalcDisplay < $totalPages_RSAnnualLeaveCalcDisplay) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_RSAnnualLeaveCalcDisplay=%d%s", $currentPage, min($totalPages_RSAnnualLeaveCalcDisplay, $pageNum_RSAnnualLeaveCalcDisplay + 1), $queryString_RSAnnualLeaveCalcDisplay); ?>"><img src="../../images/Next.gif" /></a>
        <?php } // Show if not last page ?></td>
    <td><?php if ($pageNum_RSAnnualLeaveCalcDisplay < $totalPages_RSAnnualLeaveCalcDisplay) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_RSAnnualLeaveCalcDisplay=%d%s", $currentPage, $totalPages_RSAnnualLeaveCalcDisplay, $queryString_RSAnnualLeaveCalcDisplay); ?>"><img src="../../images/Last.gif" /></a>
        <?php } // Show if not last page ?></td>
  </tr>
</table>
<p>&nbsp;</p>
