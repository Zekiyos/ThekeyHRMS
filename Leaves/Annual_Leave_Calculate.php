...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        while ($row = mysql_fetch_array($resultWM, MYSQL_ASSOC)) {
            ...
            $date = date("Y-m-d");
            $sqlINST = "INSERT INTO `ThekeyHRMSDB`.`annual_leave_calculate` (`Auto_ID`, `ID`, `FirstName`, `MiddelName`, `LastName`, `WorkingMonth`, `WorkingYear`, `ThisYearALdays`, `LastYearALdays`, `BeforeLastYearALdays`, `TotalALdays`, `Calculated_Date`,ModifiedBy) VALUES (NULL," . "'" . $ID . "'" . "," . "'" . $FirstName . "'" . "," . "'" . $MiddelName . "'" . "," . "'" . $LastName . "'" . "," . $Workingmonths . "," . $noyear . "," . $thisyear . "," . $lastyear . "," . $beforelastyear . "," . $totalALdays . "," . "'" . $date . "','" . $_SESSION['MM_Fullname'] . "')";
            mysql_query($sqlINST);
