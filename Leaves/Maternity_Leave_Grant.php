            ...
            <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
                ...
                if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
                    ...
                    if ($obj_leave->CHK_Leave_Existance($_GET['ID'], $_POST['MaternityLeave_Taken_Date']) != false) {
                        ...
                        $Result1 = $mydb->insert('maternity_leave', $data);

                        if ($Result1)
                            echo "<script type=\"text/javascript\">alert('You have granted Materinty Leave for {$_POST['FirstName']}  {$_POST['MiddelName']} {$_POST['MaternityLeaveDays']} days Successfully.')</script>";
                    }
                }
                ...
                ?>
                <h1 class="form_lable">
                    <?php echo $obj_lang->get('Maternity Leave Grant Form', $lang); ?>
                </h1>
                <?php
                ...
                <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
                    <table width="410" align="center" bgcolor="#EBEBEB">
                        <tr valign="baseline">
                ...
                ?>" size="20" readonly="readonly" /></td>
                        ...
                        <tr valign="baseline">
                            ...
                            <td><input type="Date" required="required" id="myLeave_Taken_Date" name="MaternityLeave_Taken_Date" value="<?php echo date("Y-m-d"); ?>" size="15"  /></td>
                        </tr>
                        <tr valign="baseline">
                        ...
                        <tr valign="baseline">
                            ...
                            <td><input type="submit" value="<?php echo $obj_lang->get('Grant Maternity leave', $lang); ?>" onClick="return confirm('Are you sure you want to Grant Matternity Leave for this Employee?')"  /></td>
                        </tr>
                    </table>
