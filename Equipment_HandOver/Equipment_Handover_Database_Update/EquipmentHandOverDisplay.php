...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <table  cellpadding="0" align="center" border="1" bordercolor="#FF6600"> 
            ...
            <?php do { ?>
                <tr>
                    <td><a  target="_blank" href="EquipmentHandOverUpdate.php?Auto_ID=<?php echo $row_RSEquipmenthandOverDisplay['Auto_ID']; ?>"  ><?php echo "<p>Update</p> </a>"; ?></a>
        ...
        <table width="333" height="46" border="0" align="center">
            <tr>
                <td><?php if ($pageNum_RSEquipmenthandOverDisplay > 0) { // Show if not first page    ?>
                        <a href="<?php printf("%s?pageNum_RSEquipmenthandOverDisplay=%d%s", $currentPage, 0, $queryString_RSEquipmenthandOverDisplay); ?>"><img src="../../images/First.gif" /></a>
                    <?php } // Show if not first page  ?></td>
                <td><?php if ($pageNum_RSEquipmenthandOverDisplay > 0) { // Show if not first page   ?>
                        <a href="<?php printf("%s?pageNum_RSEquipmenthandOverDisplay=%d%s", $currentPage, max(0, $pageNum_RSEquipmenthandOverDisplay - 1), $queryString_RSEquipmenthandOverDisplay); ?>"><img src="../../images/Previous.gif" /></a>
                    <?php } // Show if not first page  ?></td>
                <td><?php if ($pageNum_RSEquipmenthandOverDisplay < $totalPages_RSEquipmenthandOverDisplay) { // Show if not last page   ?>
                        <a href="<?php printf("%s?pageNum_RSEquipmenthandOverDisplay=%d%s", $currentPage, min($totalPages_RSEquipmenthandOverDisplay, $pageNum_RSEquipmenthandOverDisplay + 1), $queryString_RSEquipmenthandOverDisplay); ?>"><img src="../../images/Next.gif" /></a>
                    <?php } // Show if not last page  ?></td>
                <td><?php if ($pageNum_RSEquipmenthandOverDisplay < $totalPages_RSEquipmenthandOverDisplay) { // Show if not last page   ?>
                        <a href="<?php printf("%s?pageNum_RSEquipmenthandOverDisplay=%d%s", $currentPage, $totalPages_RSEquipmenthandOverDisplay, $queryString_RSEquipmenthandOverDisplay); ?>"><img src="../../images/Last.gif" /></a>
                    <?php } // Show if not last page  ?></td>
            </tr>
        </table>
    </body>
