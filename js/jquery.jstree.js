 ...
 */
    (function ($) {
        ...
        plugins = {},			// list of require_onced plugins
            ...
            plugin : function (pname, pdata) {
                ...
                $.each(pdata._fn, function (i, val) {
                    ...
                    $.jstree._fn[i] = function () {
                        ...
                        // Check if function belongs to the require_onced plugins of this instance
                        do {
        ...
        $.jstree.plugin("core", {
            ...
            _fn : { 
                ...
                // Dummy functions to be overwritten by any datastore plugin require_onced
 ...
 */
    (function ($) {
        ...
        // require_once the selection plugin by default
 ...
 */
    ...
    // require_once the crr plugin by default
 ...
 */
    (function ($) {
        ...
        // require_once the themes plugin by default
        ...
        $.jstree.plugin("hotkeys", {
            __init : function () {
                if(typeof $.hotkeys === "undefined") {
                    throw "jsTree hotkeys: jQuery hotkeys plugin not require_onced.";
                }
                if(!this.data.ui) {
                    throw "jsTree hotkeys: jsTree UI plugin not require_onced.";
                }
 ...
 */
        ...
        $.jstree.plugin("cookies", {
            __init : function () {
                if(typeof $.cookie === "undefined") {
                    throw "jsTree cookie: jQuery cookie plugin not require_onced.";
                }
    ...
    // require_once cookies by default
    ...
    (function ($) {
        ...
        $.jstree.plugin("xml_data", {
            defaults : { 
                ...
                get_require_once_preamble : true
            },
            _fn : {
                load_node : function (obj, s_call, e_call) {
                    var _this = this;
                ...
                get_xml : function (tp, obj, li_attr, a_attr, is_callback) {
                    ...
                    if(!is_callback) { 
                        if(s.xml_data.get_require_once_preamble) { 
            ...
            _fn : {
                ...
                _check : function (rule, obj, opts) {
                    ...
                    if(rule === "max_depth" && obj !== -1 && opts !== false && s.max_depth !== -2 && v !== 0) {
                        // also require_once the node itself - otherwise if root node it is not checked
 ...
 */
    (function ($) {
        ...
        // require_once the HTML data plugin by default
 ...
 * Adds support for jQuery UI themes. require_once this at the end of your plugins list, also make sure "themes" is not require_onced.
 */
    (function ($) {
 ...
 */
    (function ($) {
        $.jstree.plugin("wholerow", {
            __init : function () {
                if(!this.data.ui) {
                    throw "jsTree wholerow: jsTree UI plugin not require_onced.";
                }
        ...
        $.jstree.plugin("model", {
            __init : function () {
                if(!this.data.json_data) {
                    throw "jsTree model: jsTree json_data plugin not require_onced.";
                }
