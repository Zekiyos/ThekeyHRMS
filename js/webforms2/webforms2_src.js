...
if(!window.$wf2){
    ...
    if(document.implementation && document.implementation.hasFeature && 
	 ...
	 ##############################################################################################*/
            ...
            constructRepetitionTemplate : function(){
                ...
                //IMAGE???, fieldset not require_onced
                if(frm && (_templateElements = $wf2.getElementsByTagNames.apply(this, ['button','input','select','textarea','isindex'])).length){
                    ...
                    // As a workaround... this implementation requires that authors, in addition to supplying a DISABLED attribute (for Opera), to require_once a class name "disabled"
            ...
            updateValidityState : function(node){
                ...
                if(!node.validity.valueMissing && node.value){
                    ...
                    if(doMaxLengthCheck && node.maxLength >= 0 && node.value != node.defaultValue){
                        ...
                        //   newlines in textareas are submitted as U+000D U+000A). [[NOT IMPLEMENTED: This require_onces the
	 ...
	 ##############################################################################################*/
            ...
            cloneNode_rtEventHandlerAttrs : {
                onmoved:1,
                onadded:1,
                onremoved:1, //don't copy Repetition old model event attributes not methods
                onadd:1,
                onremove:1,
                onmove:1 //deprecated
            ...
            //   createElement method. To create an element with a name attribute, require_once the attribute 
 ...
 ##################################################################################*/
        ...
        (function(){
            ...
            //The script has been require_onced after the DOM has loaded (perhaps via Greasemonkey), so fire immediately
