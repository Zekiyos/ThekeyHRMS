...
if(!window.$wf2){
    ...
    if(document.implementation&&document.implementation.hasFeature&&!document.implementation.hasFeature('WebForms','2.0')){
        $wf2={
            ...
            _5c:false,
            _6f:'',
            _7b:(window.HTMLElement&&HTMLElement.prototype),
            _7c:($wf2.__defineGetter__&&$wf2.__defineSetter__),
            onDOMContentLoaded:function(){
                ...
                $wf2._0=null;
                if(window.XMLHttpRequest)$wf2._0=new XMLHttpRequest();
                        ...
                        for(j=0;fld=flds[j];j++){
                            ...
                            if(!ctrl.getAttributeNode('multiple')||!ctrl.wf2Prefilled){
                                if(ctrl.type=='checkbox'||ctrl.type=='radio'){
                                    if(!value)ctrl.checked=false;
                                    else if(ctrl.value==value)ctrl.checked=true;else break
            ...
            initRepetitionTemplates:function(parentNode){
                var _13=$wf2._51.apply((parentNode||document.documentElement),[['*'],'repeat','template']);
            ...
            initRepetitionBlocks:function(parentNode){
                var repetitionBlocks=$wf2._51.apply((parentNode||document.documentElement),[['*'],'repeat','template',true]);
            ...
            _67:function(_7){
                ...
                if(_7!='add')this.disabled=!$wf2._4d(this);
                else{
                    var rb;
                    this.disabled=!(((rb=$wf2._4d(this))&&rb.repetitionTemplate)||this.htmlTemplate)
                }
                if(this.addEventListener)this.addEventListener('click',$wf2._66,false);
                else if(this.attachEvent)this.attachEvent('onclick',$wf2._66);else this.onclick=$wf2._66;
                this.wf2Initialized=true
            },
            initRepetitionButtons:function(_7,_2){
                var i;
                if(!_2)_2=document.documentElement;
                var inpts=$wf2._51.apply(_2,[['input'],'type',_7]);
                ...
                var _40=$wf2._51.apply(_2,[['button'],'type',_7]);
            ...
            _66:function(e){
                ...
                else if(window.event)btn=event.srcElement;
                else if(this.nodeName.toLowerCase()=='button')btn=this;
                ...
                if(_7!='add'){
                    ...
                    var rt;
                    if(btn.htmlTemplate)rt=btn.htmlTemplate;
                    else{
                        block=$wf2._4d(btn);
            ...
            _7f:function(_c,index){
                ...
                var _9;
                try{
                    if(document.createEvent)_9=document.createEvent('UIEvents');
                    else if(document.createEventObject)_9=document.createEventObject();
                    RepetitionEvent._upgradeEvent.apply(_9);
                    _9.initRepetitionEvent('added',true,false,block);
                    if(this.dispatchEvent)this.dispatchEvent(_9);
            ...
            _81:function(){
                ...
                if(this.repetitionTemplate!=null){
                    var _d;
                    try{
                        if(document.createEvent)_d=document.createEvent('UIEvents');
                        else if(document.createEventObject)_d=document.createEventObject();
                        RepetitionEvent._upgradeEvent.apply(_d);
                        _d.initRepetitionEvent('removed',true,false,this);
                        if(this.repetitionTemplate.dispatchEvent)this.repetitionTemplate.dispatchEvent(_d);
                ...
                if(this.repetitionTemplate!=null){
                    ...
                    if(this.repetitionTemplate.repetitionBlocks.length<this.repetitionTemplate.repeatMax){
                        var _3d=$wf2._51.apply(document.documentElement,[['button'],'type','add']);
            ...
            _82:function(_5){
                ...
                if(this.repetitionTemplate!=null){
                    var _a;
                    try{
                        if(document.createEvent)_a=document.createEvent('UIEvents');
                        else if(document.createEventObject)_a=document.createEventObject();
                        RepetitionEvent._upgradeEvent.apply(_a);
                        _a.initRepetitionEvent('moved',true,false,this);
                        if(this.repetitionTemplate.dispatchEvent)this.repetitionTemplate.dispatchEvent(_a);
                        else if(this.repetitionTemplate.fireEvent){}
                    }catch(err){
                        _a=new Object();
                        RepetitionEvent._upgradeEvent.apply(_a);
            ...
            _72:function(rt){
                ...
                var _40=$wf2._51.apply(document.documentElement,[['button'],'type','add']);
            ...
            _73:function(_2){
                ...
                if(!_2){
                    var _75=[];
                    rbs=$wf2._51.apply(document.documentElement,[['*'],'repeat','template',true]);
                ...
                for(i=0;block=rbs[i];i++){
                    var moveUpBtns=$wf2._51.apply(block,[['button'],'type','move-up']);
                    for(j=0;btn=moveUpBtns[j];j++){
                        btn.disabled=!(rb=$wf2._4d(btn))||(i==0)
                    }
                    var moveDownBtns=$wf2._51.apply(block,[['button'],'type','move-down']);
            ...
            initNonRepetitionFunctionality:function(_2){
                ...
                var els=$wf2._51.apply(document.documentElement,[['*'],'autofocus']);
                if(_2.getAttribute('autofocus'))els.unshift(_2);
                for(i=0;i<els.length;i++)$wf2._5b(els[i]);
                var textareas=$wf2._51.apply(_2,[['textarea'],'maxlength']);
            ...
            _5e:function(){
                ...
                var _6;
                try{
                    if(document.createEvent)_6=document.createEvent('Events');
                    else if(document.createEventObject)_6=document.createEventObject();
                    _6.initEvent('invalid',true,true);
                    _6.srcElement=this;
                    if(this.dispatchEvent)canceled=!this.dispatchEvent(_6);
                    else if(this.fireEvent){}
                }catch(err){
                    _6=new Object();
                    if(_6.initEvent)_6.initEvent('invalid',true,true);
                    else{
                        _6.type='invalid';
            ...
            _6a:function(node){
                ...
                if(!node.validity.valueMissing&&node.value){
                    ...
                    if(_2e||_15)node.validity.typeMismatch=((node.wf2Value=$wf2._56(node.value,type))==null);
                    else{
                        switch(type){
                    ...
                    if(!node.validity.patternMismatch&&!node.validity.typeMismatch){
                        ...
                        if(_20&&!node.validity.rangeUnderflow&&!node.validity.rangeOverflow){
                            ...
                            if(!stepAttrNode){
                                node.step=_15?60:1
                            }else if(stepAttrNode.value=='any')node.step='any';
                            else if($wf2._63.test(stepAttrNode.value)&&stepAttrNode.value>0)node.step=Number(stepAttrNode.value);else node.step=_15?60:1;
                            if(node.step!='any'){
                                node.wf2StepDatum=null;
                                if(_10)node.wf2StepDatum=node.min;
                                else if(_11)node.wf2StepDatum=node.max;else node.wf2StepDatum=$wf2._43[type]?$wf2._43[type]:0;
                                var _step=node.step;
                                if(type=='month'){
                                    ...
                                    switch(type){
                                        case'datetime':case'datetime-local':case'time':
            ...
            _5d:function(node){
                ...
                var type=(node.getAttribute('type')?node.getAttribute('type').toLowerCase():node.type);
                if(/(hidden|button|reset|add|remove|move-up|move-down)/.test(type)||!node.name||node.disabled)node.willValidate=false;
            ...
            _6c:function(value,type){
                switch(String(type).toLowerCase()){
                    case'datetime':case'datetime-local':case'date':case'month':case'week':case'time':
            ...
            _53:function(el,_74){
                if(el.currentStyle)return el.currentStyle[_74];
                else if(window.getComputedStyle)return getComputedStyle(el,'').getPropertyValue(_74);
                else if(el.style)return el.style[_74];else return''
            },
            _7e:(function(){
                try{
                    ...
                    return function(tag,_e){
                        var html='<'+tag;
                        for(var name in _e)html+=' '+name+'="'+_e[name]+'"';html+='>';
                    ...
                    return function(tag,_e){
                        ...
                        for(var name in _e)el.setAttribute(name,_e[name]);return el
                    }
                }
            })(),
            _69:(function(){
            ...
            _55:/^(?:(\d\d\d\d)-(W(0[1-9]|[1-4]\d|5[0-2])|(0\d|1[0-2])(-(0\d|[1-2]\d|3[0-1])(T(0\d|1\d|2[0-4]):([0-5]\d)(:([0-5]\d)(\.(\d+))?)?(Z)?)?)?)|(0\d|1\d|2[0-4]):([0-5]\d)(:([0-5]\d)(\.(\d+))?)?)$/,
            _56:function(str,type){
            ...
            _57:function(value,type){
                ...
                if(type=='week')_b=(d[2].toString().indexOf('W')===0);
                else if(type=='time')_b=!!d[15];
                else if(type=='month')_b=!d[5];
                else{
                    if(d[6]){
        ...
        var RepetitionEvent={
            ...
            initRepetitionEvent:function(_21,_28,_3f,_24){
                if(this.initEvent)this.initEvent(_21,_28,_3f);
                else{
                    this.type=_21;
        ...
        if(document.addEventListener){
            ...
            document.addEventListener('DOMAttrModified',function(_6){
                if(_6._3=='autofocus'){
                    if(_6.attrChange==_6.ADDITION)$wf2._5b(_6.target);
                    else if(_6.attrChange==_6.REMOVAL)_6.target.autofocus=false
                }
            },false)
        }(function(){
            var match;
        ...
        (function(){
            ...
            function _18(_6){
                ...
                if(_6.element.repetitionTemplate[_3])_6.element.repetitionTemplate[_3](_6);
                else if(_6.element.repetitionTemplate[_1a[_6.type]])_6.element.repetitionTemplate[_1a[_6.type]](_6)
            }
