        ...
        self.parse = function(html) {
            ...
            while (matches = tokenRegExp.exec(html)) {
                ...
                if (value = matches[6]) { // End element
                    ...
                    // Treat script, noscript and style a bit different since they may require_once code that looks like elements
...
(function(){
    ...
    //   Thus far that require_onces Google Chrome.
    [0, 0].sort(function(){
...
(function(tinymce) {
    ...
    tinymce.create('tinymce.ui.Button:tinymce.ui.Control', {
        ...
        renderHTML : function() {
            ...
            if (s.image)
                h += '<img class="mceIcon" src="../../Letters/jscripts/tiny_mce/' + s.image + '" alt="' + DOM.encode(s.title) + '" />' + l;
            else
    ...
    tinymce.create('tinymce.Editor', {
        ...
        init : function() {
            ...
            if (s.document_base_url != tinymce.documentBaseURL)
                t.iframeHTML += '<base href="../../Letters/jscripts/tiny_mce/' + t.documentBaseURI.getURI() + '" />';
            ...
            if (!isGecko || !/Firefox\/2/.test(navigator.userAgent)) {
                for (i = 0; i < t.contentCSS.length; i++)
                    t.iframeHTML += '<link type="text/css" rel="stylesheet" href="../../Letters/jscripts/tiny_mce/' + t.contentCSS[i] + '" />';
        ...
        _addEvents : function() {
            ...
            if (s.custom_undo_redo) {
                ...
                t.onKeyDown.add(function(ed, e) {
                    ...
                    // IE has a really odd bug where the DOM might require_once an node that doesn't have
                ...
                function findBlockEndPoint(container, sibling_name, sibling_name2) {
                    ...
                    if (!node) {
                        ...
                        while (node[sibling_name] && !isBlock(node[sibling_name])) {
                            ...
                            // Break on BR but require_once it will be removed later on
