...
$RootMenu->AddMenuItem(55, $ReportLanguage->Phrase("ChartReportMenuItemPrefix") . $ReportLanguage->MenuPhrase("55", "MenuText") . $ReportLanguage->Phrase("ChartReportMenuItemSuffix"), "Total_Attendancesmry.php#cht_Total_Absent_Per_Department", 23, "", "", TRUE);
...
$RootMenu->AddMenuItem(54, $ReportLanguage->Phrase("ChartReportMenuItemPrefix") . $ReportLanguage->MenuPhrase("54", "MenuText") . $ReportLanguage->Phrase("ChartReportMenuItemSuffix"), "Employee_Personal_Recordsmry.php#cht_Funner_Chart_Number_of__Employee_Per_Department", 24, "", "", TRUE);
...
$RootMenu->AddMenuItem(56, $ReportLanguage->Phrase("ChartReportMenuItemPrefix") . $ReportLanguage->MenuPhrase("56", "MenuText") . $ReportLanguage->Phrase("ChartReportMenuItemSuffix"), "Sick_Leavesmry.php#cht_Sick_Leave_Per_Department", 16, "", "", TRUE);
