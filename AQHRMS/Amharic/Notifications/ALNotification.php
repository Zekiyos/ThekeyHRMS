...
WHERE ReportOn <= CURDATE( ) and Reported='NO'";
			...
			slmg[<?php echo $i;?>]='<?php echo "<font color=\"#FF9900\" size=\"+1\" face=\"Times New Roman, Times, serif\">"."{$row['FirstName']}"." {$row['MiddelName']}"." {$row['LastName']}"."<br>";
					echo "<font color=\"#FF3300\" size=\"+0\" >"."Have finished his/her "."{$row['LeaveType']}"." days on date "."{$row['ReportOn']}".".He/she should <a href=\"Leaves/Back_From_Leave_Report.php?ID=".$row['ID']."\" >report on</a> today" . "<p> </p>";?>';
					<?php
