...
$d=date("Y-m-d");
			...
			slmg[<?php echo $i;?>]='<?php echo "<font  color=\"#FF9900\" size=\"+1\" face=\"Times New Roman, Times, serif\">"."{$row['FirstName']}"." {$row['MiddelName']}"." {$row['LastName']}"."<br>";
					echo "<font color=\"#03F\" size=\"+0\" >"."Have finished his/her "."Probation Period"." .You Should <a href=\"Probation_Evaluation.php\">Evalute his/her Probation Period </a>stay on today" . "<p> </p>";?>';
					<?php
