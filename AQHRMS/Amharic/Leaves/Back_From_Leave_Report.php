  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" --><blockquote>
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center" bgcolor="#EBEBEB">
          ...
          <tr valign="baseline">
            <td height="33" align="right" nowrap="nowrap">የአባት ስም :</td>
          ...
          <tr valign="baseline">
            <td height="33" align="right" nowrap="nowrap">የአያት ስም  :</td>
          ...
          <tr valign="baseline">
            <td height="31" align="right" nowrap="nowrap">ከእረፍት:</td>
          ...
          <tr valign="baseline">
            <td height="31" align="right" nowrap="nowrap">የተመለሰበት ቀን</td>
...
-->
  ...
  <div id="sidecontent">
    ...
    <p></p>
     <a href="../Ethiopian Labour Law Pro.377(English).htm#a76" target="_blank">Leave Labour Law</a>
