  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" --><blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote>
          <font color="#FF6600" size="+1">   የጋብቻ ፍቃድ መስጫ ቅጽ </font>
			   <?php include("Select_ID4WeddingLeaveGrant.php");?>
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center" bgcolor="#EBEBEB">
          <tr valign="baseline">
            <td height="35" align="right" nowrap="nowrap">መ.ቁጥር:</td>
          ...
          <tr valign="baseline">
            <td height="35" align="right" nowrap="nowrap">የአባት ስም :</td>
          ...
          <tr valign="baseline">
            <td height="40" align="right" nowrap="nowrap">የአያት ስም  :</td>
          ...
          <tr valign="baseline">
            <td height="36" align="right" nowrap="nowrap">የጋብቻ እረፍት ቀን:</td>
            <td><input type="text" name="WeddingLeavedays" value="" size="4" /></td>
          </tr>
          <tr valign="baseline">
            <td height="40" align="right" nowrap="nowrap">የጋብቻ እረፍት የወሰደበት ቀን :</td>
            <td><input type="text" name="WeddingLeave_TakenDate" value="<?php echo date("Y-m-d"); ?>" size="15" readonly="readonly"  /></td>
          </tr>
          <tr valign="baseline">
            <td height="32" align="right" nowrap="nowrap">መመለሻ ቀን :</td>
...
-->
  ...
  <div id="sidecontent">
    ...
    <p></p><br />
    <a href="../Proclamation/Ethiopian Labour Law Pro.377-2003 Amharic and English.htm#a81" target="_blank">ስለ ጋብቻ ፍቃድ አዋጅ</a>
