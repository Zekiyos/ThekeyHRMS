...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO maternity_leave (ID, FirstName, MiddelName, LastName, MaternityLeaveDays, MaternityLeave_Taken_Date, ReportOn) VALUES (%s, %s, %s, %s, %s, %s, %s)",
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center" bgcolor="#EBEBEB">
          ...
          <tr valign="baseline">
            <td height="34" align="right" nowrap="nowrap">የአባት ስም :</td>
          ...
          <tr valign="baseline">
            <td height="36" align="right" nowrap="nowrap">የወሊድ እረፍት ቀን :</td>
            <td><input type="text" name="MaternityLeaveDays" value="" size="4" /></td>
          </tr>
          <tr valign="baseline">
            <td height="34" align="right" nowrap="nowrap">የወሊድ እረፍት የወሰደበት ቀን :</td>
            <td><input type="text" name="MaternityLeave_Taken_Date" value="<?php echo date("Y-m-d"); ?>" size="15" readonly="readonly" /></td>
          </tr>
          <tr valign="baseline">
            <td height="35" align="right" nowrap="nowrap">መመለሻ ቀን:</td>
		...
		<input type="text" name="ReportOn" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' /></td>
          ...
          <tr valign="baseline">
            ...
            <td><input type="submit" value="Grant Maternity leave" onclick="return confirm('Are you sure you want to Grant Matternity Leave for this Employee?')"  /></td>
          </tr>
        </table>
...
-->
  ...
  <div id="sidecontent">
    ...
    <p></p><br />
    <a href="../Proclamation/Ethiopian Labour Law Pro.377-2003 Amharic and English.htm#a86" target="_blank">ስለ ወሊድ ፍቃድ አዋጅ</a> 
