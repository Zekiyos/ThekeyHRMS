...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO medical_referral (ID,FirstName, MiddelName, LastName, Department, Refferal_Date) VALUES (%s,%s, %s, %s, %s, %s)",
                       GetSQLValueString($_GET['ID'], "text"),
                       GetSQLValueString($_POST['FirstName'], "text"),
                       GetSQLValueString($_POST['MiddelName'], "text"),
                       GetSQLValueString($_POST['LastName'], "text"),
                       GetSQLValueString($_POST['Department'], "text"),
                       GetSQLValueString($_POST['Refferal_Date'], "date"));
...
mysql_select_db($database_HRMS, $HRMS);
$query_RSMedicalRefferal = "SELECT * FROM annual_leave";
$RSMedicalRefferal = mysql_query($query_RSMedicalRefferal, $HRMS) or die(mysql_error());
$row_RSMedicalRefferal = mysql_fetch_assoc($RSMedicalRefferal);
$totalRows_RSMedicalRefferal = mysql_num_rows($RSMedicalRefferal);
?>
...
background:#EEEEEE">ጥቅማ ጥቅም</span></a>
          <ul>
            <li><a href="Medical_Referral.php"><span style="font-size:11.0pt;font-family:&quot;TITUS Cyberbit Basic&quot;,&quot;serif&quot;;color:#FF6600;
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" --> <blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote>
			   <?php include("Select_ID4MedicalReferral.php");?>
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    <table align="center" bgcolor="#EBEBEB">
                   <tr valign="baseline">
                     <td height="41" align="right" nowrap="nowrap">ስም :</td>
					...
					if($_GET['ID'] =="")
			    {
				 ...
				 ?>" size="20" readonly="readonly" /></td>
                   ...
                   <tr valign="baseline">
                     <td height="41" align="right" nowrap="nowrap">የአባት ስም :</td>
					...
					if($_GET['ID'] =="")
			    {
				 ...
				 ?>" size="20" readonly="readonly" /></td>
                   ...
                   <tr valign="baseline">
                     <td height="40" align="right" nowrap="nowrap">የስራ ክፍል :</td>
					...
					if($_GET['ID'] =="")
			    {
				 ...
				 ?>" size="20" readonly="readonly" /></td>
                   ...
                   <tr valign="baseline">
                     <td height="33" align="right" nowrap="nowrap">ቀን:</td>
                     <td><script type='text/JavaScript' src="../../Calendar/scw.js" ></script>
		
		<input type="text" name="Refferal_Date" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' /></td>
                   </tr>
                   <tr valign="baseline">
                     <td nowrap="nowrap" align="right">&nbsp;</td>
                     <td><input type="submit" value="Refere" /></td>
                   </tr>
    </table>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    ...
    <p>
      <input type="hidden" name="MM_insert" value="form1" />
               ...
               <p>&nbsp;</p>
<?php
mysql_free_result($RSMedicalRefferal);
?>
...
-->
  ...
  <div id="sidecontent">
    ...
    <p></p>
    <br />
    <a href="../Proclamation/Ethiopian Labour Law Pro.377-2003 Amharic and English.htm#a103" target="_blank">ስለ ሕክምና አገልግሎት አዋጅ</a>
