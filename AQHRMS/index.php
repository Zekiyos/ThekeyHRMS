...
<?php echo "<font face=\"Times New Roman, Times, serif\" size=\"+1\"><b>logged in as ".$_SESSION['MM_Username']."</b></font>";  ?>
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
     <p>&nbsp;</p>
     <?php // echo $obj_lang->get('Home', $lang); ?>
     <?php //echo $obj_lang->get('Hoe', $lang); ?>
     <?php // echo $obj_lang->get('Recruitment', $lang); ?>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
...
-->
  ...
  <div id="sidecontent">
    ...
    <?php echo "<font face=\"Times New Roman, Times, serif\" size=\"+1\" color=\"#F60\"><b>"; include("Calendar/time.html"); echo "</font></b>"?></p><br />
    <br />
    <br />
           <?php  
