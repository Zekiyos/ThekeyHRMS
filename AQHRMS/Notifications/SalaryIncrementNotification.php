...
Salary+0.8 as Increment from aqhrmsdb.employee_personal_record 
...
Salary+0.50 as Increment from aqhrmsdb.employee_personal_record 
...
if($firstYeartotal>0 OR $secondYeartotal >0){
	$totalnumber=$firstYeartotal+ $secondYeartotal;
			...
			//slmg[<?php //echo $i;?>]='<?php //echo "<font  color=\"#FF9900\" size=\"+1\" face=\"Times New Roman, Times, serif\">"."{$row['FirstName']}"." {$row['MiddelName']}"." {$row['LastName']}"."<br>";
					...
					slmg[<?php echo $i;?>]='<?php echo "<font  color=\"#FF9900\" size=\"+1\" face=\"Times New Roman, Times, serif\">"." Total {$totalnumber} Emplyee available on this month Increment <br>";
