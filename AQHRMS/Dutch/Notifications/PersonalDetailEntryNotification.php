...
$d=date("Y-m-d");
		...
		echo "<font color=\"#03F\" size=\"+0\" >"."Klaar bent met zijn / haar  Proeftijd en bracht zijn / haar evaluatieonderzoek.Je moet eerst zijn  <a href=\"Employee_Personal_Record.php\" > Persoonlijke details</a>" . "</span><p> </p>";	
				?>';
					<?php
