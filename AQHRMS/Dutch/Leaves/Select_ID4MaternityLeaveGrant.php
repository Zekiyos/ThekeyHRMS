...
mysql_select_db($database_HRMS, $HRMS);
$query_RSID = "SELECT ID FROM employee_personal_record where Sex='Female'";
...
location="Maternity_Leave_Grant.php?ID=" + elem.value;
...
<form id="form1" name="form1" method="get" action="" >
  <p>
    <label for="ID"><span id="result_box" lang="nl" xml:lang="nl"><span title="Click for alternate translations">Selecteer</span></span> Employee ID:</label>
