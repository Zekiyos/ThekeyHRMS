...
mysql_select_db($database_HRMS, $HRMS);
//$query_RSID = "SELECT ID FROM employee_personal_record";

$query_RSID = "SELECT ID FROM annual_leave UNION
 SELECT ID FROM sick_leave UNION
  SELECT ID FROM funeral_leave UNION
   SELECT ID FROM maternity_leave UNION
    SELECT ID FROM wedding_leave ORDER BY ID ASC";
...
location="Back_From_Leave_Report.php?ID=" + elem.value;
...
<form id="form1" name="form1" method="get" action="" >
  <p><span id="result_box" lang="nl" xml:lang="nl"><span title="Click for alternate translations">Selecteer</span></span> Employee ID:
