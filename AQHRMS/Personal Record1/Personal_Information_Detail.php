...
function toggle_all() {
    ...
    <tr><td width="189" height="14"></td><td width="403"><input value="Leave" type="button" onclick="javascript:toggle('Leave')" /><input value="Equipment" type="button" onclick="javascript:toggle('Equipment')" />
