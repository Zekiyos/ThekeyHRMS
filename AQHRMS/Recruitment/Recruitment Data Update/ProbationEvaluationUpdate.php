...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE probation_evalutaion SET ID=%s, FirstName=%s, MiddelName=%s, LastName=%s, Department=%s, `Position`=%s, Date_Employement=%s, Attendance=%s, Motivation=%s, Performance_Individual=%s, Performance_Group=%s, Communication_Supervisor=%s, Manger_Remark=%s, HR_Opinon=%s, `Date`=%s, `Result`=%s WHERE Auto_ID=%s",
...
$query_RSProbationEvaluationUpdate = "SELECT * FROM  probation_evalutaion where Auto_ID=".$_GET['Auto_ID']."";}else
$query_RSProbationEvaluationUpdate = "SELECT * FROM probation_evalutaion where Auto_ID=-1";

//$query_RSProbationEvaluationUpdate = "SELECT * FROM probation_evalutaion";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
 <font color="#FF6600" size="+1" > <p align="center">Probation Evaluation Data Update Form</p></font>
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">ID:</td>
      <td><input type="text" name="ID" value="<?php echo htmlentities($row_RSProbationEvaluationUpdate['ID'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">First Name:</td>
      <td><input type="text" name="FirstName" value="<?php echo htmlentities($row_RSProbationEvaluationUpdate['FirstName'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Middel Name:</td>
      <td><input type="text" name="MiddelName" value="<?php echo htmlentities($row_RSProbationEvaluationUpdate['MiddelName'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Last Name:</td>
      <td><input type="text" name="LastName" value="<?php echo htmlentities($row_RSProbationEvaluationUpdate['LastName'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Department:</td>
      <td><input type="text" name="Department" value="<?php echo htmlentities($row_RSProbationEvaluationUpdate['Department'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Position:</td>
      <td><input type="text" name="Position" value="<?php echo htmlentities($row_RSProbationEvaluationUpdate['Position'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Date of Employement:</td>
      <td><input type="text" name="Date_Employement" value="<?php echo htmlentities($row_RSProbationEvaluationUpdate['Date_Employement'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Attendance:</td>
      <td><select name="Attendance">
        <option value="Poor" <?php if (!(strcmp("Poor", htmlentities($row_RSProbationEvaluationUpdate['Attendance'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Poor</option>
        <option value="Good" <?php if (!(strcmp("Good", htmlentities($row_RSProbationEvaluationUpdate['Attendance'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Good</option>
        <option value="Very Good" <?php if (!(strcmp("Very Good", htmlentities($row_RSProbationEvaluationUpdate['Attendance'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Very Good</option>
      </select></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Motivation:</td>
      <td><select name="Motivation">
        <option value="Poor" <?php if (!(strcmp("Poor", htmlentities($row_RSProbationEvaluationUpdate['Motivation'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Poor</option>
        <option value="Good" <?php if (!(strcmp("Good", htmlentities($row_RSProbationEvaluationUpdate['Motivation'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Good</option>
        <option value="Very Good" <?php if (!(strcmp("Very Good", htmlentities($row_RSProbationEvaluationUpdate['Motivation'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Very Good</option>
      </select></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Performance as Individual:</td>
      <td><select name="Performance_Individual">
        <option value="Poor" <?php if (!(strcmp("Poor", htmlentities($row_RSProbationEvaluationUpdate['Performance_Individual'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Poor</option>
        <option value="Good" <?php if (!(strcmp("Good", htmlentities($row_RSProbationEvaluationUpdate['Performance_Individual'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Good</option>
        <option value="Very Good" <?php if (!(strcmp("Very Good", htmlentities($row_RSProbationEvaluationUpdate['Performance_Individual'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Very Good</option>
      </select></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Performance in Group:</td>
      <td><select name="Performance_Group">
        <option value="Poor" <?php if (!(strcmp("Poor", htmlentities($row_RSProbationEvaluationUpdate['Performance_Group'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Poor</option>
        <option value="Good" <?php if (!(strcmp("Good", htmlentities($row_RSProbationEvaluationUpdate['Performance_Group'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Good</option>
        <option value="Very Good" <?php if (!(strcmp("Very Good", htmlentities($row_RSProbationEvaluationUpdate['Performance_Group'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Very Good</option>
      </select></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Communication with Supervisor:</td>
      <td><select name="Communication_Supervisor">
        <option value="Poor" <?php if (!(strcmp("Poor", htmlentities($row_RSProbationEvaluationUpdate['Communication_Supervisor'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Poor</option>
        <option value="Good" <?php if (!(strcmp("Good", htmlentities($row_RSProbationEvaluationUpdate['Communication_Supervisor'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Good</option>
        <option value="Very Good" <?php if (!(strcmp("Very Good", htmlentities($row_RSProbationEvaluationUpdate['Communication_Supervisor'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Very Good</option>
      </select></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><select name="Result">
        <option value="Failed" <?php if (!(strcmp("Failed", htmlentities($row_RSProbationEvaluationUpdate['Result'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Failed</option>
        <option value="Passed" <?php if (!(strcmp("Passed", htmlentities($row_RSProbationEvaluationUpdate['Result'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Passed</option>
      </select></td>
    </tr>
    <tr valign="baseline">
   ...
   <ul id="MenuBar2" class="MenuBarVertical">
     ...
     <li><a href="#" class="MenuBarItemSubmenu"><?php echo $obj_lang->get('Personal Detail', $lang); ?></a>
       ...
       <li><a href="../Probation_Evaluation.php"><?php echo $obj_lang->get('Probation Period Evaluation', $lang); ?></a>       </li>
         ...
         <li><a href="ProbationPersonalRecordDisplay.php" title="Probation Period Personal Record Search" target="_blank"><?php echo $obj_lang->get('Probation Period Record Search', $lang); ?></a></li>
       </ul>
     </li>
...
-->
  ...
  <div id="sidecontent">
    ...
    <?php   
	//include ("../../Notifications/EvalutionNotification.php");?>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($RSProbationEvaluationUpdate);
?>
