...
location="OTSetup.php?Department=" + elem.value;
...
<form id="form1" name="form1" method="get" action="" >
  <p>
    ...
    <select name="Department" id="Department" onchange="SelectedDepartment(document.getElementById('Department'), 'Please Choose Something')">
