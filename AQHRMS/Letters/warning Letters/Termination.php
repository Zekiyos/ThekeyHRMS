...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO terminated_employee (ID,FirstName, MiddelName, LastName, Department, Terminated_Date,Termination_Reason) VALUES (%s,%s, %s, %s, %s, %s, %s)",
			  ...
			  //$UnpaidHourAfterTerminted="Select @TotalMonthOffDay:=DAY( LAST_DAY('".$DateValue."' ))/7 AS TotalMonthOffDay,
					...
					/*********************				
				//$UnpaidHourAfterTerminted="Select @AbsentDay:= DateDiff( LAST_DAY('".$DateValue."' ),'".$DateValue."') AS AbsentDay,
					//				@AbsentWorkingHour:= @AbsentDay *8 AS AbsentWorkingHour"; //making a diffrence of the date value from last day of the month and the day of termnation
...
$UnpaidHourAfterTerminted="Select @TotalMonthOffDay:=DAY( LAST_DAY('".$DateValue."' ))/7 AS TotalMonthOffDay,
									...
									@AbsentWorkingHour:=208 -(@PersentWorkingDay*8), 0) AS AbsentWorkingHour";
   ...
   <blockquote>
     <blockquote>
      <blockquote>
       <blockquote>
         <blockquote>
           <blockquote> <font color="#FF6600" size="+1"><?php echo $obj_lang->get('Employee Termination Form', $lang);?></font>
      ...
      <table width="357" height="345" align="center" bgcolor="#EBEBEB">
        ...
        <td nowrap="nowrap" align="right"><?php echo $obj_lang->get('ID', $lang);?>:</td>
          <td><input type="text" name="ID" value="<?php if(isset($_GET['ID']))
			    {echo $_GET['ID'];}?>"  readonly="readonly"/>
          </td>
          </tr>
...
-->
  ...
  <div id="sidecontent">
    ...
    <p><br />
    <br /> <br />
    <br /><a href="../../Proclamation/Ethiopian Labour Law Pro.377(English).htm#a26" target="_blank"><?php echo $obj_lang->get('Terminations Labour Law', $lang);?></a></p>
