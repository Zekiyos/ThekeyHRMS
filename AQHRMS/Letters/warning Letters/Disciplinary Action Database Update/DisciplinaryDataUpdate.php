...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE disciplinary_action SET ID=%s, FirstName=%s, MiddelName=%s, LastName=%s, Department=%s, `Position`=%s, Verbal_Warning=%s, Verbal_Warning_Date=%s, First_Inistance=%s, First_Inistance_Date=%s, Second_Inistance=%s, Second_Inistance_Date=%s, Third_Inistance=%s, Third_Inistance_Date=%s, Last_Warning=%s, Last_Warning_Date=%s WHERE Auto_ID=%s",
                       ...
                       GetSQLValueString($_POST['Verbal_Warning_Date'], "date"),
                       GetSQLValueString($_POST['First_Inistance'], "text"),
                       GetSQLValueString($_POST['First_Inistance_Date'], "date"),
                       GetSQLValueString($_POST['Second_Inistance'], "text"),
                       GetSQLValueString($_POST['Second_Inistance_Date'], "date"),
                       GetSQLValueString($_POST['Third_Inistance'], "text"),
                       GetSQLValueString($_POST['Third_Inistance_Date'], "date"),
                       GetSQLValueString($_POST['Last_Warning'], "text"),
                       GetSQLValueString($_POST['Last_Warning_Date'], "date"),
...
$query_RSDisciplinaryDataUpdate = "SELECT * FROM  disciplinary_action where Auto_ID=".$_GET['Auto_ID']."";}else
...
<li><a href="DisciplinaryDataDisplay.php" title="Disciplinary Action Data" target="_blank"><?php echo $obj_lang->get('Disciplinary Action  Data', $lang); ?></a></li>
...
<li><a href="TerminationDisplay.php" title="Termination Data" target="_blank"><?php echo $obj_lang->get('Termination Data', $lang); ?></a></li>
           </ul>
         </li>
