...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE terminated_employee SET ID=%s, FirstName=%s, MiddelName=%s, LastName=%s, Department=%s, Terminated_Date=%s, Termination_Reason=%s WHERE Auto_ID=%s",
  ...
  $updateGoTo = "TerminationDisplay.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$query_RSTerminationUpdate = "SELECT * FROM  terminated_employee where Auto_ID=".$_GET['Auto_ID']."";}else
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($RSTerminationUpdate);
?>
<script type="text/javascript">
var MenuBar1 = new Spry.Widget.MenuBar("MenuBar1", {imgDown:"SpryAssets/SpryMenuBarDownHover.gif", imgRight:"SpryAssets/SpryMenuBarRightHover.gif"});
</script>
