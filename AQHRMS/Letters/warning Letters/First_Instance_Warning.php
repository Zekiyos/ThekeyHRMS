 ...
 <?php  //include("Select_ID4FirstInstanceWarning.php");
    ...
    <blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote> <font color="#FF6600" size="+1"><?php echo $obj_lang->get('First Instance Warning Letter', $lang); ?></font></blockquote></blockquote></blockquote></blockquote></blockquote>
    ...
    <table width="706" align="center">
     <tr valign="baseline">
      ...
      <td>:        <input type="text" name="Department" value="<?php
		...
		<?php echo $obj_lang->get('Date', $lang); ?>:<input type="text" name="First_Inistance_Date" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' /></td>
    </tr>
    
    <tr valign="baseline">
      <td nowrap="nowrap" align="right" valign="top"><?php echo $obj_lang->get('First Inistance', $lang);?><br /> <?php echo $obj_lang->get('Sample', $lang);?><br />  <?php echo $obj_lang->get('Warning Letter', $lang);?>
 </td>
      <td><textarea name="First_Inistance" cols="70" rows="40" >
...
-->
  ...
  <div id="sidecontent">
    ...
    <br /> <br />
    <br />
    <a href="../../Proclamation/Ethiopian Labour Law Pro.377(English).htm#a28" target="_blank"><?php echo $obj_lang->get('Warnings Labour Law', $lang); ?></a>
