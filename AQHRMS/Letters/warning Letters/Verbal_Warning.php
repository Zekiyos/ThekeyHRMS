 ...
 <?php  //include("Select_ID4VerbalWarning.php");
     ...
     <blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote> <font color="#FF6600" size="+1"><?php echo $obj_lang->get('Verbal Warning Letter', $lang);?></font></blockquote></blockquote></blockquote></blockquote></blockquote>
    ...
    <table width="706" align="center">
     <tr valign="baseline">
      ...
      <td><input type="text" name="FirstName" value="<?php
				...
				}?>" size="20" readonly="readonly"  /><?php echo $obj_lang->get('Middel Name', $lang);?>:
      ...
      <td>:        <input type="text" name="Department" value="<?php
		...
		<?php echo $obj_lang->get('Date', $lang);?>:<input type="text" name="Verbal_Warning_Date" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' /></p></td>
    </tr>
    
    <tr valign="baseline">
      <td nowrap="nowrap" align="right" valign="top"><?php echo $obj_lang->get('Verbal', $lang);?><br /> <?php echo $obj_lang->get('Sample', $lang);?><br />  <?php echo $obj_lang->get('Warning Letter', $lang);?></td>
      <td align="left"><textarea name="Verbal_Warning" cols="30" rows="20">
