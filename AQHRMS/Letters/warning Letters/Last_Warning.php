...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
			...
			$updateDASQL="UPDATE Disciplinary_action SET `Last_Warning`='". $_POST['Last_Warning'] ."',`Last_Warning_Date`='". $_POST['Last_Warning_Date']."' WHERE ID = '". $_GET['ID'] ."'";
  ...
  $insertSQL = sprintf("INSERT INTO disciplinary_action (ID, FirstName, MiddelName, LastName, Department, Last_Warning,Last_Warning_Date) VALUES (%s,%s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_GET['ID'], "text"),
                       GetSQLValueString($_POST['FirstName'], "text"),
                       GetSQLValueString($_POST['MiddelName'], "text"),
                       GetSQLValueString($_POST['LastName'], "text"),
                       GetSQLValueString($_POST['Department'], "text"),
                       GetSQLValueString($_POST['Last_Warning'], "text"),
					   GetSQLValueString($_POST['Last_Warning_Date'], "text"));
...
<?php echo "<font face=\"Times New Roman, Times, serif\" size=\"+1\"><b>logged in as ".$_SESSION['MM_Username']."</b></font>";  ?>
 ...
 <?php  //include("Select_ID4LastWarning.php");
	 ?><?php
$_GET['TableName']="employee_personal_record";

$_GET['OpenPage']="Last_Warning";

 include("../../Search Name/SearchName.php");?> <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    <table width="706" align="center">
     <tr valign="baseline">
      ...
      <td>:        <input type="text" name="Department" value="<?php
		...
		Date:<input type="text" name="Last_Warning_Date" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' /></td>
    </tr>
    
    <tr valign="baseline">
      <td nowrap="nowrap" align="right" valign="top"><?php echo $obj_lang->get('Sample', $lang);?><br /> <?php echo $obj_lang->get('Last', $lang);?><br />  <?php echo $obj_lang->get('Warning Letter', $lang);?></td>
      <td><textarea name="Last_Warning" cols="70" rows="30">
...
-->
  ...
  <div id="sidecontent">
    ...
    <br /> <br />
    <br />
    <a href="../../Proclamation/Ethiopian Labour Law Pro.377(English).htm#a28" target="_blank"><?php echo $obj_lang->get('Warnings Labour Law', $lang);?></a></p>
