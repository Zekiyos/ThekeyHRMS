...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
				...
				while($rowDA = mysql_fetch_array($resultDA, MYSQL_ASSOC))
				{
					...
					$updateDASQL="UPDATE Disciplinary_action SET `Third_Inistance`='". $_POST['Third_Inistance'] ."',`Third_Inistance_Date`='". $_POST['Third_Inistance_Date']."' WHERE ID = '". $_GET['ID'] ."'";
  ...
  $insertSQL = sprintf("INSERT INTO disciplinary_action (ID, FirstName, MiddelName, LastName, Department, Third_Inistance, Third_Inistance_Date) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_GET['ID'], "text"),
                       GetSQLValueString($_POST['FirstName'], "text"),
                       GetSQLValueString($_POST['MiddelName'], "text"),
                       GetSQLValueString($_POST['LastName'], "text"),
                       GetSQLValueString($_POST['Department'], "text"),
                       GetSQLValueString($_POST['Third_Inistance'], "text"),
					   GetSQLValueString($_POST['Third_Inistance_Date'], "text"));
...
<?php echo "<font face=\"Times New Roman, Times, serif\" size=\"+1\"><b>logged in as ".$_SESSION['MM_Username']."</b></font>";  ?>
 ...
 <?php //include("Select_ID4ThirdInstanceWarning.php");
	 ?>
     <blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote> <font color="#FF6600" size="+1"><?php echo $obj_lang->get('Third Instance Warning Letter', $lang);?></font></blockquote></blockquote></blockquote></blockquote></blockquote>
        <blockquote> <blockquote><?php
$_GET['TableName']="employee_personal_record";

$_GET['OpenPage']="Third_Instance_Warning";

 include("../../Search Name/SearchName.php");?></blockquote></blockquote>
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    <table width="706" align="center">
     <tr valign="baseline">
      <td nowrap="nowrap" align="right"><?php echo $obj_lang->get('First Name', $lang);?><input type="text" name="FirstName" value="<?php
				...
				}?>" size="20" readonly="readonly"  /><?php echo $obj_lang->get('Middel Name', $lang);?><?php echo $obj_lang->get('MIddel Name', $lang); ?>:<input type="text" name="MiddelName" value="<?php
       ...
       <?php echo $obj_lang->get('Last Name', $lang); ?>:
		...
		Date:<input type="text" name="Third_Inistance_Date" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' /></td>
    </tr>
    
    <tr valign="baseline">
      <td nowrap="nowrap" align="right" valign="top"><?php echo $obj_lang->get('Third Inistance', $lang);?><br /> <?php echo $obj_lang->get('Sample', $lang);?><br />  <?php echo $obj_lang->get('Warning Letter', $lang);?></td>
      <td><textarea name="Third_Inistance" cols="70" rows="30">
     
    
 <table  >
<tr>
<td><img  src="letter/AQLOGO.bmp" height="100" width="150" /></td>
<td> AQ Roses PLC<br />
P.O.Box 404<br/>
Ziway<br />
Ethiopia<br />
...
<table border="1" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="249" valign="top"><p align="center">የሦስተኛ<br />
      ማስጠንቀቂያ<br />
      3rd Warning Letter</p></td>
...
Emloyees  Name &amp; signature <u>                                                                  </u>
    ...
    <tr valign="baseline">
      ...
      <td><blockquote><blockquote><input type="reset" name="reset" value="<?php echo $obj_lang->get('Reset', $lang);?>" />
        <input type="submit" value="<?php echo $obj_lang->get('Issue This Letter', $lang);?>" onClick="return confirm('Are you sure you want Issue to This Letter for this Employee?')" /></td>
    </tr>
  </table>
