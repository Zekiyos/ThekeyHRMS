...
<li><a href="../Letters/Contract Letters/Contract Letter.php"><?php echo $obj_lang->get('Contract Letter', $lang); ?></a></li>
        ...
        <li><a href="#" class="MenuBarItemSubmenu"><?php echo $obj_lang->get('Benefits', $lang); ?></a>
          <ul>
            ...
            <li><a href="Training.php"><?php echo $obj_lang->get('Training', $lang); ?></a></li>
          </ul>
        </li>
</ul>
<?php echo "<font face=\"Times New Roman, Times, serif\" size=\"+1\"><b>logged in as ".$_SESSION['MM_Username']."</b></font>";  ?>
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
    ...
    <blockquote>
     <blockquote>
      <blockquote>
       <font color="#FF6600" size="+1"> <?php  echo $obj_lang->get('Training status entry Form ', $lang); ?></font>
...
?>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
     ...
     <input name="ID" value="<?php if(isset($_GET['ID'] ))
        ...
        <tr>
        <td><?php  echo $obj_lang->get('Training Refreshment Date', $lang); ?>:</td><td><input type="text"name="Refreshment_Date" id="Refreshment_Date" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' /></td>
        </tr>
        <tr>
