...
?>
<?php 
if(isset($_POST['GrantAL_Insert']) && ($_POST['GrantAL_Insert']=="GrantAL"))
{
	if(isset($_POST['Page_Description']) && isset($_POST['Granted_Access_Level']))
	{
	
	$CheckedAL="";
	$count2=0;
	foreach ($_POST['Granted_Access_Level'] as $names){ 
	if($count2==0)
	$CheckedAL = $names;
	else
	$CheckedAL = $CheckedAL .",".$names;
	$count2 ++;
	}
	//print $Checked;
	//if (isset($HTTP_POST_VARS)) 
    //$Granted_Access_Level = $HTTP_POST_VARS["Granted_Access_Level"];
	
	$sqlUPDT="UPDATE `access_level_privilege` SET 
	               `Granted_Access_Level`='".$CheckedAL."' WHERE `Page_Description`='".$_POST['Page_Description']."'";
...
<font color="#FF6600" size="+1"> <p align="center"><?php  echo $obj_lang->get('HRMS Access Level Grant Form', $lang); ?></p></font>
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" name="GrantAL" id="GrantAL" method="post">
      <table width="776" height="299" bgcolor="#EBEBEB">
      <tr>
       <td width="448">
       Choose The file Name Description to Grant Access Level    <br />
       <fieldset >
         <legend >File Name To be Granted</legend>
     
      <?php echo $obj_AccessLevel->RetriveData('Page_Description','RADIO');?>
      
    </fieldset>
      </td>
     
       <td width="316" height="140">
       Check Access Level which you want to provied a Permission for selected File Name.
       <fieldset ><legend >Access Level</legend>
           <?php echo $obj_AccessLevel->RetriveData('Granted_Access_Level','CHECKBOX');?>
      </fieldset>
      </td>
      </tr>
      <tr>
      <td align="right"><input type="submit" value="Grant Access Level"  />
      </td>
      <td>&nbsp;</td>
      </tr>
      </table>
      <input type="hidden" name="GrantAL_Insert" value="GrantAL" />
      </form>
...
<li><a href="../Letters/warning Letters/Disciplinary Action Database Update/TerminationDisplay.php" title="Termination Data" target="_blank"><?php echo $obj_lang->get('Termination Data', $lang); ?></a></li>
      ...
      <li><a href=""><?php echo $obj_lang->get('Access Level', $lang); ?></a>
              <ul>
            <li><a href="Creat_Access_Level.php"><?php echo $obj_lang->get('Creat Access Level', $lang); ?></a></li>      
            <li><a href="Access_Level_Grant.php"><?php echo $obj_lang->get('Access Level Grant', $lang); ?></a></li>      
            <li><a href="Access Level_Database_Update/Access_Level_Display.php"><?php echo $obj_lang->get('Access Level Data ...', $lang); ?></a></li>            
