...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  echo "<script type=\"text/javascript\"> alert('You have Creat for perrmission {$_POST['PageName']} with Access Level for {$_POST['Granted_Access_Level']} Successfully'); </script>";
}
...
mysql_select_db($database_HRMS, $HRMS);
$query_RSCreatAccessLevel = "SELECT * FROM access_level_privilege";
$RSCreatAccessLevel = mysql_query($query_RSCreatAccessLevel, $HRMS) or die(mysql_error());
$row_RSCreatAccessLevel = mysql_fetch_assoc($RSCreatAccessLevel);
$totalRows_RSCreatAccessLevel = mysql_num_rows($RSCreatAccessLevel);
?>
...
<?php echo "<font face=\"Times New Roman, Times, serif\" size=\"+1\"><b>logged in as ".$_SESSION['MM_Username']."</b></font>";  ?>
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->	
    <p>&nbsp;</p>
    <font color="#FF6600" size="+1"> <p align="center"><?php  echo $obj_lang->get('Creat Access Level Permission Grant Form', $lang); ?></p></font>
    
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center" bgcolor="#EBEBEB">
        
        <tr valign="baseline">
          <td nowrap="nowrap" align="right" valign="top">Page Name(Full Path):</td>
          <td><textarea name="PageName" cols="50" rows="2"></textarea></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right" valign="top">Page Description:</td>
          <td><textarea name="Page_Description" cols="50" rows="2"></textarea></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right" valign="top">Granted Access Level:</td>
          <td><textarea name="Granted_Access_Level" cols="50" rows="3"></textarea></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">&nbsp;</td>
          <td><input type="submit" value="Grant Access Level" /></td>
        </tr>
      </table>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($RSCreatAccessLevel);
?>
<script type="text/javascript">
var MenuBar1 = new Spry.Widget.MenuBar("MenuBar1", {imgDown:"SpryAssets/SpryMenuBarDownHover.gif", imgRight:"SpryAssets/SpryMenuBarRightHover.gif"});
</script>
