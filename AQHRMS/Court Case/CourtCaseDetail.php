...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO court_case_detail (ID, FirstName, MiddelName, LastName, File_Date, Claim_Amount, AdvocateName, `Case`, Court, Pending_Date, Against, Infavour, Decision) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['ID'], "text"),
                       GetSQLValueString($_POST['FirstName'], "text"),
                       GetSQLValueString($_POST['MiddelName'], "text"),
                       GetSQLValueString($_POST['LastName'], "text"),
                       GetSQLValueString($_POST['File_Date'], "date"),
                       GetSQLValueString($_POST['Claim_Amount'], "double"),
                       GetSQLValueString($_POST['AdvocateName'], "text"),
                       GetSQLValueString($_POST['Case'], "text"),
                       GetSQLValueString($_POST['Court'], "text"),
                       GetSQLValueString($_POST['Pending_Date'], "date"),
                       GetSQLValueString($_POST['Against'], "text"),
                       GetSQLValueString($_POST['Infavour'], "text"),
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="MiddelName" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">File_Date:</td>
          <td><input type="text" name="File_Date" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Claim_Amount:</td>
          <td><input type="text" name="Claim_Amount" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">AdvocateName:</td>
          <td><input type="text" name="AdvocateName" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right" valign="top">Case:</td>
          <td><textarea name="Case" cols="50" rows="5"></textarea></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Court:</td>
          <td><select name="Court">
            <option value="Woreda" <?php if (!(strcmp("Woreda", ""))) {echo "SELECTED";} ?>>Woreda</option>
            <option value="High Court" <?php if (!(strcmp("High Court", ""))) {echo "SELECTED";} ?>>High Court</option>
            <option value="Oromia Supreme Court" <?php if (!(strcmp("Oromia Supreme Court", ""))) {echo "SELECTED";} ?>>Oromia Supreme Court</option>
            <option value="State Cassation" <?php if (!(strcmp("State Cassation", ""))) {echo "SELECTED";} ?>>State Cassation</option>
            <option value="Federal Supreme Court" <?php if (!(strcmp("Federal Supreme Court", ""))) {echo "SELECTED";} ?>>Federal Supreme Court</option>
          </select></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Pending_Date:</td>
          <td><input type="text" name="Pending_Date" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Against:</td>
          <td><select name="Against">
            <option value="YES" <?php if (!(strcmp("YES", ""))) {echo "SELECTED";} ?>>YES</option>
            <option value="NO" <?php if (!(strcmp("NO", ""))) {echo "SELECTED";} ?>>NO</option>
          </select></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Infavour:</td>
          <td><select name="Infavour">
            <option value="YES" <?php if (!(strcmp("YES", ""))) {echo "SELECTED";} ?>>YES</option>
            <option value="NO" <?php if (!(strcmp("NO", ""))) {echo "SELECTED";} ?>>NO</option>
          </select></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right" valign="top">Decision:</td>
          <td><textarea name="Decision" cols="50" rows="5"></textarea></td>
        </tr>
        <tr valign="baseline">
