...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO court_case(`ID`,`FirstName`, `MiddelName`, `LastName`, `Department`,`FileNumber`,`ClaimAmount`,`AdvocateName`, `Court`, `Case`, `Result`,`Decision`, `Case_Status`,`AppointmentDate`,`FileDate`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['ID'], "text"),
                       GetSQLValueString($_POST['FirstName'], "text"),
                       GetSQLValueString($_POST['MiddelName'], "text"),
                       GetSQLValueString($_POST['LastName'], "text"),
                       GetSQLValueString($_POST['Department'], "text"),
					   GetSQLValueString($_POST['FileNumber'], "text"),
					   GetSQLValueString($_POST['ClaimAmount'], "int"),
					   GetSQLValueString($_POST['AdvocateName'], "text"),
					  ...
					  GetSQLValueString($_POST['Result'], "text"),
					   GetSQLValueString($_POST['Decision'], "text"),
					     GetSQLValueString($_POST['Case_Status'], "text"),
					 GetSQLValueString($_POST['AppointmentDate'], "date"), 
					    GetSQLValueString($_POST['FileDate'], "date") );
...
<li><a href="#"><?php echo $obj_lang->get('Termination Letter', $lang); ?></a></li>
        ...
        <li><a href="http://localhost/Report/annual_leaverpt.php" target="_blank" class="MenuBarItemSubmenu"><?php echo $obj_lang->get('Report', $lang); ?></a>
          <ul>
            ...
            <li><a href="CourtCaseFilter.php" target="_blank"><?php echo $obj_lang->get('Court Case Report', $lang); ?></a></li>
...
<?php echo "<font face=\"Times New Roman, Times, serif\" size=\"+1\"><b>logged in as ".$_SESSION['MM_Username']."</b></font>";  ?>
 ...
 <p>&nbsp;</p>
   <blockquote>
        ...
        <font color="#FF6600" size="+1">Court Cases Registration Form</font>
          
	  <?php include("Select_ID4CourtCase.php");?>
        <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" >
      <table width="486" height="345" align="center" bgcolor="#EBEBEB">
        <tr valign="baseline">
        <td width="155" align="right" nowrap="nowrap">ID:</td>
          <td width="319"><input type="text" name="ID" value="<?php if(isset($_GET['ID'] ))
				{
		...
		<input type="text" name="FileDate" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' /></td>
        </tr>
        <tr>
             <td nowrap="nowrap" align="right">Calim Amount in Birr:</td>
        <td><input type="text" name="ClaimAmount" /></td>
        </tr>
        <tr>
             <td nowrap="nowrap" align="right">Advocator Name:</td>
        <td><input type="text" name="AdvocateName" /></td>
        </tr>
        
        <tr valign="baseline"><td nowrap="nowrap" align="right">Court</td><td>
        ...
        <tr valign="baseline"><td nowrap="nowrap" align="right">Decision</td><td>
      
        <input type="radio" name="Decision" value="Against Company"   />Against Company
  <input type="radio" name="Decision" value="Infavour Company"  />Infavour Company<br />
 	<input align="middle"  type="radio" name="Decision" value="Unknown" checked="checked"  />Unknown
             </td>
        </tr>
        <tr>
             <td nowrap="nowrap" align="right">Decision Result:</td>
        <td><textarea name="Result" id="Result" rows="5" cols="45"></textarea></td>
        </tr>
        <tr valign="baseline"><td nowrap="nowrap" align="right">Case Status</td><td><select name="Case_Status">
		...
		<input type="text" name="AppointmentDate" onclick='scwShow(this,event);' value='' /></td>
        </tr>
        
        
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">&nbsp;</td>
          <td><input type="submit" value="Register" onclick="return confirm('Are you sure you want to register this case for the specifed former employee? Click Ok to register Or cancel to omit registering the data.')" /></td>
        </tr>
      </table>
      <p>
   ...
   <ul id="MenuBar2" class="MenuBarVertical">
     ...
     <li><a class="MenuBarItemSubmenu" href="#"><?php echo $obj_lang->get('Employee Status Transaction', $lang); ?></a>
       <ul>
         ...
         <li><a href="Court_Case.php"><?php echo $obj_lang->get('Court Case', $lang); ?></a></li>
       </ul>
     </li>
...
-->
  ...
  <div id="sidecontent">
    ...
    <p><br />
    <br /> <br />
    <br /><a href="../Proclamation/Ethiopian Labour Law Pro.377(English).htm#a26" target="_blank">Terminations Labour Law</a></p>
    <?php include ("../Notifications/CourtAppointmentNotification.php");?>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
