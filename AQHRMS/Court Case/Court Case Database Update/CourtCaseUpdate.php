...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE court_case SET ID=%s, FirstName=%s, MiddelName=%s, LastName=%s, Department=%s, FileNumber=%s, FileDate=%s, ClaimAmount=%s, AdvocateName=%s, AppointmentDate=%s, Court=%s, `Case`=%s, `Result`=%s, Decision=%s, Case_Status=%s WHERE Auto_ID=%s",
                       ...
                       GetSQLValueString($_POST['ClaimAmount'], "double"),
...
$query_RSCourtCaseUpdate = "SELECT * FROM  court_case where Auto_ID=".$_GET['Auto_ID']."";}else
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          ...
          <td><input type="text" name="ID" value="<?php echo htmlentities($row_RSCourtCaseUpdate['ID'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">FirstName:</td>
          <td><input type="text" name="FirstName" value="<?php echo htmlentities($row_RSCourtCaseUpdate['FirstName'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">MiddelName:</td>
          <td><input type="text" name="MiddelName" value="<?php echo htmlentities($row_RSCourtCaseUpdate['MiddelName'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">LastName:</td>
          <td><input type="text" name="LastName" value="<?php echo htmlentities($row_RSCourtCaseUpdate['LastName'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Department:</td>
          <td><input type="text" name="Department" value="<?php echo htmlentities($row_RSCourtCaseUpdate['Department'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">FileNumber:</td>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">AppointmentDate:</td>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Case_Status:</td>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($RSCourtCaseUpdate);
?>
<script type="text/javascript">
var MenuBar1 = new Spry.Widget.MenuBar("MenuBar1", {imgDown:"SpryAssets/SpryMenuBarDownHover.gif", imgRight:"SpryAssets/SpryMenuBarRightHover.gif"});
</script>
