  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" --><blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote>
             <font color="#FF6600" size="+1"> <?php  echo $obj_lang->get('Wedding Leave Grant Form', $lang); ?></font>
...
-->
  ...
  <div id="sidecontent">
    ...
    <br /> <br />
    <br />
    <a href="../Proclamation/Ethiopian Labour Law Pro.377(English).htm#a81" target="_blank"><?php  echo $obj_lang->get('Wedding Leave Labour Law', $lang); ?></a>
