...
mysql_select_db($database_HRMS, $HRMS);
$query_RSMaternityLeaveGrant = "SELECT * FROM Special_leave";
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
        ...
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote>
              <font color="#FF6600" size="+1"><?php  echo $obj_lang->get('Special Leave Grant', $lang); ?></font> <font color="#00CC00" size="+1"><?php  echo $obj_lang->get('(WITH PAYMENT)', $lang); ?> </font>
			   <?php //include("Select_ID4SpecialLeaveGrant.php");?>
               <?php
$_GET['TableName']="employee_personal_record";

$_GET['OpenPage']="Special_Leave_Grant";
...
-->
  ...
  <div id="sidecontent">
    ...
    <br /> <br />
    <br />
    <a href="../Proclamation/Ethiopian Labour Law Pro.377(English).htm#a81" target="_blank"><?php  echo $obj_lang->get('Special Leave Labour Law', $lang); ?></a>
