...
<form action="ALCalculatedReport.php" method="post" name="form1" id="form1" target="POPUPW" onsubmit="POPUPW=window.open('ALCalculatedReport.php','POPUPW','width=400,height=450');" >
     ...
     <input name="ID" value="<?php if(isset($_GET['ID'] ))
        ...
        <tr valign="baseline">
          ...
          <td> <input type="submit" value="<?php echo $obj_lang->get('Calculate Annual Leave', $lang); ?>"    /></td>
        </tr>
