...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  //$insertSQL = sprintf("INSERT INTO funeral_leave (ID, FirstName, MiddelName, LastName, FuneralLeaveDays, FuneralLeave_Taken_Date, ReportOn) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
//  header(sprintf("Location: %s", $insertGoTo));
   if($_POST['LeaveType']=='Please Choose Leave Type')
    ...
    $sqlML="UPDATE Special_leave SET `Reported`='YES',Report_Back_Date='".$_POST['Reported_Back_Date']."' WHERE ID = '". $_GET['ID'] ."' and Reported='NO'";
    mysql_query($sqlML);
    ...
    $sqlML="UPDATE maternity_leave SET `Reported`='YES',Report_Back_Date='".$_POST['Reported_Back_Date']."' WHERE ID = '". $_GET['ID'] ."' and Reported='NO'";
    mysql_query($sqlML);
    ...
    $sqlSL="UPDATE sick_leave SET `Reported`='YES',Report_Back_Date='".$_POST['Reported_Back_Date']."' WHERE ID = '". $_GET['ID'] ."' and Reported='NO'";
    mysql_query($sqlSL);
    ...
    $sqlWL="UPDATE wedding_leave SET `Reported`='YES',Report_Back_Date='".$_POST['Reported_Back_Date']."' WHERE ID = '". $_GET['ID'] ."' and Reported='NO'";
    mysql_query($sqlWL);
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" --><blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote>
             <font color="#FF6600" size="+1"><?php  echo $obj_lang->get('Back to work from Leave Reporting Form', $lang); ?>  </font>
			   <?php include("Select_ID4BackFromLeaveReport.php");?>
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center" bgcolor="#EBEBEB">
          ...
          <tr valign="baseline">
            <td height="33" align="right" nowrap="nowrap"><?php  echo $obj_lang->get('Middel Name', $lang); ?>:</td>
          ...
          <tr valign="baseline">
            <td height="33" align="right" nowrap="nowrap"><?php  echo $obj_lang->get('Last Name', $lang); ?>:</td>
		...
		<input type="text" name="Reported_Back_Date" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' /></td>
          </tr>
          <tr valign="baseline">
...
-->
  ...
  <div id="sidecontent">
    ...
    <br /> <br />
    <br />
     <a href="../Proclamation/Ethiopian Labour Law Pro.377(English).htm#a76" target="_blank"><?php  echo $obj_lang->get('Leave Labour Law', $lang); ?></a>
