  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" --><blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote>
               <font color="#FF6600" size="+1"> <?php  echo $obj_lang->get('Funneral Leave Grant Form', $lang); ?> </font>
 ...
 include("../Search Name/SearchName.php");?>
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onmouseover="Numberofdays()">
        <table align="center" bgcolor="#EBEBEB">
          ...
          <tr valign="baseline">
            <td height="33" align="right" nowrap="nowrap"><?php  echo $obj_lang->get('Funeral Leave Days', $lang); ?>:</td>
...
-->
  ...
  <div id="sidecontent">
    ...
    <br /> <br />
    <br />
     <a href="../Proclamation/Ethiopian Labour Law Pro.377(English).htm#a81" target="_blank"><?php  echo $obj_lang->get('Funeral Leave Labour Law', $lang); ?></a>
