...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE wedding_leave SET ID=%s, FirstName=%s, MiddelName=%s, LastName=%s, Department=%s, WeddingLeavedays=%s, RestDay=%s, WeddingLeave_TakenDate=%s, ReportOn=%s, LeaveType=%s, Reported=%s, Report_Back_Date=%s WHERE Auto_ID=%s",
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <font color="#FF6600" size="+1" > <p align="center">Wedding Leave Record Update form</p></font>
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="ID" value="<?php echo htmlentities($row_RSWeddingLeaveUpdate['ID'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
