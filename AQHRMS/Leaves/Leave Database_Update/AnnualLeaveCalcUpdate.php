...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE annual_leave_calculate SET ID=%s, FirstName=%s, MiddelName=%s, LastName=%s, WorkingMonth=%s, WorkingYear=%s, ThisYearALdays=%s, LastYearALdays=%s, BeforeLastYearALdays=%s, TotalALdays=%s, TotalTakenDay=%s, TotalLeftDay=%s, Calculated_Date=%s, ModifiedBy=%s, BeforeLastYearLeft=%s, LastYearLeft=%s, ThisYearLeft=%s WHERE Auto_ID=%s",
                       GetSQLValueString($_POST['ID'], "text"),
                       GetSQLValueString($_POST['FirstName'], "text"),
                       GetSQLValueString($_POST['MiddelName'], "text"),
                       GetSQLValueString($_POST['LastName'], "text"),
                       GetSQLValueString($_POST['WorkingMonth'], "int"),
                       GetSQLValueString($_POST['WorkingYear'], "int"),
                       GetSQLValueString($_POST['ThisYearALdays'], "int"),
                       GetSQLValueString($_POST['LastYearALdays'], "int"),
                       GetSQLValueString($_POST['BeforeLastYearALdays'], "int"),
                       GetSQLValueString($_POST['TotalALdays'], "int"),
                       GetSQLValueString($_POST['TotalTakenDay'], "int"),
                       GetSQLValueString($_POST['TotalLeftDay'], "int"),
                       GetSQLValueString($_POST['Calculated_Date'], "date"),
                       GetSQLValueString($_POST['ModifiedBy'], "text"),
                       GetSQLValueString($_POST['BeforeLastYearLeft'], "int"),
                       GetSQLValueString($_POST['LastYearLeft'], "int"),
                       GetSQLValueString($_POST['ThisYearLeft'], "int"),
...
$query_RSAnnualLeaveCalcUpdate = "SELECT * FROM  annual_leave_calculate where Auto_ID=".$_GET['Auto_ID']."";}else
$query_RSAnnualLeaveCalcUpdate = "SELECT * FROM annual_leave_calculate where Auto_ID=-1";


//$query_RSAnnualLeaveCalcUpdate = "SELECT * FROM annual_leave_calculate";
$RSAnnualLeaveCalcUpdate = mysql_query($query_RSAnnualLeaveCalcUpdate, $HRMS) or die(mysql_error());
$row_RSAnnualLeaveCalcUpdate = mysql_fetch_assoc($RSAnnualLeaveCalcUpdate);
$totalRows_RSAnnualLeaveCalcUpdate = mysql_num_rows($RSAnnualLeaveCalcUpdate);
?>
...
<?php echo "<font face=\"Times New Roman, Times, serif\" size=\"+1\"><b>logged in as ".$_SESSION['MM_Username']."</b></font>";  ?>
 ...
 <font color="#FF6600" size="+2" > <p align="center"> Annual Leave Calculated Update Form</p></font>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">ID:</td>
      <td><input type="text" name="ID" value="<?php echo htmlentities($row_RSAnnualLeaveCalcUpdate['ID'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">FirstName:</td>
      <td><input type="text" name="FirstName" value="<?php echo htmlentities($row_RSAnnualLeaveCalcUpdate['FirstName'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">MiddelName:</td>
      <td><input type="text" name="MiddelName" value="<?php echo htmlentities($row_RSAnnualLeaveCalcUpdate['MiddelName'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">LastName:</td>
      <td><input type="text" name="LastName" value="<?php echo htmlentities($row_RSAnnualLeaveCalcUpdate['LastName'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">WorkingMonth:</td>
      <td><input type="text" name="WorkingMonth" value="<?php echo htmlentities($row_RSAnnualLeaveCalcUpdate['WorkingMonth'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">WorkingYear:</td>
      <td><input type="text" name="WorkingYear" value="<?php echo htmlentities($row_RSAnnualLeaveCalcUpdate['WorkingYear'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">ThisYearALdays:</td>
      <td><input type="text" name="ThisYearALdays" value="<?php echo htmlentities($row_RSAnnualLeaveCalcUpdate['ThisYearALdays'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">LastYearALdays:</td>
      <td><input type="text" name="LastYearALdays" value="<?php echo htmlentities($row_RSAnnualLeaveCalcUpdate['LastYearALdays'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">BeforeLastYearALdays:</td>
      <td><input type="text" name="BeforeLastYearALdays" value="<?php echo htmlentities($row_RSAnnualLeaveCalcUpdate['BeforeLastYearALdays'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">TotalALdays:</td>
      <td><input type="text" name="TotalALdays" value="<?php echo htmlentities($row_RSAnnualLeaveCalcUpdate['TotalALdays'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">TotalTakenDay:</td>
      <td><input type="text" name="TotalTakenDay" value="<?php echo htmlentities($row_RSAnnualLeaveCalcUpdate['TotalTakenDay'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">TotalLeftDay:</td>
      <td><input type="text" name="TotalLeftDay" value="<?php echo htmlentities($row_RSAnnualLeaveCalcUpdate['TotalLeftDay'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Calculated_Date:</td>
      <td><input type="text" name="Calculated_Date" value="<?php echo htmlentities($row_RSAnnualLeaveCalcUpdate['Calculated_Date'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">ModifiedBy:</td>
      <td><input type="text" name="ModifiedBy" value="<?php echo htmlentities($row_RSAnnualLeaveCalcUpdate['ModifiedBy'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">BeforeLastYearLeft:</td>
      <td><input type="text" name="BeforeLastYearLeft" value="<?php echo htmlentities($row_RSAnnualLeaveCalcUpdate['BeforeLastYearLeft'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">LastYearLeft:</td>
      <td><input type="text" name="LastYearLeft" value="<?php echo htmlentities($row_RSAnnualLeaveCalcUpdate['LastYearLeft'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">ThisYearLeft:</td>
      <td><input type="text" name="ThisYearLeft" value="<?php echo htmlentities($row_RSAnnualLeaveCalcUpdate['ThisYearLeft'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="Auto_ID" value="<?php echo $row_RSAnnualLeaveCalcUpdate['Auto_ID']; ?>" />
</form>
<p>&nbsp;</p>
<!-- InstanceEndEditable -->
...
<li><a href="../../Letters/warning Letters/Disciplinary Action Database Update/TerminationDisplay.php" title="Termination Data" target="_blank"><?php echo $obj_lang->get('Termination Data', $lang); ?></a></li>
         ...
         <ul>
           <li><a href="AnnualLeaveDisplay.php" title="Annual Leave Data" target="_blank"><?php echo $obj_lang->get('Annual Leave Data', $lang); ?></a></li>
             <li><a href="AnnualLeaveCalcDisplay.php" title="Annual Leave Calc" target="_blank"><?php echo $obj_lang->get('Annual Leave Calc', $lang); ?></a></li>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($RSAnnualLeaveCalcUpdate);
?>
