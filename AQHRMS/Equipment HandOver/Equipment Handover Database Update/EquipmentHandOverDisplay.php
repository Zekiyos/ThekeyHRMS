...
<table width="333" height="46" border="0" align="center">
  <tr>
    <td><?php if ($pageNum_RSEquipmenthandOverDisplay > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_RSEquipmenthandOverDisplay=%d%s", $currentPage, 0, $queryString_RSEquipmenthandOverDisplay); ?>"><img src="First.gif" /></a>
    <?php } // Show if not first page ?></td>
    <td><?php if ($pageNum_RSEquipmenthandOverDisplay > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_RSEquipmenthandOverDisplay=%d%s", $currentPage, max(0, $pageNum_RSEquipmenthandOverDisplay - 1), $queryString_RSEquipmenthandOverDisplay); ?>"><img src="Previous.gif" /></a>
    <?php } // Show if not first page ?></td>
    <td><?php if ($pageNum_RSEquipmenthandOverDisplay < $totalPages_RSEquipmenthandOverDisplay) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_RSEquipmenthandOverDisplay=%d%s", $currentPage, min($totalPages_RSEquipmenthandOverDisplay, $pageNum_RSEquipmenthandOverDisplay + 1), $queryString_RSEquipmenthandOverDisplay); ?>"><img src="Next.gif" /></a>
    <?php } // Show if not last page ?></td>
    <td><?php if ($pageNum_RSEquipmenthandOverDisplay < $totalPages_RSEquipmenthandOverDisplay) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_RSEquipmenthandOverDisplay=%d%s", $currentPage, $totalPages_RSEquipmenthandOverDisplay, $queryString_RSEquipmenthandOverDisplay); ?>"><img src="Last.gif" /></a>
    <?php } // Show if not last page ?></td>
  </tr>
</table>
</body>
