        ...
        <li><a href="#" class="MenuBarItemSubmenu"><?php echo $obj_lang->get('Recruitment', $lang); ?></a>
          <ul>
            ...
            <li><a href="#" class="MenuBarItemSubmenu"><?php echo $obj_lang->get('Equipment Handover', $lang); ?></a>
              <ul>
                <li><a href="../Equipment_HandOver.php"><?php echo $obj_lang->get('Equipment Handover', $lang); ?></a></li>
                <li><a href="../Equipment_ReturnBack.php"><?php echo $obj_lang->get('Equipment TookOver', $lang); ?></a></li>
              </ul>
            </li>
          </ul>
        </li>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE equipment_handover SET ID=%s, FirstName=%s, MiddelName=%s, LastName=%s, EquipmentName=%s, Taken_Date=%s, Replacement_Date=%s, Returning_Date=%s, Returned=%s WHERE Auto_ID=%s",
                       GetSQLValueString($_POST['ID'], "text"),
                       GetSQLValueString($_POST['FirstName'], "text"),
                       GetSQLValueString($_POST['MiddelName'], "text"),
                       GetSQLValueString($_POST['LastName'], "text"),
                       GetSQLValueString($_POST['EquipmentName'], "text"),
                       GetSQLValueString($_POST['Taken_Date'], "date"),
                       GetSQLValueString($_POST['Replacement_Date'], "date"),
                       GetSQLValueString($_POST['Returning_Date'], "date"),
                       GetSQLValueString($_POST['Returned'], "text"),
...
$query_RSEquipmnetHandoverUpdate = "SELECT * FROM equipment_handover where Auto_ID=".$_GET['Auto_ID']."";}else
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          ...
          <td><input type="text" name="ID" value="<?php echo htmlentities($row_RSEquipmnetHandoverUpdate['ID'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">First Name:</td>
          <td><input type="text" name="FirstName" value="<?php echo htmlentities($row_RSEquipmnetHandoverUpdate['FirstName'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Middel Name:</td>
          <td><input type="text" name="MiddelName" value="<?php echo htmlentities($row_RSEquipmnetHandoverUpdate['MiddelName'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Last Name:</td>
          <td><input type="text" name="LastName" value="<?php echo htmlentities($row_RSEquipmnetHandoverUpdate['LastName'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Equipment Name:</td>
          <td><input type="text" name="EquipmentName" value="<?php echo htmlentities($row_RSEquipmnetHandoverUpdate['EquipmentName'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Equipment Taken Date:</td>
        ...
        <tr valign="baseline">
          ...
          <td valign="baseline"><table>
            <tr>
              <td><input type="radio" name="Returned" value="YES" <?php if (!(strcmp(htmlentities($row_RSEquipmnetHandoverUpdate['Returned'], ENT_COMPAT, 'utf-8'),"YES"))) {echo "checked=\"checked\"";} ?> />
                YES</td>
            </tr>
            <tr>
              <td><input type="radio" name="Returned" value="NO" <?php if (!(strcmp(htmlentities($row_RSEquipmnetHandoverUpdate['Returned'], ENT_COMPAT, 'utf-8'),"NO"))) {echo "checked=\"checked\"";} ?> />
                NO</td>
            </tr>
          </table></td>
        </tr>
...
<li><a href="EquipmentHandOverDisplay.php" title="Equipment handover Data" target="_blank"><?php echo $obj_lang->get('Equipment Handover Data', $lang); ?></a></li>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($RSEquipmnetHandoverUpdate);
?>
<script type="text/javascript">
var MenuBar1 = new Spry.Widget.MenuBar("MenuBar1", {imgDown:"SpryAssets/SpryMenuBarDownHover.gif", imgRight:"SpryAssets/SpryMenuBarRightHover.gif"});
</script>
