...
{
mysql_select_db($database_HRMS, $HRMS);
$query_RSEquipmentList = "SELECT EquipmentName FROM equipment_handover WHERE ID='".$_GET['ID']."'";
...
<?php echo "<font face=\"Times New Roman, Times, serif\" size=\"+1\"><b>logged in as ".$_SESSION['MM_Username']."</b></font>";  ?>
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
    ...
    <blockquote>
     <blockquote>
      <blockquote>
       <font color="#FF6600" size="+1"> <?php  echo $obj_lang->get('Equipment Tookover Form', $lang); ?> </font>
...
do {  
?>
              <option value="<?php echo $row_RSEquipmentList['EquipmentName']?>"><?php echo $row_RSEquipmentList['EquipmentName']?></option>
              <?php
 ...
 //$date = date("Y-m-d",strtotime($date)) 
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">&nbsp;</td>
            <td><input type="submit" value="<?php  echo $obj_lang->get('Register', $lang); ?>" onclick="return confirm('Are you sure the specifed Employee return backup the selected equipment ?')"   /></td>
      </tr>
      </table>
      </font>
      <p>
...
<li><a href="Equipment Handover Database Update/EquipmentHandOverDisplay.php" title="Equipment handover Data" target="_blank"><?php echo $obj_lang->get('Equipment Handover Data', $lang); ?></a></li>
...
<li><a href="../Letters/warning Letters/Disciplinary Action Database Update/TerminationDisplay.php" title="Termination Data" target="_blank"><?php echo $obj_lang->get('Termination Data', $lang); ?></a></li>
      ...
      <li><a href=""><?php echo $obj_lang->get('Access Level', $lang); ?></a>
            ...
            <li><a href="../User_Account/Access Level_Database_Update/Access_Level_Display.php"><?php echo $obj_lang->get('Access Level Data ...', $lang); ?></a></li>            
