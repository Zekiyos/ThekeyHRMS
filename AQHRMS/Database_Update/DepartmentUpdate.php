...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE department SET `Section`=%s, `Sub Section`=%s, `Group`=%s WHERE Department=%s",
                       GetSQLValueString($_POST['Section'], "text"),
                       GetSQLValueString($_POST['Sub_Section'], "text"),
  ...
  $updateGoTo = "DepartmentDisplay.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$query_RSDepartmentUpdate = "SELECT * FROM department Where Department='".$_GET['Department']."'";
}
else
$query_RSDepartmentUpdate = "SELECT * FROM department where Department=-1";
//$query_RSDepartmentUpdate = "SELECT * FROM department";
$RSDepartmentUpdate = mysql_query($query_RSDepartmentUpdate, $HRMS) or die(mysql_error());
$row_RSDepartmentUpdate = mysql_fetch_assoc($RSDepartmentUpdate);
$totalRows_RSDepartmentUpdate = mysql_num_rows($RSDepartmentUpdate);
...
?>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          <td height="60" align="right" nowrap="nowrap"><font color="#FF6600" size="+1" ><?php echo $row_RSDepartmentUpdate['Department']; ?></td>
          <td><font color="#FF6600" size="+1" >Department Detail Update Form</font></td>
        </tr>
        <tr valign="baseline">
          <td height="67" align="right" nowrap="nowrap">Section:</td>
          <td><input type="text" name="Section" value="<?php echo htmlentities($row_RSDepartmentUpdate['Section'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td height="66" align="right" nowrap="nowrap">Sub Section:</td>
          <td><input type="text" name="Sub_Section" value="<?php echo htmlentities($row_RSDepartmentUpdate['Sub Section'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td height="79" align="right" nowrap="nowrap">Group:</td>
          <td><input type="text" name="Group" value="<?php echo htmlentities($row_RSDepartmentUpdate['Group'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
      ...
      <input type="hidden" name="Department" value="<?php echo $row_RSDepartmentUpdate['Department']; ?>" />
    </form>
    <p>&nbsp;</p>
<p>&nbsp;</p>
    <p>&nbsp;</p>
   ...
   <ul id="MenuBar2" class="MenuBarVertical">
     ...
     <li><a href="#" class="MenuBarItemSubmenu"><?php echo $obj_lang->get('Personal Detail', $lang); ?></a>
       ...
       <li><a href="../Recruitment/Probation_Evaluation.php"><?php echo $obj_lang->get('Probation Period Evaluation', $lang); ?></a>       </li>
         ...
         <li><a href="PersonalRecordDisplay.php" target="_blank"><?php echo $obj_lang->get('Personal Detail Search', $lang); ?></a></li>
     ...
     <li><a href="#" class="MenuBarItemSubmenu"> <?php echo $obj_lang->get('HRM System Settings...', $lang); ?></a>
       <ul>
         <li><a href="#" class="MenuBarItemSubmenu"><?php echo $obj_lang->get('System Data Setting', $lang); ?></a>
           <ul>
             <li><a href="CreatDepartment.php"><?php echo $obj_lang->get('Creat Department', $lang); ?></a></li>
             <li><a href="DepartmentDisplay.php" target="_blank"><?php echo $obj_lang->get('Department Data', $lang); ?></a></li>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($RSDepartmentUpdate);
?>
<script type="text/javascript">
var MenuBar1 = new Spry.Widget.MenuBar("MenuBar1", {imgDown:"SpryAssets/SpryMenuBarDownHover.gif", imgRight:"SpryAssets/SpryMenuBarRightHover.gif"});
</script>
