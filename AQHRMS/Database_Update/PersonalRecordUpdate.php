...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQLTotalDeduction = sprintf("UPDATE total_deduction SET ID=%s, FirstName=%s, MiddelName=%s, LastName=%s, Department=%s, `Position`=%s,`Basic Salary`=%s WHERE ID=%s",
                       GetSQLValueString($_POST['ID'], "text"),
                       GetSQLValueString($_POST['FirstName'], "text"),
                       GetSQLValueString($_POST['MiddelName'], "text"),
                       GetSQLValueString($_POST['LastName'], "text"),
...
Employee Personal Record Update Form
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" id="ID" name="ID" value="<?php echo htmlentities($row_RSPersonalRecordUpdate['ID'], ENT_COMPAT, 'utf-8'); ?>" size="32" readonly="readonly" /></td>
    </tr>
    <tr valign="baseline">
