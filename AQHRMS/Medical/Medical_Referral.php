...
$Subject="Ours Sick Employee on day ".date("Y-m-d");
   ...
   //mail("sherhosp@ethionet.et",".$Subject.",".$msg.");
...
<li><a href="../Letters/Contract Letters/Contract Letter.php"><?php echo $obj_lang->get('Contract Letter', $lang); ?></a></li>
        ...
        <li><a href="#" class="MenuBarItemSubmenu"><?php echo $obj_lang->get('Benefits', $lang); ?></a>
          <ul>
            <li><a href="Medical_Referral.php"><?php echo $obj_lang->get('Medical Referral From', $lang); ?></a></li>
            <li><a href="Cholinesterase_Test.php" title="Cholinesterase Test"><?php echo $obj_lang->get('Cholinesterase Test', $lang); ?></a></li>
    ...
    <table align="center" bgcolor="#EBEBEB">
					...
					if($_GET['ID'] =="")
			    {
				 ...
				 ?>" size="20" readonly="readonly" /></td>
                   ...
                   <tr valign="baseline">
                     <td height="33" align="right" nowrap="nowrap">Refferal_Date:</td>
                     <td><script type='text/JavaScript' src="../Calendar/scw.js" ></script>
		
		<input onclick='scwShow(this,event);'type="text" name="Refferal_Date" value="<?php echo date("Y-m-d");?>" size="20" /></td>
                   </tr>
                   <tr valign="baseline">
...
-->
  ...
  <div id="sidecontent">
    ...
    <br />
    <br /> <br />
     <a href="../Proclamation/Ethiopian Labour Law Pro.377(English).htm#a105" target="_blank">Medical Benefits Labour Law</a>
