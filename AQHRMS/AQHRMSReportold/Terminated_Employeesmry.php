...
//	var $SelectLimit = TRUE;
	...
	function crTerminated_Employee() {
		...
		$this->Terminated_Employee_Per_Department = new crChart('Terminated_Employee', 'Terminated Employee', 'Terminated_Employee_Per_Department', 'Terminated Employee Per Department', 'Department', 'ID', '', 6, 'COUNT', 800, 500);
