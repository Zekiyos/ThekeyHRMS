...
//	var $SelectLimit = TRUE;
	...
	function crEmployee_Personal_Record() {
		...
		$this->Number_Of_Employee_Per_Department = new crChart('Employee_Personal_Record', 'Employee Personal Record', 'Number_Of_Employee_Per_Department', 'Number Of Employee Per Department', 'Department', 'ID', '', 5, 'COUNT', 1700, 440);
		...
		$this->Employee_Distribution = new crChart('Employee_Personal_Record', 'Employee Personal Record', 'Employee_Distribution', 'Employee Distribution', 'Department', 'ID', '', 6, 'COUNT', 850, 800);
