...
define("EWRPT_PROJECT_NAME", "AQHRMSReport", TRUE); // Project Name
define("EWRPT_PROJECT_VAR", "AQHRMSReport", TRUE); // Project Var
...
define("EWRPT_CONN_DB", 'aqhrmsdb', TRUE);
...
define("EWRPT_RANDOM_KEY", '6d0_2kpHjp&x_Sty', TRUE); // Random key for encryption
define("EWRPT_PROJECT_STYLESHEET_FILENAME", "phprptcss/AQHRMSReport.css", TRUE); // Project stylesheet file name
