...
<html>
<head>
	<title>Thekey HRMS Report</title>
<?php if (@$gsExport == "") { ?>
<?php } ?>
...
<?php } ?>
<link rel="shortcut icon" type="image/vnd.microsoft.icon" href="<?php echo ewrpt_ConvertFullUrl("favicon.ico") ?>" /><link rel="icon" type="image/vnd.microsoft.icon" href="<?php echo ewrpt_ConvertFullUrl("favicon.ico") ?>" />
...
<div class="ewLayout">
	...
	<div class="ewHeaderRow"><img src="phprptimages/Report Header.bmp" alt="" border="0" /></div>
	<!-- header (end) -->
	<!-- content (begin) -->
	<!-- navigation -->
