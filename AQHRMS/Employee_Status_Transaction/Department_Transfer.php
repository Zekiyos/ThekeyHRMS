...
//					                  );
 ...
 $sqlupdate= "UPDATE employee_personal_record SET Department='".$_POST['ToDepartment']."', Position='".$_POST['as']."' where ID='".$_POST['ID']."' and FirstName='".$_POST['FirstName']."'";
  ...
  $sqlupdatePayrollDB= "UPDATE total_deduction SET `Department`='".$_POST['ToDepartment']."', `Position`='".$_POST['as']."' where `ID`='".$_POST['ID']."' and `FirstName`='".$_POST['FirstName']."'";
  
   mysql_select_db($database_HRMS, $HRMS);
      
    mysql_query($sqlupdatePayrollDB, $HRMS) or die(mysql_error());
  
  /*end of update department of payroll database*********** */
  ...
  //checking Week day of transfer
  
  /*
  $DateValue=$_POST['Transfered_Date'];  //assigning transfer date
   ...
   $WeekOFMonthSQL="SELECT WEEK('".$DateValue."',6) - WEEK(DATE_SUB('".$DateValue."', INTERVAL DAYOFMONTH('".$DateValue."')-1 DAY),6)+1 AS WeekOFMonth ";
		 ...
		 $sqlupdateAttendanceSQL = "UPDATE ".$UpdatedTabelName." SET `Department`='".$_POST['ToDepartment']."' where `ID`='".$_POST['ID']."' and `FirstName`='".$_POST['FirstName']."'";
...
<?php echo "<font face=\"Times New Roman, Times, serif\" size=\"+1\"><b>logged in as ".$_SESSION['MM_Username']."</b></font>";  ?>
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
    ...
    <blockquote>
     ...
     <font color="#FF6600" size="+1"> <?php  echo $obj_lang->get('Employee Department Transfer', $lang); ?>  </font>
...
?>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      ...
      <table width="687" height="362" align="center" background="" bgcolor="#EBEBEB">
        <tr valign="baseline">
          <td width="168" height="39" align="right" nowrap="nowrap"> <?php  echo $obj_lang->get('Selected ID', $lang); ?>:</td>
          <td width="550">
...
<?php  echo $obj_lang->get('To Department', $lang); ?>
...
ORDER BY Department ASC";
        ...
        <td>
         <input name="Position" type="text" value="<?php
				...
				}?>" size="30" maxlength="40" readonly="readonly" /> <?php  echo $obj_lang->get('As', $lang); ?>:<input name="as" type="text" value="<?php
