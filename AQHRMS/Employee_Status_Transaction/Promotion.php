...
if($_POST['Department_After_Promotion']!="Choose Department"){
 ...
 $insertSQL = sprintf("INSERT INTO employee_promotion (ID, FirstName, MiddelName, LastName,Evaluation_Result, Position_Before_Promotion, Position_After_Promotion, Department_Before_Promotion, Department_After_Promotion, Salary_Before_Promotion, Salary_After_Promotion,  Promotion_Date) VALUES (%s, %s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                      GetSQLValueString($_POST['ID'], "text"),
                      GetSQLValueString($_POST['FirstName'], "text"),
                       GetSQLValueString($_POST['MiddelName'], "text"),
                       GetSQLValueString($_POST['LastName'], "text"), 
					   GetSQLValueString($_POST['Evaluation_Result'], "int"),
					   GetSQLValueString($_POST['Position_Before_Promotion'], "text"),					   
					   GetSQLValueString($_POST['Position_After_Promotion'], "text"),
                       GetSQLValueString($_POST['Department_Before_Promotion'], "text"),
					   GetSQLValueString($_POST['Department_After_Promotion'], "text"),
					   GetSQLValueString($_POST['Salary_Before_Promotion'], "int"),
					   GetSQLValueString($_POST['Salary_After_Promotion'], "int"),
                       GetSQLValueString($_POST['Promotion_Date'], "date")
					   );

   
   
 $sqlupdate= "UPDATE employee_personal_record SET  Department='".$_POST['Department_After_Promotion']."', Position='".$_POST['Position_After_Promotion']."', Salary='".$_POST['Salary_After_Promotion']."' where ID='".$_POST['ID']."' and FirstName='".$_POST['FirstName']."'";
  ...
  $sqlupdatePayrollDB= "UPDATE total_deduction SET  `Department`='".$_POST['Department_After_Promotion']."', `Position`='".$_POST['Position_After_Promotion']."', `Basic Salary`='".$_POST['Salary_After_Promotion']."' where `ID`='".$_POST['ID']."' and `FirstName`='".$_POST['FirstName']."'";
  
    mysql_select_db($database_HRMS, $HRMS);
   
  mysql_query($sqlupdatePayrollDB, $HRMS);
   
   /*end of payroll data updating****************************/
  
  
  /***************************************************************************************************/
  /*Attendance week data entry start*/
  
  //checking Week day of Promotion
 /* 
  $DateValue=$_POST['Promotion_Date'];  //assigning transfer date
   ...
   $WeekOFMonthSQL="SELECT WEEK('".$DateValue."',6) - WEEK(DATE_SUB('".$DateValue."', INTERVAL DAYOFMONTH('".$DateValue."')-1 DAY),6)+1 AS WeekOFMonth ";
				...
				*/
				...
				$sqlupdateAttendanceSQL= "UPDATE ".$UpdatedTabelName." SET  `Department`='".$_POST['Department_After_Promotion']."' where `ID`='".$_POST['ID']."' and `FirstName`='".$_POST['FirstName']."'";
					  
  mysql_select_db($database_HRMS, $HRMS);
  $ResultAttendance = mysql_query( $sqlupdateAttendanceSQL, $HRMS) or die(mysql_error());
   }
...
else
{
 ...
 $sqlupdate= "UPDATE employee_personal_record SET Department='".$_POST['Department_Before_Promotion']."', Position='".$_POST['Position_After_Promotion']."', Salary='".$_POST['Salary_After_Promotion']."' where ID='".$_POST['ID']."' and FirstName='".$_POST['FirstName']."'";
  ...
  //$sqlupdatePayrollDB= "UPDATE Payroll_Data SET  `Department`='".$_POST['Department_After_Promotion']."', `Position`='".$_POST['Position_After_Promotion']."', `Basic Salary`='".$_POST['Salary_After_Promotion']."' where `Payroll ID`='".$_POST['ID']."' and `First Name`='".$_POST['FirstName']."'";
//  
//   mysql_select_db($database_PayrollDB, $PayrollDB);
//   
//   mysql_query($sqlupdatePayrollDB, $PayrollDB);
...
<p>&nbsp;</p>
    ...
    <blockquote>
     ...
     <font color="#FF6600" size="+1"> <?php  echo $obj_lang->get('Employee Promotion Form', $lang); ?>  </font>
     <?php //include("Select_ID4Promotion.php"); ?>
     <?php
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      ...
      <table width="738" height="383" align="center" background="" bgcolor="#EBEBEB">
        <tr valign="baseline">
          ...
          <td width="185">
     <input name="ID" value="<?php if(isset($_GET['ID'] ))
        ...
        <tr valign="baseline">
          ...
          <td> <font color="#FF6600" size="+1"><?php  echo $obj_lang->get('Promotion', $lang); ?></font></tr>
        <tr valign="baseline">
          ...
          <td><input name="LastName" type="text" value="<?php
				...
				}?>" size="20" maxlength="20" readonly="readonly" /><td align="right"><?php  echo $obj_lang->get('Evaluation Result', $lang); ?>:</td><td width="216"><span id="sprytxtEavluationResult">
...
<td align="right"><?php  echo $obj_lang->get('To Department', $lang); ?></td><td>
...
ORDER BY Department ASC";
        ...
        <td>
         <input name="Position_Before_Promotion" type="text" value="<?php
				...
				}?>" size="30" maxlength="40" readonly="readonly" /> <td align="right"><?php  echo $obj_lang->get('Postion', $lang); ?>:</td><td>
        ...
        <td>
            ...
            <input name="Salary_Before_Promotion" type="text" value="<?php
				...
				}?>" size="20" maxlength="40" /><td align="right">
                <?php  echo $obj_lang->get('Salary', $lang); ?>  </td><td><span id="sprytxtSalary">
                 <input name="Salary_After_Promotion" type="text" size="15" />
        ...
        <tr valign="baseline">
          ...
          <td><script type='text/JavaScript' src="../Calendar/scw.js" ></script>
            ...
            <input name="Promotion_Date" type="text" onclick='scwShow(this,event);' value="<?php echo date("Y-m-d"); ?>" size="20" maxlength="20" />
          </td>
        </tr>
              
        <tr valign="baseline">
          <td nowrap="nowrap" align="right"></td>
            <td align="center" ></td><td><input type="submit" value="<?php  echo $obj_lang->get('Promote', $lang); ?>:" onClick="return confirm('Are you sure you want to Promote this Employee?')"   /></td>
      </tr>
      </table>
      </font>
      <p>
  ...
  <div id="sidebar">
   ...
   <ul id="MenuBar2" class="MenuBarVertical">
     ...
     <li><a class="MenuBarItemSubmenu" href="#"><?php echo $obj_lang->get('Employee Status Transaction', $lang); ?></a>
       <ul>
         <li><a href="Department_Transfer.php"><?php echo $obj_lang->get('Department Transfer', $lang); ?></a></li>
         <li><a href="Promotion.php"><?php echo $obj_lang->get('Promotion', $lang); ?></a></li>
         <li><a href="Demotion.php"><?php echo $obj_lang->get('Demotion', $lang); ?></a></li>
...
<li><a href="Employee Status Database Update/PromotionDisplay.php" title="Promotion Data" target="_blank"><?php echo $obj_lang->get('Promotion Data', $lang); ?></a></li>
<li><a href="Employee Status Database Update/DemotionDisplay.php" title="Demotion Data" target="_blank"><?php echo $obj_lang->get('Demotion Data', $lang); ?></a></li>
...
-->
  ...
  <div id="sidecontent">
    ...
    <br />
    <br />
      <?php include ("../Notifications/SalaryIncrementNotification.php");?>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
