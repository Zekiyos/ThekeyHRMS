...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO department (`Section`, `Sub Section`, `Group`, Department) VALUES (%s, %s, %s, %s)",
...
?>
    ...
    <div id="DivSection" style="display: none;" ><input type="text" name="Section" size="40" value="" /></div></td>
        </tr>
        <tr> </tr>
        <tr valign="baseline">
...
?>
    ...
    <div id="DivSubSection" style="display: none;" ><input type="text" name="SubSection" size="40" value="" /></div></td>
        </tr>
        <tr> </tr>
        <tr valign="baseline">
...
?>
    ...
    <div id="DivGroup" style="display: none;" ><input type="text" name="Group" size="40" value="" /></div></td>
        </tr>
        <tr> </tr>
        <tr valign="baseline">
...
<li><a href="PromotionDisplay.php" title="Promotion Data" target="_blank"><?php echo $obj_lang->get('Promotion Data', $lang); ?></a></li>
<li><a href="DemotionDisplay.php" title="Demotion Data" target="_blank"><?php echo $obj_lang->get('Demotion Data', $lang); ?></a></li>
