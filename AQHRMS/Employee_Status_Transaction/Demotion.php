...
if($_POST['Department_After_Demotion']!="Choose Department"){
 ...
 $sqlupdate= "UPDATE employee_personal_record SET  Department='".$_POST['Department_After_Demotion']."', Position='".$_POST['Position_After_Demotion']."', Salary='".$_POST['Salary_After_Demotion']."' where ID='".$_POST['ID']."' and FirstName='".$_POST['FirstName']."'";
  ...
  $sqlupdatePayrollDB= "UPDATE total_deduction SET  `Department`='".$_POST['Department_After_Demotion']."', `Position`='".$_POST['Position_After_Demotion']."', `Basic Salary`='".$_POST['Salary_After_Demotion']."' where `ID`='".$_POST['ID']."' and `FirstName`='".$_POST['FirstName']."'";
  ...
  //checking Week day of Demotion
  
 /* 
  $DateValue=$_POST['Demotion_Date'];  //assigning demotion
   ...
   $WeekOFMonthSQL="SELECT WEEK('".$DateValue."',6) - WEEK(DATE_SUB('".$DateValue."', INTERVAL DAYOFMONTH('".$DateValue."')-1 DAY),6)+1 AS WeekOFMonth ";
				...
				*/
				...
				$sqlupdateAttendanceSQL= "UPDATE ".$UpdatedTabelName." SET  `Department`='".$_POST['Department_After_Demotion']."' where `ID`='".$_POST['ID']."' and `FirstName`='".$_POST['FirstName']."'";
...
else
{
 ...
 $sqlupdate= "UPDATE employee_personal_record SET Department='".$_POST['Department_Before_Demotion']."', Position='".$_POST['Position_After_Demotion']."', Salary='".$_POST['Salary_After_Demotion']."' where ID='".$_POST['ID']."' and FirstName='".$_POST['FirstName']."'";
  ...
  //$sqlupdatePayrollDB= "UPDATE Payroll_Data SET  `Department`='".$_POST['Department_After_Demotion']."', `Position`='".$_POST['Position_After_Demotion']."', `Basic Salary`='".$_POST['Salary_After_Demotion']."' where `Payroll ID`='".$_POST['ID']."' and `First Name`='".$_POST['FirstName']."'";
//  
...
<p>&nbsp;</p>
    ...
    <blockquote>
     ...
     <font color="#FF6600" size="+1"> Employee Demotion Form  </font>
     <?php //include("Select_ID4Demotion.php"); ?>
     <?php
$_GET['TableName']="employee_personal_record";

$_GET['OpenPage']="Demotion";
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
     ...
     <input name="ID" value="<?php if(isset($_GET['ID'] ))
        ...
        <tr valign="baseline">
          ...
          <td> <font color="#FF6600" size="+1"><?php  echo $obj_lang->get('Demotion', $lang); ?></font></tr>
        <tr valign="baseline">
...
ORDER BY Department ASC";
        ...
        <tr>
        <td height="23" align="right"><?php  echo $obj_lang->get('Salary Before Demotion', $lang); ?>
        </td>
        <td>
        ...
        <tr valign="baseline">
          <td height="43"  align="right" nowrap="nowrap"><?php  echo $obj_lang->get('Date of Demotion', $lang); ?>:</td>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right"></td>
            <td align="center" ></td><td><input type="submit" value="<?php  echo $obj_lang->get('Demote', $lang); ?>" onClick="return confirm('Are you sure you want to Promote this Employee?')"   /></td>
      </tr>
      </table>
      </font>
      <p>
