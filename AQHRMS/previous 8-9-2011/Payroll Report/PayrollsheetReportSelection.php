...
function SelectedFileName(elem, helperMsg){
	...
	var ID=elem.value;
	alert("http://localhost/AQHRMS/payroll%20report/html/"+elem.value)
...
url1="http:/AQHRMS/AQPayrollReport/PayrollSheet/"+elem.value
window.open(url1)
...
<?php
    $file=opendir("D:/wamp/www/aqhrms/AQPayrollReport/PayrollSheet/");
