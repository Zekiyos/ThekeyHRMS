...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	...
	{
  $insertSQL = sprintf("INSERT INTO Paternity_leave (ID, FirstName, MiddelName, LastName,Department, PaternityLeaveDays, PaternityLeave_Taken_Date, ReportOn) VALUES (%s, %s, %s, %s,%s, %s, %s, %s)",
                       GetSQLValueString($_POST['ID'], "text"),
                       GetSQLValueString($_POST['FirstName'], "text"),
                       GetSQLValueString($_POST['MiddelName'], "text"),
                       GetSQLValueString($_POST['LastName'], "text"),
					   GetSQLValueString($_POST['Department'], "text"),
                       GetSQLValueString($_POST['PaternityLeaveDays'], "int"),
                       GetSQLValueString($_POST['PaternityLeave_Taken_Date'], "date"),
                       GetSQLValueString($_POST['ReportOn'], "date"));

  mysql_select_db($database_HRMS, $HRMS);
  $Result1 = mysql_query($insertSQL, $HRMS) or die(mysql_error());

echo "<script type=\"text/javascript\">alert('You have Granted Paternity leave Seccussfully.')</script>";
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
        ...
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote>
			   <?php include("Select_ID4PaternityLeaveGrant.php");?>
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onmouseover="Numberofdays()">
        <table align="center" bgcolor="#EBEBEB">
          <tr valign="baseline">
            ...
            <td><input type="text" name="ID" value="<?php echo $_GET['ID']; ?>" size="10" readonly="readonly" /></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            <td height="36" align="right" nowrap="nowrap">Paternity Leave Days:</td>
            <td><input type="text" id="PaternityLeaveDays"  name="PaternityLeaveDays" value="5" size="4" readonly="readonly"/></td>
          </tr>
          <tr valign="baseline">
            <td height="34" align="right" nowrap="nowrap">Paternity Leave Taken Date:</td>
            <td><input type="text" id="PaternityLeave_Taken_Date" name="PaternityLeave_Taken_Date" onclick='scwShow(this,event);' value="<?php echo date("Y-m-d"); ?>" size="15"  /></td>
          </tr>
          <tr valign="baseline">
		...
		<input type="text" id="ReportOn" name="ReportOn" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' /></td>
          ...
          <tr valign="baseline">
            ...
            <td><input type="submit" value="Grant Paternity leave" onclick="return confirm('Are you sure you want to Grant Paternity Leave for this Employee?')"  /></td>
          </tr>
        </table>
...
function Numberofdays(){
       t1=document.getElementById("PaternityLeave_Taken_Date").value;
...
document.getElementById("PaternityLeaveDays").value=_Diff;
