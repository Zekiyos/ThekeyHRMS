...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO terminated_employee (ID,FirstName, MiddelName, LastName, Department, Terminated_Date,Termination_Reason) VALUES (%s,%s, %s, %s, %s, %s, %s)",
					 ...
					 $DateValue=$_POST['Terminated_Date']; $UnpaidHourAfterTerminted="Select @TotalMonthOffDay:=DAY( LAST_DAY('".$DateValue."' ))/7 AS TotalMonthOffDay,
   ...
   <blockquote>
     <blockquote>
      <blockquote>
       <blockquote>
         <blockquote>
           <blockquote> <font color="#FF6600" size="+1">Pobation Period Termination Form</font>
	  ...
	  <?php include("Select_ID4TerminationProbationPeriod.php");?>
