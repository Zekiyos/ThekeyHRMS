...
<?php echo "<font face=\"Times New Roman, Times, serif\" size=\"+1\"><b>logged in as ".$_SESSION['MM_Username']."</b></font>";  ?>
 ...
 <?php include("Select_ID4ThirdInstanceWarning.php");
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right" valign="top"><p>Sample Third <br />Inistance Warning<br /> Letter</td>
...
Emloyees  Name &amp; signature <u>                                                                  </u>
    ...
    <tr valign="baseline">
      ...
      <td><blockquote><blockquote><input type="reset" name="reset" value="Reset" />
        <input type="submit" value="Issue This Letter" onClick="return confirm('Are you sure you want Issue to This Letter for this Employee?')" /></td>
    </tr>
  </table>
...
-->
  ...
  <div id="sidecontent">
    ...
    <!-- InstanceBeginEditable name="SideContent" -->
        <p><br />
    <br /> <br />
    <br /><a href="../../Proclamation/Ethiopian Labour Law Pro.377(English).htm#a28" target="_blank">Warnings Labour Law</a></p>
