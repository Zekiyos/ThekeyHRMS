...
<p>&nbsp;</p>
    ...
    <blockquote>
     ...
     <font color="#FF6600" size="+1"> Employee Promotion Form  </font>
...
?>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      ...
      <table width="738" height="383" align="center" background="" bgcolor="#EBEBEB">
        <tr valign="baseline">
          <td width="150" height="39" align="right" nowrap="nowrap"> Selected ID:</td>
          <td width="185">
     <input name="ID" value="<?php echo $_GET['ID']; ?>" size="10" readonly="readonly"  />     
        ...
        <tr valign="baseline">
          <td height="37" align="right" nowrap="nowrap">First Name:</td>
        ...
        <tr valign="baseline">
          <td height="37" align="right" nowrap="nowrap">Middel Name:</td>
          ...
          <td width="163" align="right"><font color="#FF6600" size="+1">After</font> </td>
          <td> <font color="#FF6600" size="+1">Promotion</font></tr>
        <tr valign="baseline">
          <td height="36"  align="right" nowrap="nowrap">Last Name:</td>
          <td><input name="LastName" type="text" value="<?php
					...
					if($_GET['ID'] =="")
			    {
				 ...
				 ?>" size="20" maxlength="20" readonly="readonly" /><td align="right">Evaluation Result:</td><td width="216"><span id="sprytxtEavluationResult">
        ...
        <tr valign="baseline">
          <td height="36"  align="right" nowrap="nowrap">From Department:</td>
          <td>
...
<td align="right">To Department</td><td>
...
ORDER BY Department ASC";
        ...
        <td>
         <input name="Position_Before_Promotion" type="text" value="<?php
					...
					if($_GET['ID'] =="")
			    {
				 ...
				 ?>" size="30" maxlength="40" readonly="readonly" /> <td align="right">Postion:</td><td>
        ...
        <tr>
        <td height="23" align="right">Salary Before Promotion
        </td>
        <td>
            ...
            <input name="Salary_Before_Promotion" type="text" value="<?php
					...
					if($_GET['ID'] =="")
			    {
                 ...
                 Salary </td><td><span id="sprytxtSalary">
                 <input name="Salary_After_Promotion" type="text" size="15" />
                 <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
          </td>
        </tr>
        <tr valign="baseline">
          <td height="43"  align="right" nowrap="nowrap">Date of Promotion:</td>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right"></td>
            <td align="center" ></td><td><input type="submit" value="Promote" onClick="return confirm('Are you sure you want to Promote this Employee?')"   /></td>
      </tr>
      </table>
      </font>
      <p>
