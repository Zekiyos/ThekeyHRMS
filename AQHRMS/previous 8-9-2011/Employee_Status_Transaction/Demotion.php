    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
     ...
     <input name="ID" value="<?php echo $_GET['ID']; ?>" size="10" readonly="readonly"  />     
        ...
        <tr valign="baseline">
          ...
          <td> <font color="#FF6600" size="+1">Demotion</font></tr>
        <tr valign="baseline">
...
ORDER BY Department ASC";
        ...
        <tr>
        <td height="23" align="right">Salary Before Demotion
        </td>
        <td>
        ...
        <tr valign="baseline">
          <td height="43"  align="right" nowrap="nowrap">Date of Demotion:</td>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right"></td>
            <td align="center" ></td><td><input type="submit" value="Demote" onClick="return confirm('Are you sure you want to Promote this Employee?')"   /></td>
      </tr>
      </table>
      </font>
      <p>
