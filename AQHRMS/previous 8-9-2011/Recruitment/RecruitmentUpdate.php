...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE recruitment SET Employee=%s, Place=%s, ID=%s, FirstName=%s, MiddelName=%s, LastName=%s, Age=%s, Sex=%s, Photo=%s, `Date`=%s, Address=%s, Department=%s, `Position`=%s, Salary=%s, Transport_Allowance=%s, Hardship_Allowance=%s, Housing_Allowance=%s, Position_Allowance=%s WHERE Auto_ID=%s",
...
<font color="#FF6600" size="+1" > <p align="center">Recruitment Data Update Form</p></font>
  <table align="center" bgcolor="#EBEBEB">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="ID" value="<?php echo htmlentities($row_RSRecruitmentUpdate['ID'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
