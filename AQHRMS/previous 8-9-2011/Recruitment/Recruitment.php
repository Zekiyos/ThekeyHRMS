...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO recruitment (Employee, Place, ID, FirstName, MiddelName, LastName, Age, Sex, Photo, `Date`, Address,`Department`, `Position`, Salary, Transport_Allowance,Housing_Allowance,Hardship_Allowance, Position_Allowance) VALUES (%s, %s, %s, %s, %s, %s, %s,%s, %s,%s, %s, %s, %s, %s, %s, %s, %s, %s)",
 ...
 /*******************Payroll data entry for new employeee registration*/ 
   ...
   $insertPayrollDBSQL = sprintf("INSERT INTO total_deduction (`ID`,`FirstName`,`MiddelName`,`LastName`,`Basic salary`,`Department`,`Position`,`Hardship_Allowance`,Housing_Allowance,`Transport_Allowance_Amount`,`Position_Allowance`)
  ...
  $insertAttendanceSQL = sprintf("INSERT INTO ".$UpdatedTabelName." (`ID`,`FirstName`,`MiddelName`,`LastName`,`Department`)
	...
	********/
	...
	$UnpaidHour="Select @TotalMonthOffDay:=DAY( LAST_DAY('".$DateValue."' ))/7 AS TotalMonthOffDay,
				...
				@AbsentWorkingHour:=@PersentWorkingDay*8 AS AbsentWorkingHour";
