    ...
    <body>
        ...
        <div id="thekey_page">
            ...
            <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
                ...
                echo "<form name=\"SelectedID4Update\"  action=\"WeekPayrollDataSettingSetup3.php\" method=\"post\">";
...
//session_start();
                ...
                if (isset($_POST['CHK']) && isset($_POST['Next']) && isset($_POST['FieldData']) && isset($_POST['Field']) && isset($_POST['Week'])) {
                    $a = $_POST['CHK'];
                    $field = $_POST['Field'];
                    ...
                    if ($fieldData == "") {
                        ...
                        echo("To Set Week <font color=\"#FF0000\">$Week</font> Payroll Data <font color=\"#FF0000\">$fieldData</font> for the Field <font color=\"#FF0000\">$field</font> .<br/>");
                        ...
                        $obj_PayrollData->get_selected_employee($a, $Week);
                    }
                }
