...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <table  cellpadding="0" align="center" border="1" bordercolor="#FF6600">
            ...
            <?php do { ?>
                <tr>
                    <td><a  target="_blank" href="../Court_Case/Court_Case_Database_Update/CourtCaseUpdate.php?Auto_ID=<?php echo $row_RSCourtCaseDisplay['Auto_ID']; ?>"  ><?php echo "<p>Update</p> </a>"; ?></a>
        ...
        <table width="449" height="50" border="0" align="center">
            <tr>
                <td><?php if ($pageNum_RSCourtCaseDisplay > 0) { // Show if not first page    ?>
                        <a href="<?php printf("%s?pageNum_RSCourtCaseDisplay=%d%s", $currentPage, 0, $queryString_RSCourtCaseDisplay); ?>"><img src="../Court Case/Court Case Database Update/First.gif" /></a>
                    <?php } // Show if not first page  ?></td>
                <td><?php if ($pageNum_RSCourtCaseDisplay > 0) { // Show if not first page    ?>
                        <a href="<?php printf("%s?pageNum_RSCourtCaseDisplay=%d%s", $currentPage, max(0, $pageNum_RSCourtCaseDisplay - 1), $queryString_RSCourtCaseDisplay); ?>"><img src="../Court Case/Court Case Database Update/Previous.gif" /></a>
                    <?php } // Show if not first page  ?></td>
                <td><?php if ($pageNum_RSCourtCaseDisplay < $totalPages_RSCourtCaseDisplay) { // Show if not last page    ?>
                        <a href="<?php printf("%s?pageNum_RSCourtCaseDisplay=%d%s", $currentPage, min($totalPages_RSCourtCaseDisplay, $pageNum_RSCourtCaseDisplay + 1), $queryString_RSCourtCaseDisplay); ?>"><img src="../Court Case/Court Case Database Update/Next.gif" /></a>
                    <?php } // Show if not last page  ?></td>
                <td><?php if ($pageNum_RSCourtCaseDisplay < $totalPages_RSCourtCaseDisplay) { // Show if not last page    ?>
                        <a href="<?php printf("%s?pageNum_RSCourtCaseDisplay=%d%s", $currentPage, $totalPages_RSCourtCaseDisplay, $queryString_RSCourtCaseDisplay); ?>"><img src="../Court Case/Court Case Database Update/Last.gif" /></a>
                    <?php } // Show if not last page  ?></td>
            </tr>
        </table>
    </body>
