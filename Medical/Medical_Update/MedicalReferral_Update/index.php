        ...
        <div id="thekey_page">
            ...
            <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
                ...
                if (isset($_GET['Auto_ID']) && (!isset($_POST['MM_update']))) {
                    ...
                    $result = $mydb->delete('medical_referral');
                    if ($result) {
                ...
                $mydb = new DataBase();
                $header_lable = 'Medical Referral';


                $mydb = filter($mydb, true);
                $result = $mydb->get('medical_referral');
                $total_num_row = $result['total_row'];                 $result = $result['result'];

                $header_info = $mydb->show_column('medical_referral');
                ksort($header_info);

                $update_page = 'MedicalReferralUpdate.php';
                $key_filed = 'Auto_ID';

                $hide = array('Auto_ID' => 'Auto_ID');
                $table = "medical_referral";
