    ...
    <body>
        ...
        <div id="thekey_page">
            ...
            <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
                ...
                $mydb = new DataBase();
                $header_lable = 'Health Care Insurance';


                $mydb = filter($mydb, true);
                $result = $mydb->get('Health_Care_Insurance');
                $total_num_row = $result['total_row'];                 $result = $result['result'];

                $header_info = $mydb->show_column('Health_Care_Insurance');
                ksort($header_info);

                $update_page = 'HealthCareInsuranceUpdate.php';
                $key_filed = 'Auto_ID';

                $hide = array('Auto_ID' => 'Auto_ID');
                $table = "Health_Care_Insurance";
