        ...
        <div id="thekey_page">
            ...
            <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" --> 
                ...
                if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
                    ...
                    $Result1 = $mydb->insert('medical_referral', $data);

                    if ($Result1)
                        echo "<script type=\"text/javascript\">alert('You have reffered {$_POST['FirstName']}  {$_POST['MiddelName']} Successfully.')</script>";
                ...
                ?>
                <h1 class="form_lable">
                    <?php echo $obj_lang->get('Medical Referral', $lang); ?>
                </h1>
                <?php
                $_GET['TableName'] = "employee_personal_record";

                $_GET['OpenPage'] = "Medical_Referral";
                ...
                <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
                    <table width="277" align="center" bgcolor="#EBEBEB">
                        <tr valign="baseline">
                            ...
                            <td><input readonly="readonly" type="text" name="ID"  size="15" value="<?php if (isset($_GET['ID'])) echo $_GET['ID']; ?>"/></td>
                        </tr>
                        <tr valign="baseline">
                ...
                ?>" size="35" readonly="readonly" /></td>
                        ...
                        <tr valign="baseline">
                            ...
                            <td>
                                ...
                                <input type="Date" name="Refferal_Date" value="<?php echo date("Y-m-d"); ?>" size="20" />
                            </td>
                        </tr>
                        <tr valign="baseline">
