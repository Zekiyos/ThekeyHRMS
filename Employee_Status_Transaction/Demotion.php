...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    if ($_POST['Department_After_Demotion'] != "Choose Department") {
        ...
        $data = array('ID' => $_POST['ID']
            ...
            , 'Position_Before_Demotion' => $_POST['Position_Before_Demotion']
            , 'Position_After_Demotion' => $_POST['Position_After_Demotion']
            , 'Department_Before_Demotion' => $_POST['Department_Before_Demotion']
            , 'Department' => $_POST['Department_After_Demotion']
            , 'Department_After_Demotion' => $_POST['Department_After_Demotion']
            , 'Salary_Before_Demotion' => $_POST['Salary_Before_Demotion']
            , 'Salary_After_Demotion' => $_POST['Salary_After_Demotion']
            , 'Demotion_Date' => $_POST['Demotion_Date']);

        $Result1 = $mydb->insert('employee_Demotion', $data);


        $data = array('Department' => $_POST['Department_After_Demotion']
            , 'Position' => $_POST['Position_After_Demotion']
            , 'Salary' => $_POST['Salary_After_Demotion']
        ...
        $data = array('Department' => $_POST['Department_After_Demotion']
            , 'Position' => $_POST['Position_After_Demotion']
            , 'Basic Salary' => $_POST['Salary_After_Demotion']
            , 'ModifiedBy' => $_SESSION['MM_Fullname']);
        ...
        echo "<script type=\"text/javascript\">alert('Please Choose First Department for Demotion.')</script>";
    }
}
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/ThekeyHRMS_main_Template.dwt" codeOutsideHTMLIsLocked="false" -->
    ...
    <body>
        ...
        <div id="thekey_page">
            ...
            <div id="mainContent"><!-- InstanceBeg<h1 class="form_lable">inEditable name="MainContent" -->
                ...
                ?>" size="20" maxlength="20" readonly="readonly" /><td align="right"><?php echo $obj_lang->get('Evaluation Result', $lang); ?>:</td><td width="216"> 
                                                <input type="text" name="Evaluation_Result" size="15" value="0" required="required" />
                                            </td>
                                        ...
                                        <td>
                                            ...
                                            ?>" size="20" maxlength="40" /><td align="right">
                                                <?php echo $obj_lang->get('Salary', $lang); ?> </td><td><span id="sprytxtSalary">
                                                    <input name="Salary_After_Demotion" required="required"  type="text" size="15" />
                                            </td>
                                        </td>
                                    </tr>
                                    <tr valign="baseline">
                                        ...
                                        <td>
                                            <input name="Demotion_Date" type="Date" required="required"  value="<?php echo date("Y-m-d"); ?>" size="20" maxlength="20" />
                                        </td>
                                    </tr>

                                    <tr valign="baseline">
                                        <td align="right" colspan="4">
                                            <input type="submit" value="<?php echo $obj_lang->get('Demote', $lang); ?>" onClick="return confirm('Are you sure you want to Demote this Employee?')"   /></td>
                                    </tr>
                                    </table>
                                    <p>
