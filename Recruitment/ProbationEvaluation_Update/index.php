        ...
        <div id="thekey_page" class="not_pop_up">
            ...
            <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
                ...
                if (isset($_GET['Auto_ID'])) {
                    ...
                    $mydb->delete('probation_evalutaion');
                }

                $mydb = new DataBase();
                $header_lable = 'Probation Evalutaion';
                 $mydb = filter($mydb);
                $result = $mydb->get('probation_evalutaion');
                $total_num_row = $result['total_row'];                 $result = $result['result'];

                
                $header_info = $mydb->show_column('probation_evalutaion');
                ksort($header_info);

                $update_page = 'ProbationEvaluationUpdate.php';
                $key_filed = 'Auto_ID';
