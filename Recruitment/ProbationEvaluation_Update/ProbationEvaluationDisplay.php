        ...
        <table width="277" border="0" align="center">
            <tr>
                <td><?php if ($pageNum_RSProbationEvaluationDisplay > 0) { // Show if not first page  ?>
                        <a href="<?php printf("%s?pageNum_RSProbationEvaluationDisplay=%d%s", $currentPage, 0, $queryString_RSProbationEvaluationDisplay); ?>"><img src="../../Img/First.gif" /></a>
<?php } // Show if not first page  ?></td>
                <td><?php if ($pageNum_RSProbationEvaluationDisplay > 0) { // Show if not first page  ?>
                        <a href="<?php printf("%s?pageNum_RSProbationEvaluationDisplay=%d%s", $currentPage, max(0, $pageNum_RSProbationEvaluationDisplay - 1), $queryString_RSProbationEvaluationDisplay); ?>"><img src="../../Img/Previous.gif" /></a>
<?php } // Show if not first page  ?></td>
                <td><?php if ($pageNum_RSProbationEvaluationDisplay < $totalPages_RSProbationEvaluationDisplay) { // Show if not last page  ?>
                        <a href="<?php printf("%s?pageNum_RSProbationEvaluationDisplay=%d%s", $currentPage, min($totalPages_RSProbationEvaluationDisplay, $pageNum_RSProbationEvaluationDisplay + 1), $queryString_RSProbationEvaluationDisplay); ?>"><img src="../../Img/Next.gif" /></a>
<?php } // Show if not last page  ?></td>
                <td><?php if ($pageNum_RSProbationEvaluationDisplay < $totalPages_RSProbationEvaluationDisplay) { // Show if not last page  ?>
                        <a href="<?php printf("%s?pageNum_RSProbationEvaluationDisplay=%d%s", $currentPage, $totalPages_RSProbationEvaluationDisplay, $queryString_RSProbationEvaluationDisplay); ?>"><img src="../../Img/Last.gif" /></a>
<?php } // Show if not last page  ?></td>
            </tr>
        </table>
    </body>
