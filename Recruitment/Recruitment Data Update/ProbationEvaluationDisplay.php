...
if(isset($_GET['ID']))
$query_RSProbationEvaluationDisplay = "SELECT * FROM probation_evalutaion WHERE ID='".$_GET['ID']."'";
else
...
$_GET['TableName']="probation_evalutaion";

$_GET['OpenPage']="ProbationEvaluationDisplay";
...
<table width="277" border="0" align="center">
  <tr>
    <td><?php if ($pageNum_RSProbationEvaluationDisplay > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_RSProbationEvaluationDisplay=%d%s", $currentPage, 0, $queryString_RSProbationEvaluationDisplay); ?>"><img src="../../images/First.gif" /></a>
        <?php } // Show if not first page ?></td>
    <td><?php if ($pageNum_RSProbationEvaluationDisplay > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_RSProbationEvaluationDisplay=%d%s", $currentPage, max(0, $pageNum_RSProbationEvaluationDisplay - 1), $queryString_RSProbationEvaluationDisplay); ?>"><img src="../../images/Previous.gif" /></a>
        <?php } // Show if not first page ?></td>
    <td><?php if ($pageNum_RSProbationEvaluationDisplay < $totalPages_RSProbationEvaluationDisplay) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_RSProbationEvaluationDisplay=%d%s", $currentPage, min($totalPages_RSProbationEvaluationDisplay, $pageNum_RSProbationEvaluationDisplay + 1), $queryString_RSProbationEvaluationDisplay); ?>"><img src="../../images/Next.gif" /></a>
        <?php } // Show if not last page ?></td>
    <td><?php if ($pageNum_RSProbationEvaluationDisplay < $totalPages_RSProbationEvaluationDisplay) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_RSProbationEvaluationDisplay=%d%s", $currentPage, $totalPages_RSProbationEvaluationDisplay, $queryString_RSProbationEvaluationDisplay); ?>"><img src="../../images/Last.gif" /></a>
        <?php } // Show if not last page ?></td>
  </tr>
</table>
</body>
