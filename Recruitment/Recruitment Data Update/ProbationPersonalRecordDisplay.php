...
<div id="headerAdvert" align="center">
    <H2 ><font  size="20" color="#FF6600" >Thekey</font><span id="headerAdvert"><font color="#999999" size="20" >HRMS</font><font color="#999999" size="3" >    Bringing ICT Solution to Your need.</font>  </span> <font color="#999999" size="3" >The key is yours!! </font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../../index.php"><img src="../../images/United Kingdom flag.png" width="35" height="25" /></a><a href="../../Amharic/index.php"><img border="0" src="../../images/Ethiopiaflag.jpg" alt="Amharic(ETH)" width="35" height="30" /></a><a href="../../Dutch/index.php"><img src="../../images/Netherlands-Flag-icon.png" width="35" height="25" /></a></h2>
   <H2><font color="#999999" size="+1" ></font><img src="../../images/logo.jpg" alt="Rev(3:7)He that hath THE KEY of David, he that openeth, and no man shutteth;  and shutteth, and no man openeth;" width="100" height="40" />
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <td><input type="image" src="../../images/Search.png" width="67" height="69" />   </td>
  <td>&nbsp;&nbsp;
    Field Name
  ...
  <?php do { ?>
    <tr><td><a  target="_blank" href="RecruitmentUpdate.php?ID=<?php echo $result['ID']; ?>"  ><?php echo "<p>Update</p> </a>";?></a>
     ...
     ><?php echo "Delete </a>";?></a>
      ...
      <td bgcolor="<?php if($_POST['field']=="Employer")
	  echo "#FFFFCC";
