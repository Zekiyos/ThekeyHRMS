        ...
        <table width="331" border="0" align="center">
            <tr>
                <td><?php if ($pageNum_RSRecruitment > 0) { // Show if not first page        ?>
                        <a href="<?php printf("%s?pageNum_RSRecruitment=%d%s", $currentPage, 0, $queryString_RSRecruitment); ?>"><img src="../../Img/First.gif" /></a>
                    <?php } // Show if not first page  ?></td>
                <td><?php if ($pageNum_RSRecruitment > 0) { // Show if not first page        ?>
                        <a href="<?php printf("%s?pageNum_RSRecruitment=%d%s", $currentPage, max(0, $pageNum_RSRecruitment - 1), $queryString_RSRecruitment); ?>"><img src="../../Img/Previous.gif" /></a>
                    <?php } // Show if not first page  ?></td>
                <td><?php if ($pageNum_RSRecruitment < $totalPages_RSRecruitment) { // Show if not last page        ?>
                        <a href="<?php printf("%s?pageNum_RSRecruitment=%d%s", $currentPage, min($totalPages_RSRecruitment, $pageNum_RSRecruitment + 1), $queryString_RSRecruitment); ?>"><img src="../../Img/Next.gif" /></a>
                    <?php } // Show if not last page  ?></td>
                <td><?php if ($pageNum_RSRecruitment < $totalPages_RSRecruitment) { // Show if not last page        ?>
                        <a href="<?php printf("%s?pageNum_RSRecruitment=%d%s", $currentPage, $totalPages_RSRecruitment, $queryString_RSRecruitment); ?>"><img src="../../Img/Last.gif" /></a>
                    <?php } // Show if not last page  ?></td>
            </tr>
        </table>
    </body>
