...
// echo "<table border=\"4\" align=\"center\"LIMIT 10 bgcolor=\"#EBEBEB\" bordercolor=\"#FF6600\" >";
            ...
            while ($result = mysql_fetch_array($data)) {
                ...
                <div id="headerAdvert" align="center">
                    <H2 ><font  size="20" color="#FF6600" >Thekey</font><span id="headerAdvert"><font color="#999999" size="20" >HRMS</font><font color="#999999" size="3" >    Bringing ICT Solution to Your need.</font>  </span> <font color="#999999" size="3" >The key is yours!! </font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../../index2.php"><img src="../../Img/United Kingdom flag.png" width="35" height="25" /></a><a href="../../Amharic/index.php"><img border="0" src="../../Img/Ethiopiaflag.jpg" alt="Amharic(ETH)" width="35" height="30" /></a><a href="../../Dutch/index.php"><img src="../../Img/Netherlands-Flag-icon.png" width="35" height="25" /></a></h2>
                    <H2><font color="#999999" size="+1" ></font><img src="../../Img/logo.jpg" alt="Rev(3:7)He that hath THE KEY of David, he that openeth, and no man shutteth;  and shutteth, and no man openeth;" width="100" height="40" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
                    <table>
                        <tr>
                            ...
                            <td><input type="image" src="../../Img/Search.png" width="67" height="69" />   </td>
                            <td>&nbsp;&nbsp;
                                Field Name
                ...
                <blockquote><blockquote><blockquote><blockquote> <blockquote>
                                    <blockquote><blockquote><blockquote><blockquote> <blockquote>
                                                        <blockquote><blockquote><blockquote><blockquote> <blockquote><blockquote><blockquote> <blockquote><blockquote><blockquote> <blockquote>
                                                                                                    <input type=button value="Print Out" onClick="PrintContent('searchResult')" align="right" ></blockquote></blockquote></blockquote></blockquote></blockquote>
                                                                            </blockquote></blockquote></blockquote></blockquote></blockquote>
                                                        </blockquote></blockquote></blockquote></blockquote></blockquote></blockquote></blockquote></blockquote></blockquote></blockquote></blockquote>
                ...
                <div id="searchResult"> 
                    ...
                    <table id="searchtbl" border="1" cellpadding="0" align="center" border="1" bordercolor="#FF6600" >
                        ...
                        <?php do { ?>
                            <tr><td><a  target="_blank" href="RecruitmentUpdate.php?ID=<?php echo $result['ID']; ?>"  ><?php echo "<p>Update</p> </a>"; ?></a>
                                    <a  href="javascript: if (confirm('Are You Sure You want to Delete the Employee Recored?')) { window.location.href='RecruitmentDelete.php?ID=<?php echo $result['ID']; ?>' } else { void('') }; "

                                        ><?php echo "Delete </a>"; ?></a>
                                <td><a  target="_blank" href="../../Database_Update/PersonalRecordDetail.php?recordID=<?php echo $result['ID']; ?>"> <?php echo $result['Auto_ID']; ?>&nbsp; </td>
                                <td bgcolor="<?php
                    if ($_POST['field'] == "ID")
                        echo "#FFFFCC";
                            ?>"><?php echo $result['ID']; ?>&nbsp; </td>
                                <td bgcolor="<?php
                    if ($_POST['field'] == "FirstName")
                        echo "#FFFFCC";
                            ?>"><?php echo $result['FirstName']; ?>&nbsp; </td>
                                <td bgcolor="<?php
                    if ($_POST['field'] == "MiddelName")
                        echo "#FFFFCC";
                    ...
                    if ($_POST['field'] == "LastName")
                        echo "#FFFFCC";
                            ?>"><?php echo $result['LastName']; ?>&nbsp; </td>
                                <td bgcolor="<?php
                    if ($_POST['field'] == "Employer")
                        echo "#FFFFCC";
                            ?>"><?php echo $result['Employer']; ?>&nbsp; </td>
                                <td bgcolor="<?php
                    if ($_POST['field'] == "Place")
                        echo "#FFFFCC";
                    ...
                    if ($_POST['field'] == "Department")
                        echo "#FFFFCC";
                            ?>"><?php echo $result['Department']; ?>&nbsp; </td>
                                <td bgcolor="<?php
                    if ($_POST['field'] == "Position")
                        echo "#FFFFCC";
                            ?>"><?php echo $result['Position']; ?>&nbsp; </td>
                                <td bgcolor="<?php
                    if ($_POST['field'] == "Salary")
                        echo "#FFFFCC";
                            ?>"><?php echo $result['Salary']; ?>&nbsp; </td>
                                <td bgcolor="<?php
                    if ($_POST['field'] == "Transport_Allowance")
                        echo "#FFFFCC";
                            ?>"><?php echo $result['Transport_Allowance']; ?>&nbsp; </td>

                                <td bgcolor="<?php
                    if ($_POST['field'] == "Hardship_Allowance")
                        echo "#FFFFCC";
                    ...
                    if ($_POST['field'] == "Hardship_Allowance")
                        echo "#FFFFCC";
                            ?>"><?php echo $result['Housing_Allowance']; ?>&nbsp; </td>
                                ...
                                <td bgcolor="<?php
                    if ($_POST['field'] == "Position_Allowance")
                        echo "#FFFFCC";
                            ?>"><?php echo $result['Position_Allowance']; ?>&nbsp; </td>

                                <td bgcolor="<?php
                    if ($_POST['field'] == "Present_Allowance")
                        echo "#FFFFCC";
