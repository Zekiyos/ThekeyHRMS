...
class Termination {
    ...
    public function Clear_Terminated_Employee($IDNumber, $Tablename) {

        $queryCR = "DELETE FROM " . $Tablename . " WHERE ID = '" . $IDNumber . "'";
        mysql_query($queryCR);
    }

    public function Copy2Terminated($IDNumber, $sourceTable, $desinationTable) {
        $queryCT = "INSERT INTO ThekeyHRMSDB." . $desinationTable . " () SELECT  * FROM " . $sourceTable . " WHERE ID = '" . $IDNumber . "'";
        mysql_query($queryCT);
    }
