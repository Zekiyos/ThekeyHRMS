			...
			if ($workingDay < 0) {
			 ...
			 if (($summarize)&&( $totalDays>0)) {
			  ...
			  $sqlchk = "SELECT * FROM Biometric_Attendance_Summary 
                    WHERE Month_Year='" . $yearMonth . "' AND ID='" . $ID . "' AND Confirm=1";
                ...
                $sqlInsert = "INSERT INTO Biometric_Attendance_Summary (`ID`, `FirstName`, `MiddelName`, `LastName`, `Department`, `Working_Day`, `Leave_Day`,  `Absent_Day`, `DayOT_Hour`, `NightOT_Hour`, `OffDayOT_Hour`, `HolyDayOT_Hour`, `Month_Year`, `Prepared`, `Department_Manager`, `Checked`, `Approved`,`ModifiedBy`)";
				...
				$sqlInsert1 = "INSERT INTO thekey_bas (`ID`, `FirstName`, `MiddelName`, `LastName`, `Department`, `Working_Day`, `Leave_Day`,  `Absent_Day`, `DayOT_Hour`, `NightOT_Hour`, `OffDayOT_Hour`, `HolyDayOT_Hour`, `Month_Year`, `Prepared`, `Department_Manager`, `Checked`, `Approved`,`ModifiedBy`,`time`)";
        ...
        while ($rowAS = mysql_fetch_assoc($result, MYSQL_ASSOC)) {
		  ...
		  // echo "<td > <lable class='full_name'>" . $rowAS['FirstName'] .' '. $rowAS['MiddelName'].' '. $rowAS['LastName']. "</lable></td>";
            ...
            if ($count == $numrows) {
                ...
                $not_sumable = array('ID1', 'Full Name', 'FirstName1', 'MiddelName1', 'LastName1', 'Department1', 'Position', 'Prepared', 'Department_Manager', 'Checked', 'Approved', 'Month_Year', 'Confirm', 'ModifiedBy');
