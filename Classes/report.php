...
class R_Report {
    ...
    private $report_list = array(
        ...
        'Employee Personal Record' => array(
            'select' => array(
                'Section', 'Sub Section', 'Department.Group', 'Department.Department',
                'employee_personal_record.FirstName', 'employee_personal_record.MiddelName',
                'employee_personal_record.LastName', 'employee_personal_record.Date_Employement'
            ),
     ...
     /* Attendance System eport */
        'Attendance Allocation' => array(
            'from_table' => 'attendance_allocation',
        ),
        'Attendance Scan Sheet' => array(
            'from_table' => 'attendance_sheet',
            'where' => array('ID!=' => '')
        ),
    ...
    function reports($report, $event) {
        ...
        if (isset($this->report_list[$report])) {
            ...
            $this->all_rows = $result['total_row'];
...
$total_num_row = $thekeyreport->all_rows;
