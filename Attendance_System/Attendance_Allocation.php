            ...
            <div id="mainContent">
                ...
                if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
                    ...
                    if ((isset($_POST['From_Date']) && isset($_POST['To_Date']))) {
                        ...
                        // $_POST['operation'] = "Insert";

                        $sql = "Select * FROM `Attendance_Allocation` WHERE `Date` BETWEEN '" . $_POST['From_Date'] . "' and '" . $_POST['To_Date'] . "'";

						if (!(isset($_POST['Group_No'])))
                            $_POST['Group_No']='';

                        if ((isset($_POST['Department'])) && ($_POST['Department'] != '')
                                && ($_POST['ID']=='') && ($_POST['Group_No']=='')) {
                            ...
                            $sql = "Select * FROM `Attendance_Allocation` WHERE `Date` BETWEEN '" . $_POST['From_Date'] . "' and '" . $_POST['To_Date'] . "' and Department='" . $_POST['Department'] . "'";


                            //   if (mysql_num_rows(mysql_query($sql))) {


                            $obj_OT->Attendance_Cleaner("attendance_sheet", $_POST['From_Date'], $_POST['To_Date'], $Department);
                            $obj_OT->Attendance_Scan_Sheet_Importer($_POST['From_Date'], $_POST['To_Date'], $Department);

                           // $obj_OT->Attendance_Cleaner("attendance_allocation", $_POST['From_Date'], $_POST['To_Date'], $Department);


                            $obj_OT->Attendance_Allocation($_POST['From_Date'], $_POST['To_Date'], $Department, NULL, $operation);
//                        }
//                        else
...
//                 
                        ...
                        if ((isset($_POST['ID'])) || (isset($_POST['Group_No']))) {
                            ...
                            if (is_array($ID)) {
                                ...
                                foreach ($ID as $key => $value) {
                                    $obj_OT->Attendance_Cleaner("attendance_sheet", $_POST['From_Date'], $_POST['To_Date'], NULL, $value);
                                    $obj_OT->Attendance_Cleaner("attendance_allocation", $_POST['From_Date'], $_POST['To_Date'], NULL, $value);
                                }
                            } else {
                                $obj_OT->Attendance_Cleaner("attendance_sheet", $_POST['From_Date'], $_POST['To_Date'], NULL, $ID);
                                $obj_OT->Attendance_Cleaner("attendance_allocation", $_POST['From_Date'], $_POST['To_Date'], NULL, $ID);
                            }

                            $obj_OT->Attendance_Scan_Sheet_Importer($_POST['From_Date'], $_POST['To_Date'], NULL, $ID);


                            $obj_OT->Attendance_Allocation($_POST['From_Date'], $_POST['To_Date'], NULL, $ID, $operation);
                    ...
                    ?>
                    <h1 class="form_lable">
                        <?php echo $obj_lang->get('Attendance Allocation', $lang); ?>
                    </h1>
                    <form action="http://192.168.1.201/ci/index.php/Attendance_System/attendance_allocation<?php //echo $editFormAction; ?>" method="post" name="form1" id="form1">
                    <!--  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">-->
                        <table align="center"  bgcolor="#EBEBEB" width="382" height="361">
							...
							<tr valign="baseline">
            <td  align="right" nowrap="nowrap"><label >Force Import Scan:</label></td>
            <td>
                <input  type="checkbox" ID="import_scan" Name="import_scan" value="import_scan" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="submit" value="Run Allocation" />
                                </td>
                            </tr>
