    ...
    <body>
        ...
        <div id="thekey_page">
            ...
            <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
                <h1 class="form_lable">
                    Attendance  Scan Sheet Importer
                </h1>
                ...
                if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
                    ...
                    if ((isset($_POST['Department'])) && isset($_POST['From_Date']) && isset($_POST['To_Date'])) {
                        ...
                        $obj_AS->Attendance_Scan_Sheet_Importer($SelectedDepartment, $_POST['From_Date'], $_POST['To_Date']);
                    }
                }
                ?>
                ...
                <form id="form_multiple" name="form1" method="POST"  action="<?php echo $editFormAction; ?>">
                    <table align="center"  bgcolor="#EBEBEB" width="382" height="361">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="submit"  value="Import" onClick="return confirm('Are you sure you want to Issue, you want to Attendance Import Scan Sheet?')"  />
