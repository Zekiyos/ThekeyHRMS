        ...
        <div id="thekey_page">
            ...
            <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
                ...
                if (isset($_GET['Auto_ID']) && (count($_POST) == 0)) {
                    ...
                    $result = $mydb->delete('working_time_setting');
                    if ($result) {
                ...
                $mydb = new DataBase();
                $header_lable = 'Departmental Working Time Setting';
                $mydb = filter($mydb);
                $result = $mydb->get('working_time_setting');
                ...
                $update_page = 'WorkingTimeSettingUpdate.php';
                $key_filed = 'Auto_ID';

                $hide = array('Auto_ID' => 'Auto_ID');
                $table = "working_time_setting";
