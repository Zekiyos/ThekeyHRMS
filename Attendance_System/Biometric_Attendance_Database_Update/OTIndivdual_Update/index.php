        ...
        <div id="thekey_page">
            ...
            <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
               ...
               if (isset($_GET['Auto_ID']) && (count($_POST) == 0)) {
                    ...
                    $result = $mydb->delete('ot_definition');
                    if ($result) {
                ...
                $mydb = new DataBase();
                $header_lable = 'Individual Over Time Work Definition';
                $mydb = filter($mydb);
                $result = $mydb->get('ot_definition');
                $total_num_row = $result['total_row'];                 $result = $result['result'];
                
                 $header_info = $mydb->show_column('ot_definition');
                ksort($header_info);

                $update_page = 'OTIndivdualUpdate.php';
                $key_filed = 'Auto_ID';
