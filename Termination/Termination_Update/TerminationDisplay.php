...
<table width="397" border="0" align="center">
  <tr>
    <td><?php if ($pageNum_RSTerminationDisplay > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_RSTerminationDisplay=%d%s", $currentPage, 0, $queryString_RSTerminationDisplay); ?>"><img src="../../Img/First.gif" /></a>
        <?php } // Show if not first page ?></td>
    <td><?php if ($pageNum_RSTerminationDisplay > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_RSTerminationDisplay=%d%s", $currentPage, max(0, $pageNum_RSTerminationDisplay - 1), $queryString_RSTerminationDisplay); ?>"><img src="../../Img/Previous.gif" /></a>
        <?php } // Show if not first page ?></td>
    <td><?php if ($pageNum_RSTerminationDisplay < $totalPages_RSTerminationDisplay) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_RSTerminationDisplay=%d%s", $currentPage, min($totalPages_RSTerminationDisplay, $pageNum_RSTerminationDisplay + 1), $queryString_RSTerminationDisplay); ?>"><img src="../../Img/Next.gif" /></a>
        <?php } // Show if not last page ?></td>
    <td><?php if ($pageNum_RSTerminationDisplay < $totalPages_RSTerminationDisplay) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_RSTerminationDisplay=%d%s", $currentPage, $totalPages_RSTerminationDisplay, $queryString_RSTerminationDisplay); ?>"><img src="../../Img/Last.gif" /></a>
        <?php } // Show if not last page ?></td>
  </tr>
</table>
</p>
