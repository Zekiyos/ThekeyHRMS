    ...
    <body>
        ...
        <div id="thekey_page">
            ...
            <div id="mainContent">
                ...
                echo 'Chart Selection Form';
                echo "</h1>";
                ?>
                <form action="Chart_Display.php" method="GET" name="form1" id="form1">

                    <table  name="userDefinedChartSelection" id="userDefinedChartSelection" align="center" background="" bgcolor="#EBEBEB">
                       
                        <tr> <td  align="right" nowrap="nowrap" colspan="2">
                                Chart Name
                            </td>
                            <td>
                                <select name="Chart" class="ChartSelection" >
                                    <option>Select Chart</option>
                                    <?php $objChart->get_User_Defined_Chart(); ?>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            
                            <td colspan="5"><div class="ChartDisplayOption"></div></td>
                        </tr>

                        <tr valign="baseline">
                            <td nowrap="nowrap" align="right">&nbsp;</td><td>
                                <td>&nbsp;&nbsp;<input type="submit" value="Show Chart" /></td>
                        </tr>
                    </table>
                </form>
