 ...
 */
require_once($base_path . 'class/BCGParseException.php');
require_once($base_path . 'class/BCGArgumentException.php');
require_once($base_path . 'class/BCGBarcode1D.php');
...
class BCGmsi extends BCGBarcode1D {
    ...
    public function setChecksum($checksum) {
        ...
        if ($checksum < 0 && $checksum > 2) {
            throw new BCGArgumentException('The checksum must be between 0 and 2 require_onced.', 'checksum');
        }
