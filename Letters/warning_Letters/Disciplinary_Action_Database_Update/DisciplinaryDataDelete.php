...
if ((isset($_GET['Auto_ID'])) && ($_GET['Auto_ID'] != "")) {
    $deleteSQL = sprintf("DELETE FROM disciplinary_action WHERE Auto_ID=%s", GetSQLValueString($_GET['Auto_ID'], "int"));

    mysql_select_db($database_HRMS, $HRMS);
    $Result1 = mysql_query($deleteSQL, $HRMS) or die(mysql_error());

    $deleteGoTo = "DisciplinaryDataDisplay.php";
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Disciplinary Data Delete</title>
    </head>
