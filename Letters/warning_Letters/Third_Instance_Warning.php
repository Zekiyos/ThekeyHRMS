    ...
    <body>
        ...
        <div id="thekey_page">
            ...
            <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
                ...
                if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
                    ...
                    if ($count == 0) {
                        ...
                        $data = array('ID' => $_GET['ID']
                            ...
                            , 'Third_Inistance' => $_POST['Third_Inistance']
                            , 'Third_Inistance_Date' => $_POST['Third_Inistance_Date']
                        );
                        $Result1 = $mydb->insert('disciplinary_action', $data);

                        if ($Result1)
                            echo "<script type=\"text/javascript\">alert('You have issued Third Inistance Warning Letter  for {$_POST['FirstName']}  {$_POST['MiddelName']}  Successfully.')</script>";
                    }
                }
                ...
                ?>
                <h1 class="form_lable">
                    <?php echo $obj_lang->get('Third Instance Warning Letter', $lang); ?>
                </h1>
                <?php
                ...
                ?>" readonly="readonly" size="20" />
                        ...
                        <tr>
                            ...
                            <td><input type="Date" name="Third_Inistance_Date"  value='<?php echo date("Y-m-d"); ?>' /></td>
                        </tr>
                        <tr valign="baseline">
                            <td colspan="2">
                                <?php echo $obj_lang->get('Third Instance ', $lang) . $obj_lang->get(' Sample', $lang) . $obj_lang->get('Warning Letter', $lang); ?>
                                <br/>
                                <hr/>
                                <textarea name="Third_Inistance" style="width: 600px;height: 400px;" >
                                    <?php require_once('Warning Letters Format/Third_Instance_Warning_Letter.php'); ?>
                                </textarea>
                            </td>
                        </tr>
                        <tr valign="baseline">
