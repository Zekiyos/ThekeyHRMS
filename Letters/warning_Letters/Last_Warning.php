...
<body>
    ...
    <div id="thekey_page">
        ...
        <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
            ...
            if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
                ...
                if ($count == 0) {
                    $data = array('ID' => $_GET['ID']
                        ...
                        , 'Last_Warning' => $_POST['Last_Warning']
                        , 'Last_Warning_Date' => $_POST['Last_Warning_Date']
                    );
                    $Result1 = $mydb->insert('disciplinary_action', $data);

                    if ($Result1)
                        echo "<script type=\"text/javascript\">alert('You have issued Last Warning Letter for {$_POST['FirstName']}  {$_POST['MiddelName']}  Successfully.')</script>";
                }
            }
            ...
            ?>
            <h1 class="form_lable">
                <?php echo $obj_lang->get('Last Warning Letter', $lang); ?>
            </h1>
            <?php
            ...
            ?>" readonly="readonly" size="20" />
                    ...
                    <tr>
                        ...
                        <td><input type="Date" name="Last_Warning_Date"  value='<?php echo date("Y-m-d"); ?>' /></td>
                    </tr>
                    <tr valign="baseline">
                        <td colspan="2">
                            <?php echo $obj_lang->get('Sample', $lang) . $obj_lang->get('Last', $lang) . $obj_lang->get('Warning Letter', $lang); ?>
                            <br/>
                            <hr/>
                            <textarea name="Last_Warning" style="width: 600px;height: 400px">
                                <?php
                                $query = "SELECT * FROM employee_personal_record";
                                $result = mysql_query($query);
                                while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
