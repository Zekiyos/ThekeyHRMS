        ...
        <div id="thekey_page" >
            ...
            <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
                ...
                if (isset($_GET['Auto_ID']) && (!isset($_POST['MM_update']))) {
                    ...
                    $result = $mydb->delete('disciplinary_action');
                    if ($result) {
                ...
                $mydb = new DataBase();
                $header_lable = 'Employee Offday';
                $mydb = filter($mydb);
                $result = $mydb->get('disciplinary_action');
                $total_num_row = $result['total_row'];                 $result = $result['result'];


                $header_info = $mydb->show_column('employee_offday');
                ksort($header_info);

                $update_page = 'OffDayUpdate.php';
                $key_filed = 'Auto_ID';
