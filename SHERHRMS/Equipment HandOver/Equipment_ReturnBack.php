...
$updateSQL ="UPDATE equipment_handover SET `Returned`='YES',`Returning_Date`='".$_POST['Returning_Date']."' WHERE ID = '". $_GET['ID'] ."' and EquipmentName='".$_POST['EquipmentName']."'";
...
<?php echo "<font face=\"Times New Roman, Times, serif\" size=\"+1\"><b>loged in as ".$_SESSION['MM_Username']."</b></font>";  ?>
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
    ...
    <blockquote>
     <blockquote>
      <blockquote>
       <font color="#FF6600" size="+1"> Equipment Returning Back Form </font>
    <?php include("Select_ID4EquipmentReturnBack.php"); ?>
<?php
...
?>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
     ...
     <input name="ID" value="<?php if(isset($_GET['ID'] )){	echo $_GET['ID'];} ?>" size="10" readonly="readonly"  />     
        ...
        <tr valign="baseline">
          <td height="36"  align="right" nowrap="nowrap">Name of Equipements:</td>
          <td>
...
<option >Filters (RC 209)(Colorless)</option>
    ...
    <option style="background:#00F; color:#FFF">Apron (Blue)</option>
        ...
        <tr valign="baseline">
          <td height="38" align="right" nowrap="nowrap">Returing Date:</td>
          <td><script type='text/JavaScript' src="../Calender/scw.js" ></script>
		
		<input type="text" name="Returning_Date" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' />
</td>
        </tr>
 ...
 //$date = date("Y-m-d",strtotime($date)) 
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">&nbsp;</td>
            <td><input type="submit" value="Register" onclick="return confirm('Are you sure the specifed Employee return backup the selected equipment ?')"   /></td>
      </tr>
      </table>
      </font>
      <p>
