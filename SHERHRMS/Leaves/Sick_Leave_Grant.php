...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	...
	{
  $insertSQL = sprintf("INSERT INTO sick_leave (ID, FirstName, MiddelName, LastName,Department, SickLeaveDays, SickLeave_Taken_Date, ReportOn) VALUES (%s, %s, %s, %s, %s, %s,%s, %s)",
...
echo "<script type=\"text/javascript\">alert('You have Granted Sick leave Seccussfully.')</script>";
	}
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" --> <blockquote>
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onmouseover="Numberofdays()">
        <table align="center" bgcolor="#EBEBEB">
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Sick Leave Days:</td>
            <td><input type="text" id="SickLeaveDays" name="SickLeaveDays" value="" size="4" readonly="readonly"/></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Sick Leave Taken Date:</td>
            <td><input type="text" id="SickLeave_Taken_Date" name="SickLeave_Taken_Date"  onclick='scwShow(this,event);'value="<?php echo date("Y-m-d"); ?>" size="15"  /></td>
          </tr>
          <tr valign="baseline">
...
function Numberofdays(){
           ...
           t1=document.getElementById("SickLeave_Taken_Date").value;
...
document.getElementById("SickLeaveDays").value=_Diff;
...
-->
  ...
  <div id="sidecontent">
    ...
    <br /> <br />
    <br />
    <a href="../Ethiopian Labour Law Pro.377(English).htm#a85" target="_blank">Sick Leave Labour Law</a>
