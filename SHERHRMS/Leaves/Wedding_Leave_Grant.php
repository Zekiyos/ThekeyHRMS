...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO wedding_leave (ID, FirstName, MiddelName, LastName,Department, WeddingLeavedays,Restday, WeddingLeave_TakenDate, ReportOn) VALUES (%s, %s, %s, %s,%s,%s, %s, %s, %s)",
  ...
  echo "<script type=\"text/javascript\">alert('You haveGranted the Wedding Leave form the employee  Seccussfully.')</script>";
	}
  //$insertGoTo = "../test.htm";
//  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" --><blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote>
             <font color="#FF6600" size="+1"> Wedding Leave Grant Form</font>
			   <?php include("Select_ID4WeddingLeaveGrant.php");?>
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onmouseover="Numberofdays()">
        <table align="center" bgcolor="#EBEBEB">
          <tr valign="baseline">
            <td height="35" align="right" nowrap="nowrap">ID:</td>
          ...
          <tr valign="baseline">
            <td height="35" align="right" nowrap="nowrap">Middel Name:</td>
          ...
          <tr valign="baseline">
            <td height="40" align="right" nowrap="nowrap">Last Name:</td>
          ...
          <tr valign="baseline">
            <td height="36" align="right" nowrap="nowrap">Wedding Leave days:</td>
            <td><input type="text" name="WeddingLeavedays" id="WeddingLeavedays" value="0" size="4" /></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            <td height="40" align="right" nowrap="nowrap">Wedding Leave Taken Date:</td>
            <td><input type="text" name="WeddingLeave_TakenDate"  id="WeddingLeave_TakenDate" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' size="15"   /></td>
          </tr>
          <tr valign="baseline">
            <td height="32" align="right" nowrap="nowrap">Report On:</td>
		...
		<input type="text" id="ReportOn" name="ReportOn" value='<?php echo date("Y-m-d");?>' readonly="readonly" /></td>
          ...
          <tr valign="baseline">
            ...
            <td><input type="submit" value="Grant Wedding Leave" onclick="return confirm('Are you sure you want to Grant Wedding Leave for this Employee?')" /></td>
          </tr>
        </table>
...
function Numberofdays(){
      t1=document.getElementById("WeddingLeave_TakenDate").value;
		   t2=document.getElementById("ReportOn").value
	  restday=document.getElementById("Restday").value
	  leaveday=document.getElementById("WeddingLeavedays").value
...
-->
  ...
  <div id="sidecontent">
    ...
    <br /> <br />
    <br />
    <a href="../Ethiopian Labour Law Pro.377(English).htm#a81" target="_blank">Wedding Leave Labour Law</a>
