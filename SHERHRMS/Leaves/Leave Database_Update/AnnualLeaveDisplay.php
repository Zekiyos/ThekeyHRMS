...
<table width="290" height="59" border="0" align="center">
  <tr>
    <td><?php if ($pageNum_RSAnnualLeaveDisplay > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_RSAnnualLeaveDisplay=%d%s", $currentPage, 0, $queryString_RSAnnualLeaveDisplay); ?>"><img src="../../Database_Update/Personal Record Database_Update/First.gif" /></a>
        <?php } // Show if not first page ?></td>
    <td><?php if ($pageNum_RSAnnualLeaveDisplay > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_RSAnnualLeaveDisplay=%d%s", $currentPage, max(0, $pageNum_RSAnnualLeaveDisplay - 1), $queryString_RSAnnualLeaveDisplay); ?>"><img src="../../Database_Update/Personal Record Database_Update/Previous.gif" /></a>
        <?php } // Show if not first page ?></td>
    <td><?php if ($pageNum_RSAnnualLeaveDisplay < $totalPages_RSAnnualLeaveDisplay) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_RSAnnualLeaveDisplay=%d%s", $currentPage, min($totalPages_RSAnnualLeaveDisplay, $pageNum_RSAnnualLeaveDisplay + 1), $queryString_RSAnnualLeaveDisplay); ?>"><img src="../../Database_Update/Personal Record Database_Update/Next.gif" /></a>
        <?php } // Show if not last page ?></td>
    <td><?php if ($pageNum_RSAnnualLeaveDisplay < $totalPages_RSAnnualLeaveDisplay) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_RSAnnualLeaveDisplay=%d%s", $currentPage, $totalPages_RSAnnualLeaveDisplay, $queryString_RSAnnualLeaveDisplay); ?>"><img src="../../Database_Update/Personal Record Database_Update/Last.gif" /></a>
        <?php } // Show if not last page ?></td>
  </tr>
</table>
</body>
