...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO Special_leave (ID, FirstName, MiddelName, LastName,Department, SpecialLeaveDays, SpecialLeave_Taken_Date, ReportOn) VALUES (%s, %s,%s, %s, %s, %s, %s, %s)",
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
        ...
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote>
			   <?php include("Select_ID4SpecialLeaveGrant.php");?>
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onmouseover="Numberofdays()">
        <table align="center" bgcolor="#EBEBEB">
          ...
          <tr valign="baseline">
            <td height="36" align="right" nowrap="nowrap">Special Leave Days:</td>
            <td><input type="text" id="SpecialLeaveDays" name="SpecialLeaveDays" value="" size="4" readonly="readonly" /></td>
          </tr>
          <tr valign="baseline">
            <td height="34" align="right" nowrap="nowrap">Special Leave Taken Date:</td>
		...
		<input type="text" id="ReportOn" name="ReportOn" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' /></td>
          ...
          <tr valign="baseline">
            ...
            <td><input type="submit" value="Grant Special leave" onclick="return confirm('Are you sure you want to Grant Special Leave for this Employee?')"  /></td>
          </tr>
        </table>
