  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" --><blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote>
             <font color="#FF6600" size="+1"> Back to work from Leave Reporting Form </font>
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center" bgcolor="#EBEBEB">
          ...
          <tr valign="baseline">
            <td height="31" align="right" nowrap="nowrap">From Leave:</td>
          ...
          <tr valign="baseline">
            <td height="31" align="right" nowrap="nowrap">Reported On:</td>
