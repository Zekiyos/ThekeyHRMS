...
echo "<script type=\"text/javascript\"> alert('Maternity Leave Registred Successfully'); </script>";
}
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onmouseover="Numberofdays()">
        <table align="center" bgcolor="#EBEBEB">
          <tr valign="baseline">
            <td height="34" align="right" nowrap="nowrap">ID:</td>
            <td><input type="text" name="ID" value="<?php if(isset($_GET['ID'] )){	echo $_GET['ID'];} ?>" size="10" readonly="readonly" /></td>
          </tr>
          <tr valign="baseline">
            <td height="31" align="right" nowrap="nowrap">First Name:</td>
          ...
          <tr valign="baseline">
            <td height="34" align="right" nowrap="nowrap">Middel Name:</td>
          ...
          <tr valign="baseline">
            <td height="36" align="right" nowrap="nowrap">Maternity Leave Days:</td>
          ...
          <tr valign="baseline">
            <td height="34" align="right" nowrap="nowrap">Maternity Leave Taken Date:</td>
          ...
          <tr valign="baseline">
            <td height="35" align="right" nowrap="nowrap">Report On:</td>
		...
		<input type="text"  id="ReportOn" name="ReportOn" onfocus="Numberofdays()" onblur="Numberofdays()"  onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' /></td>
          ...
          <tr valign="baseline">
            ...
            <td><input type="submit" onmousemove="Numberofdays()" value="Grant Maternity leave" onclick="return confirm('Are you sure you want to Grant Matternity Leave for this Employee?')"  /></td>
          </tr>
        </table>
...
-->
  ...
  <div id="sidecontent">
    ...
    <br /> <br />
    <br />
    <a href="../Ethiopian Labour Law Pro.377(English).htm#a88" target="_blank">Maternity Leave Labour Law</a>
