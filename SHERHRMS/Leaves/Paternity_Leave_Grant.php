...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	...
	{
  $insertSQL = sprintf("INSERT INTO Paternity_leave (ID, FirstName, MiddelName, LastName, PaternityLeaveDays, PaternityLeave_Taken_Date, ReportOn) VALUES (%s, %s, %s, %s, %s, %s, %s)",
