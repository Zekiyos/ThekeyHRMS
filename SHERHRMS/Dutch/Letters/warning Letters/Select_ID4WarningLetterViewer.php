...
mysql_select_db($database_HRMS, $HRMS);
$query_RSID = "SELECT * FROM disciplinary_action";
...
function SelectedID(elem, helperMsg){
	...
	location="Warning_Letters_Viewer.php?ID=" + document.getElementById('ID').value+ "&WarningType=" + document.getElementById('WarningType').value; ;
...
<option>Third Inistance Warning</option><option>Last Warning</option>
  ...
  <input type="button" onclick="SelectedID(document.getElementById('ID'), 'Please Choose Something')" value="Display"> 
</form>
</body>
</html>
<?php
