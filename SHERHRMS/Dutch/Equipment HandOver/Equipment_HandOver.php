...
<li><a href="#">Home</a>        </li>
        <li><a href="#" class="MenuBarItemSubmenu"><span id="result_box" lang="nl" xml:lang="nl"><span title="Click for alternate translations">Aanwerving</span></span></a>
          <ul>
            ...
            <li><a href="Equipment_HandOver.php">Apparatuur Handover</a></li>
          </ul>
        </li>
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
    ...
    <blockquote>
     <blockquote>
      <blockquote>
       <font color="#FF6600" size="+1">Apparatuur Overdracht Formulier</font>
...
?>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      ...
      <table width="400" height="362" align="center" background="" bgcolor="#EBEBEB">
        <tr valign="baseline">
          <td width="128" height="39" align="right" nowrap="nowrap">  Geselecteerde ID:</td>
          <td width="385">
     <input name="ID" value="<?php if(isset($_GET['ID'] )){	echo $_GET['ID'];} ?>" size="10" readonly="readonly"  />     
        ...
        <tr valign="baseline">
          <td height="37" align="right" nowrap="nowrap">Midden Naam:</td>
        ...
        <option>Kies dan de Apparatuur</option>
        <!--option>Apron</option>
...
<option >Filters (RC 209)(Colorless)</option>
    ...
    <option style="background:#00F; color:#FFF">Apron (Blue)</option>
        ...
        <tr valign="baseline">
          <td height="43"  align="right" nowrap="nowrap">Dag Gemaakt op:</td>
        ...
        <tr valign="baseline">
          <td height="62" align="right" nowrap="nowrap">Vervangende datum:</td>
          <td><script type='text/JavaScript' src="../Calender/scw.js" ></script>
 ...
 //$date = date("Y-m-d",strtotime($date)) 
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">&nbsp;</td>
            <td><input type="submit" value="Registreren" onclick="return confirm('Ben je zeker dat je wilt geregistreerd Apparatuur voor deze werknemer?')"   /></td>
      </tr>
      </table>
      </font>
      <p>
