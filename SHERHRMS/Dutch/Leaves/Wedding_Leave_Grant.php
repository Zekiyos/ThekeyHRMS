...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO wedding_leave (ID, FirstName, MiddelName, LastName, WeddingLeavedays, WeddingLeave_TakenDate, ReportOn) VALUES (%s, %s, %s, %s, %s, %s, %s)",
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" --><blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote>
             <font color="#FF3300" size="+1" > Bruiloft Laat subsidie Formulier</font>
        ...
        <table align="center" bgcolor="#EBEBEB">
          ...
          <tr valign="baseline">
            <td height="35" align="right" nowrap="nowrap">Midden Naam:</td>
          ...
          <tr valign="baseline">
            <td height="40" align="right" nowrap="nowrap">Achternaam:</td>
          ...
          <tr valign="baseline">
            <td height="36" align="right" nowrap="nowrap">Wedding Laat dagen:</td>
            <td><input type="text" name="WeddingLeavedays" value="" size="4" /></td>
          </tr>
          <tr valign="baseline">
            <td height="40" align="right" nowrap="nowrap">Bruiloft verlof Datum:</td>
            <td><input type="text" name="WeddingLeave_TakenDate" value="<?php echo date("Y-m-d"); ?>" size="15" readonly="readonly"  /></td>
          </tr>
          <tr valign="baseline">
            <td height="32" align="right" nowrap="nowrap"><span id="result_box5" lang="nl" xml:lang="nl"><span title="Click for alternate translations">Verslag uit over</span><span title="Click for alternate translations">:</span></span></td>
