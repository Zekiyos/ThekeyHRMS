  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" --><blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote>
              <font color="#FF3300" size="+1" >Funeral verlof toe te kennen vorm  </font>
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center" bgcolor="#EBEBEB">
          ...
          <tr valign="baseline">
            <td height="33" align="right" nowrap="nowrap">Achternaam:
</td>
          ...
          <tr valign="baseline">
            <td height="33" align="right" nowrap="nowrap">Funeral verlofdagen: </td>
            <td><input type="text" name="FuneralLeaveDays" value="" size="4" /></td>
          </tr>
          <tr valign="baseline">
            <td height="35" align="right" nowrap="nowrap">Funeral verlof Datum:</td>
            <td><input type="text" name="FuneralLeave_Taken_Date" value="<?php echo date("Y-m-d"); ?>" size="15" readonly="readonly" /></td>
          </tr>
          <tr valign="baseline">
            <td height="31" align="right" nowrap="nowrap">Verslag uit over: </td>
