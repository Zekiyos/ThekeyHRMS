  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" --><blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote>
             <font color="#FF6600" size="+1"> Weer aan het werk van verlof Rapportage Formulier </font>
			   <?php include("Select_ID4BackFromLeaveReport.php");?>
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center" bgcolor="#EBEBEB">
          <tr valign="baseline">
            <td height="40" align="right" nowrap="nowrap">Geselecteerde ID:</td>
            <td><input type="text" name="ID" value="<?php if(isset($_GET['ID'] )){	echo $_GET['ID'];} ?>" size="10" readonly="readonly" /></td>
          </tr>
          <tr valign="baseline">
            <td height="38" align="right" nowrap="nowrap">Voornaam:</td>
          ...
          <tr valign="baseline">
            <td height="33" align="right" nowrap="nowrap">Midden Naam:</td>
          ...
          <tr valign="baseline">
            <td height="33" align="right" nowrap="nowrap">Achternaam:</td>
          ...
          <tr valign="baseline">
            <td height="31" align="right" nowrap="nowrap">van verlof</td>
            <td><select name="LeaveType">
            <option>Please Choose Leave Type</option>
          ...
          <tr valign="baseline">
            <td height="31" align="right" nowrap="nowrap">Gerapporteerd over:</td>
		...
		<input type="text" name="Reported_Back_Date" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' /></td>
          ...
          <tr valign="baseline">
            ...
            <td><input type="submit" value="Voer" /></td>
          </tr>
        </table>
