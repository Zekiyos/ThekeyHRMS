  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
        ...
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote>
            <font color="#FF3300" size="+1" >  Zwangerschapsverlof te verlenen vorm</font>
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center" bgcolor="#EBEBEB">
          ...
          <tr valign="baseline">
            <td height="31" align="right" nowrap="nowrap">Voornaam:
</td>
          ...
          <tr valign="baseline">
            <td height="34" align="right" nowrap="nowrap">Midden Naam:</td>
          ...
          <tr valign="baseline">
            <td height="36" align="right" nowrap="nowrap">Zwangerschapsverlof Dagen:</td>
            <td><input type="text" name="MaternityLeaveDays" value="" size="4" /></td>
          </tr>
          <tr valign="baseline">
            <td height="34" align="right" nowrap="nowrap">Genomen zwangerschapsverlof Datum:</td>
            <td><input type="text" name="MaternityLeave_Taken_Date" value="<?php echo date("Y-m-d"); ?>" size="15" readonly="readonly" /></td>
          </tr>
          <tr valign="baseline">
            <td height="35" align="right" nowrap="nowrap">Verslag uit over:</td>
