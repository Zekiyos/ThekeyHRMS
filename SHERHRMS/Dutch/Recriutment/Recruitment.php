...
<li><a href="#">Home</a>        </li>
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" --><span id="result_box11" lang="nl" xml:lang="nl"><span title="Click for alternate translations"><p class="active">&nbsp;</p><font color="#FF3300" size="+1" > WerknemerProeftijd Recruitment Formulier</font>
  
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table width="535" height="535" align="center">
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Werknemer:</td>
            <td><span id="sprytxtEmployee">
              <input type="text" name="Employee" value="" size="32" />
            <span class="textfieldRequiredMsg">A value is required.</span></span></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Plaats:</td>
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Voornaam:<br /></td>
            <td><span id="sprytxtFirstName">
              <input type="text" name="FirstName" value="" size="20" />
            <span class="textfieldRequiredMsg">A value is required.</span></span></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right"><span id="result_box5"><span title="Father Name:" onMouseOver="this.style.backgroundColor='#ebeff9'" onMouseOut="this.style.backgroundColor='#fff'">Vader Naam:</span></span></td>
            <td><span id="sprytxtMiddelName">
              <input type="text" name="MiddelName" value="" size="20" />
            <span class="textfieldRequiredMsg">A value is required.</span></span></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right"><span id="result_box6"><span title="LastName:" onMouseOver="this.style.backgroundColor='#ebeff9'" onMouseOut="this.style.backgroundColor='#fff'">Achternaam: </span></span></td>
            <td><span id="sprytxtLastName">
              <input type="text" name="LastName" value="" size="20" />
            <span class="textfieldRequiredMsg">A value is required.</span></span></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right"><span id="result_box7"><span title="Age:" onMouseOver="this.style.backgroundColor='#ebeff9'" onMouseOut="this.style.backgroundColor='#fff'">Leeftijd: </span></span></td>
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Geslacht:</td>
            <td valign="baseline"><table>
              ...
              <tr>
                ...
                <span id="result_box8" lang="nl" xml:lang="nl"><span title="Click for alternate translations">Vrouw</span></span></td>
              </tr>
            </table></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Foto:<br /></td>
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right"><span id="result_box10" lang="nl" xml:lang="nl"><span title="Click for alternate translations">ambtsvergoeding</span><span title="Click for alternate translations">:</span></span>:</td>
            <td><span id="sprytxtHardshipAllowance">
              <input type="text" name="Hardship_Allowance" value="" size="15" />
            <span class="textfieldInvalidFormatMsg">Invalid format type Number in Birr.</span></span></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right"><span id="result_box9" lang="nl" xml:lang="nl"><span title="Click for alternate translations">Positie</span>vergoedingen<span title="Click for alternate translations">:</span></span></td>
