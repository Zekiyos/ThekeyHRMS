...
$d=date("Y-m-d");
			...
			slmg[<?php echo $i;?>]='<?php echo "<font  color=\"#FF9900\" size=\"+1\" face=\"Times New Roman, Times, serif\">"."{$row['FirstName']}"." {$row['MiddelName']}"." {$row['LastName']}"."<br>";
					echo "<font color=\"#03F\" size=\"+0\" >"."Klaar bent met zijn / haar Proeftijd U dient te   <a href=\"Probation_Evaluation.php\">evalueren zijn / haar Proeftijd </a>verblijf op vandaag" . "<p> </p>";?>';
					<?php
