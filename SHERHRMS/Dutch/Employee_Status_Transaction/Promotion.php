...
<p>&nbsp;</p>
    ...
    <blockquote>
     ...
     <font color="#FF6600" size="+1"> Medewerker Promotie Formulier  </font>
...
?>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      ...
      <table width="738" height="383" align="center" background="" bgcolor="#EBEBEB">
        <tr valign="baseline">
          <td width="150" height="39" align="right" nowrap="nowrap"> Geselecteerde ID:</td>
          <td width="185">
     <input name="ID" value="<?php if(isset($_GET['ID'] )){	echo $_GET['ID'];} ?>" size="10" readonly="readonly"  />     
        ...
        <tr valign="baseline">
          <td height="37" align="right" nowrap="nowrap">Middelste naam:</td>
          ...
          <td width="163" align="right"><font color="#FF6600" size="+1">Na de </font> </td>
          <td> <font color="#FF6600" size="+1">Promotie</font></tr>
        <tr valign="baseline">
          ...
          <td><input name="LastName" type="text" value="<?php
				...
				}?>" size="20" maxlength="20" readonly="readonly" /><td align="right">Resultaat van de beoordeling:</td><td width="216"><span id="sprytxtEavluationResult">
...
<td align="right">Naar afdeling:</td><td>
...
ORDER BY Department ASC";
        ...
        <td>
         <input name="Position_Before_Promotion" type="text" value="<?php
				...
				}?>" size="30" maxlength="40" readonly="readonly" /> <td align="right">Positie:</td><td>
        ...
        <tr>
        <td height="23" align="right"><span id="result_box" lang="nl" xml:lang="nl"><span title="Click for alternate translations">Salaris</span> <span title="Click for alternate translations">voorafgaand aan de bevordering</span></span></td>
        <td>
        ...
        <td align="right">Salaris:</td><td><span id="sprytxtSalary">
                 <input name="Salary_After_Promotion" type="text" size="15" />
                 <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
          </td>
        </tr>
        <tr valign="baseline">
          <td height="43"  align="right" nowrap="nowrap">Datum van Promotie:</td>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right"></td>
            <td align="center" ></td><td><input type="submit" value="Te bevorderen" onClick="return confirm('Are you sure you want to Promote this Employee?')"   /></td>
      </tr>
      </table>
      </font>
      <p>
