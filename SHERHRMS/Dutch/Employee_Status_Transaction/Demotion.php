...
<p>&nbsp;</p>
    ...
    <blockquote>
     ...
     <font color="#FF6600" size="+1"> Medewerker Demotie Formulier  </font>
...
?>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      ...
      <table width="738" height="383" align="center" background="" bgcolor="#EBEBEB">
        <tr valign="baseline">
          <td width="150" height="39" align="right" nowrap="nowrap"><span id="result_box" lang="nl" xml:lang="nl"><span title="Click for alternate translations">Geselecteerde</span> <span title="Click for alternate translations">ID</span></span>:</td>
          <td width="185">
     <input name="ID" value="<?php if(isset($_GET['ID'] )){	echo $_GET['ID'];} ?>" size="10" readonly="readonly"  />     
        ...
        <tr valign="baseline">
          <td height="37" align="right" nowrap="nowrap"><span id="result_box2" lang="nl" xml:lang="nl"><span title="Click for alternate translations">Voornaam</span></span>:</td>
        ...
        <tr valign="baseline">
          <td height="37" align="right" nowrap="nowrap"><span id="result_box3" lang="nl" xml:lang="nl"><span title="Click for alternate translations">Middelste naam</span></span>:</td>
          ...
          <td width="163" align="right"><font color="#FF6600" size="+1">Na </font> </td>
          <td> <font color="#FF6600" size="+1">Demotie</font></tr>
        <tr valign="baseline">
          <td height="36"  align="right" nowrap="nowrap"><span id="result_box4" lang="nl" xml:lang="nl"><span title="Click for alternate translations">Achternaam</span></span>:</td>
        ...
        <tr valign="baseline">
          <td height="36"  align="right" nowrap="nowrap"><span id="result_box5" lang="nl" xml:lang="nl"><span title="Click for alternate translations">Van de afdeling</span></span>:</td>
          <td>
...
ORDER BY Department ASC";
        ...
        <tr>
        <td align="right"><span id="result_box6" lang="nl" xml:lang="nl"><span title="Click for alternate translations">Positie</span></span>:
        </td>
        <td>
        ...
        <tr>
        <td height="23" align="right">Salaris voorafgaand aan Demotie</td>
        <td>
            ...
            <input name="Salary_Before_Demotion" type="text" value="<?php
				...
				if(isset($_GET['ID'] ))
				{
                 ...
                 Salaris </td><td><span id="sprytxtSalary">
                 <input name="Salary_After_Demotion" type="text" size="15" />
                 <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
          </td>
        </tr>
        <tr valign="baseline">
          <td height="43"  align="right" nowrap="nowrap"><span id="result_box8" lang="nl" xml:lang="nl"><span title="Click for alternate translations">Datum van</span> <span title="Click for alternate translations">Demotie</span></span>:</td>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right"></td>
            <td align="center" ></td><td><input type="submit" value="Degraderen" onClick="return confirm('Are you sure you want to Promote this Employee?')"   /></td>
      </tr>
      </table>
      </font>
      <p>
