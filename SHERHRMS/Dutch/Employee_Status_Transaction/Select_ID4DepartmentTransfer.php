...
location="Department_Transfer.php?ID=" + elem.value;
...
<form id="form1" name="form1" method="get" action="" >
  <p>
    <label for="ID"><span id="result_box" lang="nl" xml:lang="nl"><span title="Click for alternate translations">Selecteer</span> <span title="Click for alternate translations">Employee</span> <span title="Click for alternate translations">ID</span></span>:</label>
