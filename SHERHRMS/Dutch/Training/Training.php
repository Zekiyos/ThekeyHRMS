...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO Training (ID, FirstName, MiddelName, LastName,TrainingName,Training_Start_Date, Training_End_Date,Status) VALUES ( %s,%s, %s, %s, %s, %s, %s, %s)",
...
<li><a href="#">Home</a>        </li>
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
    ...
    <blockquote>
     <blockquote>
      <blockquote>
       <font color="#FF6600" size="+1"> Training status inschrijfformulier</font>
...
?>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
     ...
     <input name="ID" value="<?php if(isset($_GET['ID'] )){	echo $_GET['ID'];} ?>" size="10" readonly="readonly"  />     
        ...
        <tr valign="baseline">
          <td height="43"  align="right" nowrap="nowrap">Startdatum training:</td>
        ...
        <tr valign="baseline">
          <td height="50" align="right" nowrap="nowrap">Training Einddatum:</td>
          <td><script type='text/JavaScript' src="../Calender/scw.js" ></script>
        ...
        <td>
        <input type="radio" name="Status" value="Incomplete" />Onvolledige
