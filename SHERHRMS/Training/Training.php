...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO Training (ID, FirstName, MiddelName, LastName,TrainingName,Training_Start_Date, Training_End_Date,Refreshment_Date,Status) VALUES ( %s,%s, %s,%s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['ID'], "text"),
                       GetSQLValueString($_POST['FirstName'], "text"),
                       GetSQLValueString($_POST['MiddelName'], "text"),
                       GetSQLValueString($_POST['LastName'], "text"),
					   GetSQLValueString($_POST['TrainingName'], "text"),
                       GetSQLValueString($_POST['Training_Start_Date'], "date"),
                       GetSQLValueString($_POST['Training_End_Date'], "date") , 
					   GetSQLValueString($_POST['Refreshment_Date'], "date")   ,
...
<?php echo "<font face=\"Times New Roman, Times, serif\" size=\"+1\"><b>loged in as ".$_SESSION['MM_Username']."</b></font>";  ?>
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
    ...
    <blockquote>
     <blockquote>
      <blockquote>
       <font color="#FF6600" size="+1"> Training status entry Form </font>
    <?php include("Select_ID4Training.php"); ?>
<?php
...
?>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
     ...
     <input name="ID" value="<?php if(isset($_GET['ID'] )){	echo $_GET['ID'];} ?>" size="10" readonly="readonly"  />     
        ...
        <tr valign="baseline">
          <td height="36"  align="right" nowrap="nowrap">Training:</td>
          <td>
        ...
        <tr valign="baseline">
          <td height="43"  align="right" nowrap="nowrap">Training Start Date:</td>
          <td><script type='text/JavaScript' src="../Calender/scw.js" ></script>
		
            <input name="Training_Start_Date" type="text" onclick='scwShow(this,event);' value="<?php echo date("Y-m-d"); ?>" size="20" maxlength="20" />
          </td>
        </tr>
        <tr valign="baseline">
          <td height="50" align="right" nowrap="nowrap">Training End Date:</td>
          <td><script type='text/JavaScript' src="../Calender/scw.js" ></script>
		
		<input type="text" name="Training_End_Date" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' />
</td>
        </tr>
        <tr>
        <td>Training Refreshment Date:</td><td><input type="text"name="Refreshment_Date" id="Refreshment_Date" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' /></td>
        </tr>
        <tr>
        <td height="48" align="right">Status: </td>
        <td>
 ...
 //$date = date("Y-m-d",strtotime($date)) 
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">&nbsp;</td>
            <td><input type="submit" value="Register" onclick="return confirm('Are you sure you want to registered the specfied training for this Employee?')"   /></td>
      </tr>
      </table>
      </font>
      <p>
...
-->
  ...
  <div id="sidecontent">
    ...
    <br />
    <br /> 
    <?php include ("../Notifications/TraningRefreshmentNotification.php");?>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
