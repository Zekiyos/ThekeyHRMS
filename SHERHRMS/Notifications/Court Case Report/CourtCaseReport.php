...
$query_RSCourtCaseReport = "SELECT * FROM court_case where DATEDIFF(CURDATE(),court_case.AppointmentDate) >-2 and DATEDIFF(CURDATE(),court_case.AppointmentDate) <=5";
...
<table id="CourtCase" ellpadding="0" align="center" border="1" bordercolor="#E19319">
  ...
  <?php do { ?>
    <tr>
      ...
      <td><?php echo $row_RSCourtCaseReport['ClaimAmount']; ?></td>
      <td><?php echo $row_RSCourtCaseReport['AdvocateName']; ?></td>
      <td><?php echo $row_RSCourtCaseReport['FileDate']; ?></td>      
      <td><?php echo $row_RSCourtCaseReport['Court']; ?></td>
      <td><?php echo $row_RSCourtCaseReport['Case']; ?></td>
      <td><?php echo $row_RSCourtCaseReport['Decision']; ?></td>
