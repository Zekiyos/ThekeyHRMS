...
//					                  );
 ...
 $sqlupdate= "UPDATE employee_personal_record SET Department='".$_POST['ToDepartment']."', Position='".$_POST['as']."' where ID='".$_POST['ID']."' and FirstName='".$_POST['FirstName']."'";
  ...
  $sqlupdatePayrollDB= "UPDATE Payroll_Data SET `Department`='".$_POST['ToDepartment']."', `Position`='".$_POST['as']."' where `Payroll ID`='".$_POST['ID']."' and `First Name`='".$_POST['FirstName']."'";
...
<?php echo "<font face=\"Times New Roman, Times, serif\" size=\"+1\"><b>loged in as ".$_SESSION['MM_Username']."</b></font>";  ?>
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
    ...
    <blockquote>
     ...
     <font color="#FF6600" size="+1"> Employee Department Transfer  </font>
...
?>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      ...
      <table width="687" height="362" align="center" background="" bgcolor="#EBEBEB">
        <tr valign="baseline">
          <td width="168" height="39" align="right" nowrap="nowrap"> Selected ID:</td>
          <td width="550">
...
ORDER BY Department ASC";
        ...
        <td>
         <input name="Position" type="text" value="<?php
				...
				}?>" size="30" maxlength="40" readonly="readonly" /> As:<input name="as" type="text" value="<?php
        ...
        <tr valign="baseline">
          <td height="43"  align="right" nowrap="nowrap">Date of Transfer:</td>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right"></td>
            <td align="center"><input type="submit" value="Transfer" onclick="return confirm('Are you sure you want to Tranfer this Employee ?')"   /></td>
      </tr>
      </table>
      </font>
      <p>
