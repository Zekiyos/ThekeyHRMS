...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO medical_test (ID, FirstName, MiddelName, LastName, Department, Test_Name, Test_Result, `Comment`, Action_Taken, Test_Date) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['ID'], "text"),
                       GetSQLValueString($_POST['FirstName'], "text"),
                       GetSQLValueString($_POST['MiddelName'], "text"),
                       GetSQLValueString($_POST['LastName'], "text"),
                       GetSQLValueString($_POST['Department'], "text"),
                       GetSQLValueString($_POST['Test_Name'], "int"),
                       GetSQLValueString($_POST['Test_Result'], "double"),
                       GetSQLValueString($_POST['Comment'], "text"),
                       GetSQLValueString($_POST['Action_Taken'], "text"),
...
?>
    <?php
mysql_select_db($database_HRMS, $HRMS);
$query_RSMedicalTest = "SELECT * FROM medical_test";
$RSMedicalTest = mysql_query($query_RSMedicalTest, $HRMS) or die(mysql_error());
$row_RSMedicalTest = mysql_fetch_assoc($RSMedicalTest);
$totalRows_RSMedicalTest = mysql_num_rows($RSMedicalTest);
?>
     <blockquote>
        <blockquote>
          <blockquote>
            <blockquote>
              <blockquote>
			   <?php include("Select_ID4MedicalTest.php");?>
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
     <table align="center" bgcolor="#EBEBEB">
     <tr valign="baseline">
                     <td height="41" align="right" nowrap="nowrap">ID:</td><td><input type="text" name="ID" value="<?php if(isset($_GET['ID'] ))echo $_GET['ID']; ?>"/></td></tr>
                   <tr valign="baseline">
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Test Name:</td>
          <td><select name="Test_Name">
            <option value="Colostrest Test" <?php if (!(strcmp("Colostrest Test", ""))) {echo "SELECTED";} ?>>Colostrest Test</option>
            <option value="PHICT" <?php if (!(strcmp("PHICT", ""))) {echo "SELECTED";} ?>>PHICT</option>
            <option value="CD4 Count" <?php if (!(strcmp("CD4 Count", ""))) {echo "SELECTED";} ?>>CD4 Count</option>
          </select></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Test Result:</td>
          <td><input type="text" name="Test_Result" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><select name="Action_Taken">
            <option value="Department Transfred" <?php if (!(strcmp("Department Transfred", ""))) {echo "SELECTED";} ?>>Department Transfred</option>
            <option value="Nothing" <?php if (!(strcmp("Nothing", ""))) {echo "SELECTED";} ?>>Nothing</option>
          </select></td>
        </tr>
        <tr valign="baseline">
		...
		<input onclick='scwShow(this,event);'type="text" name="Test_Date" value="<?php echo date("Y-m-d");?>" size="20" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">&nbsp;</td>
          <td><input type="submit" value="Registre" /></td>
        </tr>
      </table>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($RSMedicalTest);
?>
<script type="text/javascript">
var MenuBar1 = new Spry.Widget.MenuBar("MenuBar1", {imgDown:"SpryAssets/SpryMenuBarDownHover.gif", imgRight:"SpryAssets/SpryMenuBarRightHover.gif"});
</script>
