...
$query_RSFirstName = "SELECT * FROM terminated_employee ORDER BY ID ASC";
...
mysql_select_db($database_HRMS, $HRMS);
$query_RSID = "SELECT distinct ID FROM terminated_employee ";
...
<form id="form1" name="form1" method="get" action="" >
  <p>
    ...
    <select name="ID" id="ID" onchange="SelectedID(document.getElementById('ID'), 'Please Choose Something')">
      <option label="Please Choose ID"></option> 
      <?php
	 // echo $_GET['ID'];
