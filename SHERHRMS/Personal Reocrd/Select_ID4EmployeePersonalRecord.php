...
mysql_select_db($database_HRMS, $HRMS);
$query_RSID = "SELECT ID, `Date` FROM recruitment ORDER BY ID ASC";
...
function SelectedID(elem, helperMsg){
	...
	var ID=elem.value;
location="Employee_Personal_Record.php?ID=" + elem.value;
...
<form id="form1" name="form1" method="get" action="">
  <p>
    <label for="ID">Select Employee ID From Recruited List</label>
