  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" --><blockquote>
        <blockquote>
          <blockquote>
            ...
            <blockquote>
              <blockquote>
			  <font color="#FF6600" size="+1">  የቀብር ፍቃድ መስጫ ቅጽ </font> <?php include("Select_ID4FuneralLeaveGrant.php");?>
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center" bgcolor="#EBEBEB">
          ...
          <tr valign="baseline">
            <td height="33" align="right" nowrap="nowrap">የቀብር እረፍት ቀን :</td>
            <td><input type="text" name="FuneralLeaveDays" value="" size="4" /></td>
          </tr>
          <tr valign="baseline">
            <td height="35" align="right" nowrap="nowrap">የቀብር እረፍት የወሰደበት ቀን :</td>
            <td><input type="text" name="FuneralLeave_Taken_Date" value="<?php echo date("Y-m-d"); ?>" size="15" readonly="readonly" /></td>
          </tr>
          <tr valign="baseline">
            <td height="31" align="right" nowrap="nowrap">መመለሻ ቀን:</td>
...
-->
  ...
  <div id="sidecontent">
    ...
    <p></p><br />
    <a href="../Proclamation/Ethiopian Labour Law Pro.377-2003 Amharic and English.htm#a81" target="_blank">ስለ ቀብር ፍቃድ አዋጅ</a> 
