...
background:#EEEEEE">የህክምና መላኪያ</span></a></li>
            <li><a href="Training.php">ስልጠና</a></li>
          </ul>
        </li>
</ul>
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
    ...
    <blockquote>
     <blockquote>
      <blockquote>
       <font color="#FF6600" size="+1"> የተወሰደ ስልጠና ውጤት ቅጽ </font>
...
?>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
     ...
     <input name="ID" value="<?php if(isset($_GET['ID'] )){	echo $_GET['ID'];} ?>" size="10" readonly="readonly"  />     
        ...
        <tr valign="baseline">
          <td height="36"  align="right" nowrap="nowrap">የስልጠናው ሥም:</td>
          <td>
        ...
        <tr valign="baseline">
          <td height="43"  align="right" nowrap="nowrap">የጀመረበት ቀን:</td>
        ...
        <tr valign="baseline">
          <td height="50" align="right" nowrap="nowrap">የጨረሰበት ቀን:</td>
          <td><script type='text/JavaScript' src="../../Calender/scw.js" ></script>
        ...
        <tr>
        <td height="48" align="right">ውጤት: </td>
        <td>
        <input type="radio" name="Status" value="Incomplete" />አልተሞላም
        <input type="radio" name="Status" value="Complete" />ተጠናቆል
