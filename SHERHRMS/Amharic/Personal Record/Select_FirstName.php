...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
 ...
 if ($searching =="yes") 
 { 
 echo "<h2><font color=\"#FB33\">የፍለጋ ውጤት </font></h2><p>"; 
 
 //If they did not enter a search term we give them an error 
 if ($find == "") 
 { 
 echo "<p><font color=\"#FF0000\">እባኮ በመጀመሪያ የሚፈልጉትን ስም ያስገቡ፡፡</font>"; 
 //exit; 
 } 
 else{
...
// echo "<br>"; 
 ...
 if ($anymatches == 0) 
 { 
 echo "<font color=\"#FF0000\">ባስገቡት ስም መሰረት አሁን ባለው መረጃ ውስጥ ተመሳሳይ ስም የለም፡፡እባኮ የጻፉትን ስም የረጋግጡ፡፡<br><br></font>"; 
 } 
 
 //And we remind them what they searched for 
 echo "<b>ተፈላጊው ቃል:</b> " .$find; 
 echo "<br/><b> አጠቃላይ :</b> ".$anymatches." ሰራተነኛ አለ፡፡"; 
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  ...
  <td><select name="ID" id="ID" tabindex="40" onchange="SelectedID(document.getElementById('ID'), 'Please Choose Something')">
<option value="Select ID"> የመ. ቁጥር ይምረጡ</option>
    <?php
