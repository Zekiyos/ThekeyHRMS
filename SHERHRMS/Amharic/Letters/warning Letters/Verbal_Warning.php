    ...
    <table width="706" align="center">
     <tr valign="baseline">
      ...
      <td>:        <input type="text" name="Department" value="<?php
		...
		Date:<input type="text" name="Verbal_Warning_Date" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' /></td>
    </tr>
    
    <tr valign="baseline">
      <td nowrap="nowrap" align="right" valign="top"><p>Sample Verbal Warning<br /> Letter</td>
      <td><textarea name="Verbal_Warning" cols="30" rows="20">
...
-->
  ...
  <div id="sidecontent">
    ...
    <!-- InstanceBeginEditable name="SideContent" -->
        <p>
        <br /><a href="../../Proclamation/Ethiopian Labour Law Pro.377-2003 Amharic and English.htm#a25" target="_blank">ስለማስጠንቀቂያ የወጣ አዋጅ</a></p>
