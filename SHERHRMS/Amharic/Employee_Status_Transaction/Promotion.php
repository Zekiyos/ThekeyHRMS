...
<p>&nbsp;</p>
    ...
    <blockquote>
     ...
     <font color="#FF6600" size="+1"> የሰራተኛ  እድገት  መሙያ ቅጽ  </font>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
     ...
     <input name="ID" value="<?php if(isset($_GET['ID'] ))
        ...
        <tr valign="baseline">
          ...
          <td width="163" align="right"><font color="#FF6600" size="+1">ከእድገት </font> </td>
...
ORDER BY Department ASC";
        ...
        <td><input name="Position_Before_Promotion" type="text" value="<?php
       ...
       <td align="right">የሥራ መደብ:</td><td>
        ...
        <tr>
        <td height="23" align="right">ደመወዝ(ከእድገት  በፊት)</td>
        <td>
            ...
            <input name="Salary_Before_Promotion" type="text" value="<?php
				...
				while($row = mysql_fetch_array($result, MYSQL_ASSOC))
				{
                 ...
                 ደመወዝ </td><td><span id="sprytxtSalary">
                 <input name="Salary_After_Promotion" type="text" size="15" />
                 <span class="textfieldRequiredMsg">A value is required.</span></span></td>
          </td>
        </tr>
        <tr valign="baseline">
          <td height="43"  align="right" nowrap="nowrap">የእድገት  የተሰጠበት ቀን:</td>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right"></td>
            <td align="center" ></td><td><input type="submit" value="አሳድገው" onClick="return confirm('Are you sure you want to Promote this Employee?')"   /></td>
      </tr>
      </table>
      </font>
      <p>
