...
background:#EEEEEE">የህክምና መላኪያ</span></a></li>
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
    ...
    <blockquote>
     ...
     <font color="#FF6600" size="+1"> የሰራተኛ  ሥራ  ክፍል ማዘዋወሪያ ቅጽ   </font>
...
?>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      ...
      <table width="687" height="362" align="center" background="" bgcolor="#EBEBEB">
        <tr valign="baseline">
          <td width="168" height="39" align="right" nowrap="nowrap">መ.ቁጥር:</td>
          <td width="550">
...
ORDER BY Department ASC";
        ...
        <td>
         ...
         እንደ :<input name="as" type="text" value="<?php
        ...
        <tr valign="baseline">
          <td height="43"  align="right" nowrap="nowrap">የተዘዋወረበት  ቀን:</td>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right"></td>
            <td align="center"><input type="submit" value="አዘዋውረው" onclick="return confirm('Are you sure you want to Tranfer this Employee ?')"   /></td>
      </tr>
      </table>
      </font>
      <p>
