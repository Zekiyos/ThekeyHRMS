...
background:#EEEEEE">የቅጥር ቅጽ</span></a></li>
            <li><a href="Equipment_HandOver.php">እቃ ርክክብ </a></li>
          </ul>
        </li>
...
background:#EEEEEE">የህክምና መላኪያ</span></a></li>
  ...
  <div id="mainContent"><!-- InstanceBeginEditable name="MainContent" -->
    ...
    <blockquote>
     <blockquote>
      <blockquote>
       <font color="#FF6600" size="+1"> የእቃ ርክክብ ቅጽ   </font>
...
?>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      ...
      <table width="400" height="362" align="center" background="" bgcolor="#EBEBEB">
        <tr valign="baseline">
          <td width="128" height="39" align="right" nowrap="nowrap"> መ.ቁጥር:</td>
          <td width="385">
     <input name="ID" value="<?php if(isset($_GET['ID'] ))
        ...
        <tr valign="baseline">
          ...
          <td><input name="MiddelName" type="text" value="<?php
				...
				while($row = mysql_fetch_array($result, MYSQL_ASSOC))
				{
					 if(isset($_GET['ID'] )){	if ($row['ID'] == $_GET['ID'])
					{
					echo "{$row['MiddelName']}";
					}
        ...
        <tr valign="baseline">
          <td height="36"  align="right" nowrap="nowrap">የእቃው ዓይነት </td>
          <td>
  ...
  <option style="background:#FF0">Spray Mask (RC 203)(Yellow)</option>
<option >Filters (RC 209)(Colorless)</option>
    ...
    <option style="background:#00F; color:#FFF">Apron (Blue)</option>
        ...
        <tr valign="baseline">
          <td height="43"  align="right" nowrap="nowrap">የተወሰደበት ቀን :</td>
        ...
        <tr valign="baseline">
          <td height="62" align="right" nowrap="nowrap">የሚተካበት ቀን :</td>
          <td><script type='text/JavaScript' src="../Calender/scw.js" ></script>
