...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
			...
			//		$updateDASQL="UPDATE Disciplinary_action SET `Last_Warning`='". $_POST['Last_Warning'] ."' WHERE ID = '". $_GET['ID'] ."'";
  ...
  $insertSQL = sprintf("INSERT INTO disciplinary_action (ID, FirstName, MiddelName, LastName, Department, Verbal_Warning,Verbal_Warning_Date) VALUES (%s,%s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_GET['ID'], "text"),
                       GetSQLValueString($_POST['FirstName'], "text"),
                       GetSQLValueString($_POST['MiddelName'], "text"),
                       GetSQLValueString($_POST['LastName'], "text"),
                       GetSQLValueString($_POST['Department'], "text"),
                       GetSQLValueString($_POST['Verbal_Warning'], "text"),
					   GetSQLValueString($_POST['Verbal_Warning_Date'], "text"));
...
<?php echo "<font face=\"Times New Roman, Times, serif\" size=\"+1\"><b>loged in as ".$_SESSION['MM_Username']."</b></font>";  ?>
 ...
 <?php  include("Select_ID4VerbalWarning.php");
    ...
    <table width="706" align="center">
     <tr valign="baseline">
      ...
      <td>:        <input type="text" name="Department" value="<?php
		...
		Date:<input type="text" name="Verbal_Warning_Date" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' /></p></td>
    </tr>
    
    <tr valign="baseline">
      <td nowrap="nowrap" align="right" valign="top"><p>Verbal Warning<br /> Letter</td>
      <td align="left"><textarea name="Verbal_Warning" cols="15" rows="43">
     
  <p align="right">ቁጥር፡ ___________________<br />
  ቀን፡ <u><?php echo date("d/m/Y");?></u></p>
<p><strong>&nbsp;</strong></p>
<p><strong>ለ አቶ/ወሮ/ወ/ሪት</strong><u><?php           
       			 		$query  = "SELECT * FROM employee_personal_record";
						$result = mysql_query($query);
				while($row = mysql_fetch_array($result, MYSQL_ASSOC))
				{
					...
					if ($row['ID'] == $_GET['ID'])
					{
					echo "<b><font size=\"+3\">"."(Full Name):"."{$row['FirstName']}";
					echo " {$row['MiddelName']}";
					echo " {$row['LastName']}"."</br></b></font>";
					}
									}
				}?></u></p>
<p><strong>ጉዳዩ፡ <u>የቃል ማስጠንቀቂያ ስለመስጠት </u></strong><br />
  እርስዎ  በድርጅታችን ውስጥ በጠቅላላ ሰራተኝነት የሰራ መደብ ተቀጥረው እያገለገሉ መሆኑ ይታወቃል በመሆኑም በ  -------- ቀን ካለምንም <span style="background-color: #ffff00;">የቅርብ አለቃዎ ፍቃድ ከመግቢያ ሰአትዎ ለ --- ደቂቃ ያህል አርፍደው</span> መጥተዋል  በመሆኑም ይህ ድርጊትዎ በሼር ኢትዮጵያ ኃ/የተ/የግ/ኩ  እና በሼር ኢትዮጵያ መሰረታዊ ሰራተኛ መካከል በተደረገው ህብረት ስምምነት የጥፋት ሰንጠረዥ ላይ ቀላል ጥፋቶች በሚለው ዝርዝር  ውስጥ በተራ ቁጥር 1.1 1ኛ ደረጃ ላይ በተጠቀሰው መሰረት ይህ የቃል ማስጠንቀቂያ የተሰጥዎ መሆኑን አውቀው ወደፊት ከተመሳሳይ  ድርጊት እራስዎን ያርሙ ዘንድ እያሳሰብኩ ይህ ባይሆን ግን ድርጅቱ ህጉ የሚፈቅድለትን ቀጣይ እርምጃ ለመውሰድ የሚገደድ መሆኑን  አሳስባለሁ፡፡</p>
<p>ከሰላምታ ጋር</p>
<p>&nbsp;</p>
<p>የመስመር --------- የሰው ኃይል አስተዳደር</p>
<p>&nbsp;</p>
<p><strong>ግልባጭ፡</strong> ለ ----- ክፍል <br />
  ለግል ማኅደር </p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p align="right">ቁጥር፡ ___________________<br />
...
<p><strong>ጉዳዩ፡ <u>የቃል ማስጠንቀቂያ እና የግማሽ ቀን ደመወዝ ስለመስጠት</u></strong><br />
  እርስዎ  በድርጅታችን ውስጥ በጠቅላላ ሰራተኝነት የሰራ መደብ ተቀጥረው እያገለገሉ መሆኑ ይታወቃል በመሆኑም በ  -------- ቀን <span style="background-color: #ffff00;">ካለምንም የቅርብ አለቃዎ ፍቃድ ለግማሽ ቀን ቀርተዋል፡፡</span> በመሆኑም ይህ ድርጊትዎ  በሼር ኢትዮጵያ ኃ/የተ/የግ/ኩ እና በሼር ኢትዮጵያ መሰረታዊ  ሰራተኛ መካከል በተደረገው ህብረት ስምምነት የጥፋት ሰንጠረዥ ላይ ቀላል ጥፋቶች በሚለው ዝርዝር ውስጥ በተራ ቁጥር 1.2 1ኛ  ደረጃ ላይ በተጠቀሰው መሰረት ይህ የቃል ማስጠንቀቂያ ከግማሽ ቀን ደመወዝ ቅጣት ጋር የተሰጥዎ መሆኑን አውቀው ወደፊት ከተመሳሳይ  ድርጊት እራስዎን ያርሙ ዘንድ እያሳሰብኩ ይህ ባይሆን ግን ድርጅቱ ህጉ የሚፈቅድለትን ቀጣይ እርምጃ ለመውሰድ የሚገደድ መሆኑን  አሳስባለሁ፡፡</p>
<p>ከሰላምታ ጋር</p>
<p>&nbsp;</p>
<p>የመስመር --------- የሰው ኃይል አስተዳደር</p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
    ...
    <tr valign="baseline">
      ...
      <td><blockquote><blockquote><input type="reset" name="reset" value="Reset" />
        <input type="submit" value="Register this Verbal Warning" onClick="return confirm('Are you sure you want to This Letter for this Employee?')" /></td>
    </tr>
  </table>
...
-->
  ...
  <div id="sidecontent">
    ...
    <!-- InstanceBeginEditable name="SideContent" -->
        <p><br />
    <br /> <br />
    <br /><a href="../../Ethiopian Labour Law Pro.377(English).htm#a28" target="_blank">Warnings Labour Law</a></p>
