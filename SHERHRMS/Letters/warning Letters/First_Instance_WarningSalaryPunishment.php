...
<?php echo "<font face=\"Times New Roman, Times, serif\" size=\"+1\"><b>loged in as ".$_SESSION['MM_Username']."</b></font>";  ?>
 ...
 <?php  include("Select_ID4FirstInstanceWarning.php");
    ...
    <table width="706" align="center">
     <tr valign="baseline">
      ...
      <td>:        <input type="text" name="Department" value="<?php
		...
		Date:<input type="text" name="First_Inistance_Date" onclick='scwShow(this,event);' value='<?php echo date("Y-m-d");?>' /></td>
    </tr>
    
    <tr valign="baseline">
      <td nowrap="nowrap" align="right" valign="top"><p>Sample First <br />Inistance Warning<br /> Letter</td>
      <td><textarea name="First_Inistance" cols="70" rows="30">
...
<p><strong>ጉዳዩ፡ <u>የመጀመሪያ ደረጃ ማስጠንቀቂያ እና የደመወዝ ቅጣት  ስለመስጠት</u></strong><br />
  እርስዎ  በድርጅታችን ውስጥ በጥበቃ ሰራተኝነት የሰራ መደብ ተቀጥረው እያገለገሉ መሆኑ ይታወቃል በመሆኑም በ  -------- ቀን <span style="background-color: #ffff00;">ግቢ ውስጥ ከብቶች እንዲገቡ በማመቻቸትዎ እና የውሃ ማስተላለፊያ ቱቦወች ላይ ጉዳት እንዲደርስ  አድርገዋል፡፡</span> በመሆኑም ይህ ድርጊትዎ በሼር ኢትዮጵያ ኃ/የተ/የግ/ኩ  እና በሼር ኢትዮጵያ መሰረታዊ ሰራተኛ መካከል በተደረገው ህብረት ስምምነት የጥፋት ሰንጠረዥ ላይ መካከለኛ ደረጃ ጥፋቶች በሚለው  ዝርዝር ውስጥ በተራ ቁጥር 2.7 ላይ በተጠቀሰው መሰረት ይህ የመጀመሪያ ደረጃ ማስጠንቀቂያ ከሁለት ቀን የደመወዝ ቅጣት ጋር የተሰጥዎ  መሆኑን አውቀው ወደፊት ከተመሳሳይ ድርጊት እራስዎን ያርሙ ዘንድ እያሳሰብኩ ይህ ባይሆን ግን ድርጅቱ ህጉ የሚፈቅድለትን ቀጣይ  እርምጃ ለመውሰድ የሚገደድ መሆኑን አሳስባለሁ፡፡</p>
<p>ከሰላምታ ጋር</p>
<p>&nbsp;</p>
<p>የመስመር --------- የሰው ኃይል አስተዳደር</p>
<p>&nbsp;</p>
...
-->
  ...
  <div id="sidecontent">
    ...
    <br /> <br />
    <br />
    <a href="../../Ethiopian Labour Law Pro.377(English).htm#a28" target="_blank">Warnings Labour Law</a>
