...
<?php echo "<font face=\"Times New Roman, Times, serif\" size=\"+1\"><b>loged in as ".$_SESSION['MM_Username']."</b></font>";  ?>
 ...
 <?php  include("Select_ID4SecondInstanceWarning.php");
    ...
    <tr valign="baseline">
      ...
      <td><textarea name="Second_Inistance" cols="65" rows="43">
...
<p><strong>ጉዳዩ፡ <u>የሁለተኛ ደረጃ ማስጠንቀቂያ ስለመስጠት</u></strong><br />
  እርስዎ  በድርጅታችን ውስጥ በጥበቃ ሰራተኝነት የሰራ መደብ ተቀጥረው እያገለገሉ መሆኑ ይታወቃል ከዚህ በፊት <span style="background-color: #ffff00;">በደብዳቤ ቁጥር ---- በቀን ---- ወደ ድርጅቱ ቅጥር  ግቢ ከብቶች እንዲገቡ በማመቻቸትዎ የመጀመሪያ ማስጠንቀቂያ ከሁለት ቀን ደመወዝ  ቅጣት ጋር የተሰጥዎ መሆኑ ይታወሳል </span>ሆኖም ከጥፋትዎ ከመማር ይልቅ <span style="background-color: #ffff00;">በ ------- ቀን በሰአት መቆጣጠሪያ ሰነዱ ላይ ቀሪ በተደረገበት ቦታ ላይ መፈረምዎ በማስረጃ  ተረጋግጧል፡፡ </span>በመሆኑም ይህ ድርጊትዎ በሼር ኢትዮጵያ ኃ/የተ/የግ/ኩ  እና በሼር ኢትዮጵያ መሰረታዊ ሰራተኛ መካከል በተደረገው ህብረት ስምምነት መሰረት የጥፋቱ ዓይነት ቢለያይም መጨረሻ ላይ ባጠፋው  ጥፋት ትይዩ ባለው መሰረት እንደሚቀጣ በመደንገጉ የጥፋት ሰንጠረዥ ላይ ቀላል ጥፋቶች በሚለው ዝርዝር ውስጥ በተራ ቁጥር 1.13  ላይ በተጠቀሰው መሰረት ይህ የሁለተኛ ደረጃ  ማስጠንቀቂያ የተሰጥዎ  መሆኑን አውቀው ወደፊት ከተመሳሳይ ድርጊት እራስዎን ያርሙ ዘንድ እያሳሰብኩ ይህ ባይሆን ግን ድርጅቱ ህጉ የሚፈቅድለትን ቀጣይ  እርምጃ ለመውሰድ የሚገደድ መሆኑን አሳስባለሁ፡፡</p>
<p>ከሰላምታ ጋር</p>
<p>&nbsp;</p>
...
<p><strong>ጉዳዩ፡ <u>የሁለተኛ ደረጃ ማስጠንቀቂያ እና የደመወዝ ቅጣት  ስለመስጠት</u></strong><br />
  እርስዎ  በድርጅታችን ውስጥ በጥበቃ ሰራተኝነት የሰራ መደብ ተቀጥረው እያገለገሉ መሆኑ ይታወቃል ከዚህ በፊት በደብዳቤ ቁጥር ---- በቀን ---- ወደ ድርጅቱ ቅጥር  ግቢ ከብቶች እንዲገቡ በማመቻቸትዎ የመጀመሪያ ማስጠንቀቂያ ከሁለት ቀን ደመወዝ  ቅጣት ጋር የተሰጥዎ መሆኑ ይታወሳል ሆኖም ከጥፋትዎ <span style="background-color: #ffff00;">ከመማር ይልቅ በ ------- ቀን በስራ ባልደረባዎ ላይ የዛቻ እና የማስፈራራት ድርጊት መፈጸምዎ  በማስረጃ ተረጋግጧል፡፡</span> በመሆኑም ይህ ድርጊትዎ በሼር ኢትዮጵያ ኃ/የተ/የግ/ኩ እና በሼር ኢትዮጵያ መሰረታዊ ሰራተኛ መካከል በተደረገው  ህብረት ስምምነት መሰረት የጥፋቱ ዓይነት ቢለያይም መጨረሻ ላይ ባጠፋው ጥፋት ትይዩ ባለው መሰረት እንደሚቀጣ በመደንገጉ የጥፋት  ሰንጠረዥ ላይ መካከለኛ ደረጃ ጥፋቶች በሚለው ዝርዝር ውስጥ በተራ ቁጥር 2.3 ላይ በተጠቀሰው መሰረት በወንጀል መጠየቅዎ እንደተጠበቀ  ሆኖ ይህ የሁለተኛ ደረጃ  ማስጠንቀቂያ ከ3 ቀን ደመወዝ ቅጣት ጋር  የተሰጥዎ መሆኑን አውቀው ወደፊት ከተመሳሳይ ድርጊት እራስዎን ያርሙ ዘንድ እያሳሰብኩ ይህ ባይሆን ግን ድርጅቱ ህጉ የሚፈቅድለትን  ቀጣይ እርምጃ ለመውሰድ የሚገደድ መሆኑን አሳስባለሁ፡፡</p>
<p>ከሰላምታ ጋር</p>
<p>&nbsp;</p>
<p>የመስመር --------- የሰው ኃይል አስተዳደር</p>
<p>&nbsp;</p>
