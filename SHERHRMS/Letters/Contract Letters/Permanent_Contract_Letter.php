...
<li><a href="../../Leaves/Wedding_Leave_Grant.php">Wedding Leave</a></li>
        ...
        <li><a class="MenuBarItemSubmenu" href="#">Disciplinary Action</a>
          <ul>
            <li><a href="../warning Letters/Verbal_Warning.php">Verbal Warning</a>            </li>
            <li><a href="#">Salary Punishment</a></li>
            <li><a href="#" class="MenuBarItemSubmenu">Written Warning</a>
              <ul>
                <li><a href="../warning Letters/First_Instance_Warning.php">1st Instance Warning</a></li>
                <li><a href="../warning Letters/Second_Instance_Warning.php">2nd Instance Warning</a></li>
                <li><a href="../warning Letters/Third_Instance_Warning.php">3rd Instance Warning</a></li>
                <li><a href="../warning Letters/Last_Warning.php">Last Warning</a></li>
              </ul>
            </li>
            <li><a href="#" class="MenuBarItemSubmenu">Dismissal / Termination</a>
              <ul>
                <li><a href="../warning Letters/Termination.php">Termination Form</a></li>
            ...
            <li><a href="../warning Letters/Warning_Letters_Viewer.php">Warning Letter Viewer</a></li>
          </ul>
        </li>
