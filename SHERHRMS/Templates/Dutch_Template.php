...
<div id="headerAdvert">
    ...
    <H2 ><font color="#999999" size="+5" ></font><blockquote><blockquote><blockquote><font color="#FF6600" size="6"> De mens Bron management Het systeem</font>
      </font></h2>
  </div>
    <div id="headerimg">
      <div class="menu_nav">
...
<li><a href="#">Home</a>        </li>
        <li><a href="#" class="MenuBarItemSubmenu"><span id="result_box" lang="nl" xml:lang="nl"><span title="Click for alternate translations">Aanwerving</span></span></a>
          <ul>
            <li><a href="../Recruitment/Recruitment.php">Werving vorm</a></li>
</ul>
        </li>
        <li><a href="../Personal Reocrd/Personal_Information_Detail.php">Persoonlijke Informatie</a></li>
...
<li><a href="../Leaves/Wedding_Leave_Grant.php">Laat bruiloft</a></li>
        ...
        <li><a class="MenuBarItemSubmenu" href="#">Disciplinaire maatregelen</a>
          <ul>
            <li><a class="MenuBarItemSubmenu" href="#">Mondelinge waarschuwing</a>
              <ul>
  ...
  <div id="sidebar">
   ...
   <ul id="MenuBar2" class="MenuBarVertical">
     <li><a href="../Recruitment/Probation_Evaluation.php">Proeftijd Evaluatie</a>       </li>
