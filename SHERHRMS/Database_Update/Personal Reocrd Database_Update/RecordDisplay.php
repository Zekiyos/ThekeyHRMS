...
if($_POST['comparison']!="Contain")
 {
	...
	$i=0;
	 $selected="";
	foreach ($_POST['Displayfield'] as $names){ 
	//$i=$i+1;
	//if($i=1)
	//$selected = $names;
	//else
...
$data = mysql_query("SELECT ID".$selected." FROM `employee_personal_record`
WHERE ".$_POST['field']." ". $_POST['comparison']."'".$find."'");
echo "</br>SELECT ID".$selected." FROM `employee_personal_record`
WHERE ".$_POST['field']." ". $_POST['comparison']."'".$find."'";
 }
 else
 {
...
$data = mysql_query("SELECT ID".$selected." FROM employee_personal_record WHERE upper(".$_POST['field'].") LIKE'%$find%' "); 
 echo "SELECT ID".$selected." FROM employee_personal_record WHERE upper(".$_POST['field'].") LIKE'%$find%' ";
 }
...
<div id="headerAdvert" align="center">
  ...
  <td>&nbsp;&nbsp;
   ...
   <td ><p align="right">Comparison</p>
   <input type="radio" name="comparison" value="Contain" checked="checked"  />Contain </br>
      <input type="radio" name="comparison" value="="   />EQAUL</br>
      <input type="radio" name="comparison" value="!="  />NOT EQAUL</br>
      <input type="radio" name="comparison" value=">"   />GREATERTHAN</td><td></br><br /><br />
      <input type="radio" name="comparison" value=">="  />GREATERTHAN OR EQUAL</br>
      <input type="radio" name="comparison" value="<"   />LESSTHAN</br>
      <input type="radio" name="comparison" value="<="  />LESSTHAN OR EQAUL</br>
  ...
  <td><p align="center">&nbsp;</p>
    <p align="center">Select the field you want to be on the Report  </p>
      <select name="Displayfield[]" size="10" multiple="MULTIPLE" id="Displayfield" >
        <option value="FirstName" selected="selected">First Name</option>
      <option value="MiddelName" selected="selected">Middel Name</option>
      <option value="LastName">Last Name</option>
      <option value="Date_Birth">Date of Birth</option>
      <option value="Place_Birth">Place of Birth</option>
      <option value="Age">Age</option>
...
var excBook = excApp.Workbooks.open("D:\Documents and Settings\Admin\My Documents\Sher HRMS Data\Book4.xls");
 ...
 ?>
 <img src="Sherlogo.JPG" height="100" width="1253" />
<table id="searchtbl" cellpadding="10" align="center" border="0" bordercolor="#FF6600" >
...
{   
	...
	//echo "<td >";
	?><td bgcolor="<?php if($_POST['field']=="$names")
	  echo "#FFFFCC";
		  ?>">
          <?php
	$names=$names;
    ...
    <?php /*  <!--td bgcolor="<?php if($_POST['field']=="FirstName")
	  echo "#FFFFCC";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  ...
  <table >
    <tr>
    <td height="264">Type search term</td>
  <td><input type="text" size="20" id="find" name="find" />
