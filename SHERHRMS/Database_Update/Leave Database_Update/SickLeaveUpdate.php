...
?>
    ...
    <font color="#FF6600" size="+2" > <p align="center">Sick Leave Record Update form</p></font>
      <table align="center">
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">ID:</td>
          <td><input type="text" name="ID" value="<?php echo htmlentities($row_RSSickLeaveUpdate['ID'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="Leavedays" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">RestDay:</td>
          <td><input type="text" name="RestDay" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Leave_Taken_Date:</td>
          <td><input type="text" name="Leave_Taken_Date" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
