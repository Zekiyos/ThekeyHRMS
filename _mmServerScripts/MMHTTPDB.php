...
// <ERRORS><ERROR><DESCRIPTION>Your testing server do not has support for PHP pages</DESCRIPTION></ERROR>\n</ERRORS>
...
if (isset($oConn) && $oConn) {
    ...
    if ($_POST['opCode'] == 'IsOpen') {
        ...
        switch ($_POST['opCode']) {
            case 'GetTables': $answer = $oConn->GetTables(@$_POST['Database']);
                break;
            ...
            case 'GetProcedures': $answer = $oConn->GetProcedures();
                break;
            case 'GetParametersOfProcedure': $answer = $oConn->GetParametersOfProcedure(@$_POST['ProcName']);
                break;
            ...
            case 'GetKeysOfTable': $answer = $oConn->GetPrimaryKeysOfTable(@$_POST['TableName']);
                break;
            default: $answer = create_error('The \'' . $_POST['opCode'] . '\' command is not supported.');
                break;
        }
    }
