...
while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
    ...
    echo "<font color=\"#FF3300\" size=\"+0\" >" . "has finished his/her " . "{$row['LeaveType']}" . " days on date " . "{$row['ReportOn']}" . ".He/she should <a href=\"/Leaves/Back_From_Leave_Report.php?ID=" . $row['ID'] . "\" >report on</a> today" . "<p> </p>";
    ?>';
    <?php
    //}
}
