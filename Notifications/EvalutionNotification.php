...
<html><head>
        ...
        <script language="javascript"> 
            ...
            slmg[0]='<font color="#03F"> <h3>Today\'s Evalution Notification </h3></font>' 
<?php
$d = date("Y-m-d");
$query = "SELECT * FROM Recruitment where DATEDIFF('" . $d . "',Recruitment.date) > 42 and DATEDIFF('" . $d . "',Recruitment.date) < 46 ";
...
while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
    ...
    echo "<font color=\"#03F\" size=\"+0\" >" . "Have finished his/her " . "Probation Period" . " .You Should <a href=\"Probation_Evaluation.php?ID=" . $row['ID'] . "\" >Evalute his/her Probation Period </a>stay on today" . "<p> </p>";
    ?>';
    <?php
}
?>;
