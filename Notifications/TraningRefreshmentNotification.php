...
<html><head>
        ...
        <script language="javascript"> 
            ...
            slmg[0]='<font color="#03F"> <h3>Today\'s Traning Notification </h3></font>' 
<?php
$d = date("Y-m-d");
$query = "SELECT * FROM Training where DATEDIFF(Training.Refreshment_Date,'" . $d . "') > -1 and DATEDIFF(Training.Refreshment_Date,'" . $d . "') < 6";
...
while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
    ...
    echo "<font color=\"#03F\" size=\"+0\" >" . "Traning Refreshement Date is on " . $row['Refreshment_Date'] . " Inform for the Trainers to preapre the traning equipment and enviroment." . "<p> </p>";
    ?>';
    <?php
}
?>;
