...
<html><head>
        ...
        <script language="javascript"> 
            ...
            slmg[0]='<font color="#03F"> <h3>Today\'s Court Appointment Notification </h3></font>' 
<?php
$d = date("Y-m-d");
//$query="SELECT * FROM court_case ";
$query = "SELECT * FROM court_case where DATEDIFF('" . $d . "',court_case.AppointmentDate) >-2 and DATEDIFF('" . $d . "',court_case.AppointmentDate) <=2 ";
...
while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
    ...
    echo "<font color=\"#03F\" size=\"+0\" >" . "<a href=\"../Notifications/Court Case Report/CourtCaseReport.php\" target=\"_blank\" >case on {$row['Court']} Court</a> Appointment is on date {$row['AppointmentDate']}" . "<p> </p>";
    ?>';
    <?php
}
?>;
