...
attendance_allocation.MiddelName,attendance_allocation.LastName,attendance_allocation.Date,
...
@Working_Day:=IF((working_day_val -
(IF((Sum(Time_To_Sec(if(isnull(attendance_allocation.AbsentHR),'00:00:00',attendance_allocation.AbsentHR))) /28800)
-
floor((Sum(Time_To_Sec(if(isnull(attendance_allocation.AbsentHR),'00:00:00',attendance_allocation.AbsentHR))) /28800) ) < 0.25,
...
CEILING((Sum(Time_To_Sec(if(isnull(attendance_allocation.AbsentHR),'00:00:00',attendance_allocation.AbsentHR))) /28800)))))
-(IF(isnull(TotalLeaveDays),0, if(TotalLeaveDays>working_day_val,working_day_val,TotalLeaveDays) ))
-((IF(isnull(TotalOffDays),0,IF(TotalOffDays>=2,2,TotalOffDays)))))<0,0,(working_day_val -
(IF((Sum(Time_To_Sec(if(isnull(attendance_allocation.AbsentHR),'00:00:00',attendance_allocation.AbsentHR))) /28800)
-
floor((Sum(Time_To_Sec(if(isnull(attendance_allocation.AbsentHR),'00:00:00',attendance_allocation.AbsentHR))) /28800) ) < 0.25,
...
CEILING((Sum(Time_To_Sec(if(isnull(attendance_allocation.AbsentHR),'00:00:00',attendance_allocation.AbsentHR))) /28800)))))
-(IF(isnull(TotalLeaveDays),0, if(TotalLeaveDays>working_day_val,working_day_val,TotalLeaveDays) ))
-(IF(isnull(TotalOffDays),0,IF(TotalOffDays>=2,2,TotalOffDays)))))
...
@TotalLeaveDays:=(IF(isnull(TotalLeaveDays),0,if(TotalLeaveDays>=(working_day_val-(IF(isnull(TotalOffDays),0,IF(TotalOffDays>=2,2,TotalOffDays)))),(working_day_val - (IF(isnull(TotalOffDays),0,IF(TotalOffDays>=2,2,TotalOffDays)))),TotalLeaveDays))) AS Total_Leave_Days,

@TotalOffDays:=(IF(isnull(TotalOffDays),0,IF(TotalOffDays>=3,4,TotalOffDays))) AS Total_Off_Days,
...
Prepared,Department_Manager,Checked,Approved
  ...
  LEFT JOIN Al_TotalOffDays ON Al_TotalOffDays.ID=attendance_allocation.ID
