...
@TotalLeaveDays:=(IF(isnull(TotalLeaveDays),0,if(TotalLeaveDays>=(working_day_val-4),(working_day_val - 4),TotalLeaveDays))) AS Total_Leave_Days,

@TotalOffDays:=(IF(isnull(TotalOffDays),0,IF(TotalOffDays>=4,4,TotalOffDays))) AS Total_Off_Days,
