...
-- @Working_Day:=working_day_val -(IF((Sum(Time_To_Sec(if(isnull(attendance_allocation.AbsentHR),'00:00:00',attendance_allocation.AbsentHR))) /28800)
-- -
-- floor((Sum(Time_To_Sec(if(isnull(attendance_allocation.AbsentHR),'00:00:00',attendance_allocation.AbsentHR))) /28800) ) < 0.25,
...
-- CEILING((Sum(Time_To_Sec(if(isnull(attendance_allocation.AbsentHR),'00:00:00',attendance_allocation.AbsentHR))) /28800)))))-(IF(isnull(TotalLeaveDays),0, if(TotalLeaveDays>working_day_val,working_day_val,TotalLeaveDays) )) AS Working_Day,
...
CEILING((Sum(Time_To_Sec(if(isnull(attendance_allocation.AbsentHR),'00:00:00',attendance_allocation.AbsentHR))) /28800)))))
-(IF(isnull(TotalLeaveDays),0, if(TotalLeaveDays>working_day_val,working_day_val,TotalLeaveDays) )))<0,0,(working_day_val -
(IF((Sum(Time_To_Sec(if(isnull(attendance_allocation.AbsentHR),'00:00:00',attendance_allocation.AbsentHR))) /28800)
-
floor((Sum(Time_To_Sec(if(isnull(attendance_allocation.AbsentHR),'00:00:00',attendance_allocation.AbsentHR))) /28800) ) < 0.25,
